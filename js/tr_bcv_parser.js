    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yar(?:at[Iİı]l(?:[Iİı][sş]))?|Ba[sş](?:lang(?:[Iİı][cç])?)|Tekv[Iİ]n|Gen)|Ba[sş]|(?:Yarat(?:il[ıIiİ][sş]|[ıİI]li[sş])|Tekvin|Ba[sş]langi[cç]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Exod|M[Iİı]s(?:[Iİı]r(?:dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş]))|['’]dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş]))))))|[CÇ](?:[Iİı]k))|M[Iİı]s(?:[Iİı]r(?:['’]dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş])))))|(?:M(?:is[Iiıİ]r(?:(?:['’]dan[\\s\\xa0]*(?:[ÇC](?:[iıİI]k(?:[Iİıi][şs])))|dan[\\s\\xa0]*[CÇ](?:[ıiIİ]k(?:[Iİıi][şs]))))|[ıIİ]s(?:(?:[ıİI]r(?:dan[\\s\\xa0]*(?:[ÇC](?:(?:[İIı]ki[sş]|ik[iİıI][şs]))|[’']dan[\\s\\xa0]*(?:[ÇC](?:(?:[İıI]ki[sş]|ik[Iiİı][şs])))))|ir(?:['’]dan[\\s\\xa0]*(?:[ÇC](?:[iIıİ]k(?:[İıiI][sş])))|dan[\\s\\xa0]*[ÇC](?:[İıIi]k(?:[iIİı][sş]))))))|(?:[CÇ](?:ik(?:[Iiıİ][sş])?|[İıI]k(?:[İıiI][sş]))))|M[İIı]s(?:[ıIİ]r(?:['’]dan[\\s\\xa0]*(?:[CÇ](?:(?:[Iıİ]ki[sş]|ik[İIıi][şs]))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yeremya(?:['’]n(?:[Iİı]n[\\s\\xa0]*Mers(?:[Iİ]yeler[Iİ]))|n[Iİı]n[\\s\\xa0]*Mers(?:[Iİ]yeler[Iİ]))|Lam|A(?:[gğ](?:[Iİı](?:t(?:lar)?)?)))|(?:Yeremya(?:(?:[’']n(?:(?:[ıIİ]n[\\s\\xa0]*Mers(?:iyeler[Iİi]|[İI]yeleri))|in[\\s\\xa0]*Mers[Iİi]yeler[Iİi]))|n(?:(?:[Iİı]n[\\s\\xa0]*Mers(?:iyeler[iIİ]|[İI]yeleri))|in[\\s\\xa0]*Mers[İIi]yeler[Iİi]))|A(?:[ğg]i(?:t(?:lar)?)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        ...
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:PrMan|Mana[sş](?:[sş]e(?:(?:['’]n(?:[Iİ]n[\\s\\xa0]*Duas[Iİı])|n[Iİ]n[\\s\\xa0]*Duas[Iİı]))))|Mana[sş](?:[sş]e(?:(?:[’']n(?:(?:[Iİ]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İiıI]))|n(?:[Iİ]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İIıi])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kunun(?:un[\\s\\xa0]*Tekrar[Iİı]|['’]un[\\s\\xa0]*Tekrar[Iİı])|Tesn[Iİ]ye|Deut|Yas(?:[\\s\\xa0]*Tek|a(?:['’]n(?:[Iİı]n[\\s\\xa0]*Tekrar[Iİı])|n[Iİı]n[\\s\\xa0]*Tekrar[Iİı])))|(?:Yas(?:a(?:n(?:in[\\s\\xa0]*Tekrar[ıIİi]|[Iıİ]n[\\s\\xa0]*Tekrari)|(?:[’']n(?:in[\\s\\xa0]*Tekrar[İiIı]|[Iıİ]n[\\s\\xa0]*Tekrari))))?|Kunun(?:['’]un[\\s\\xa0]*Tekrari|un[\\s\\xa0]*Tekrari)|Tesniye))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        ...
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Sa(?:m(?:uel)?)?|\.[\s\xa0]*Sa(?:m(?:uel)?)?|Sam?)|I(?:I(?:[\s\xa0]*Sa(?:m(?:uel)?)?|\.[\s\xa0]*Sa(?:m(?:uel)?)?)|k(?:[Iİ](?:[\s\xa0]*Sa(?:m(?:uel)?)?|nc(?:[Iİ][\s\xa0]*Sa(?:m(?:uel)?)?))))|İk(?:[Iİ](?:[\s\xa0]*Sa(?:m(?:uel)?)?|nc(?:[Iİ][\s\xa0]*Sa(?:m(?:uel)?)?))))|(?:(?:[İI]k(?:(?:[İI]nci[\s\xa0]*Sa(?:m(?:uel)?)?)|i(?:[\s\xa0]*Sa(?:m(?:uel)?)?|nc(?:[İIi][\s\xa0]*Sa(?:m(?:uel)?)?))))|ik(?:[İiI](?:[\s\xa0]*Sa(?:m(?:uel)?)?|nc(?:[İiI][\s\xa0]*Sa(?:m(?:uel)?)?)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Sa(?:m(?:uel)?)?|\.[\s\xa0]*Sa(?:m(?:uel)?)?|Sam?)|I(?:[\s\xa0]*Sa(?:m(?:uel)?)?|lk[\s\xa0]*Sa(?:m(?:uel)?)?|\.[\s\xa0]*Sa(?:m(?:uel)?)?)|B(?:[Iİ]r(?:[\s\xa0]*Sa(?:m(?:uel)?)?|(?:[Iİ]nc(?:[Iİ][\s\xa0]*Sa(?:m(?:uel)?)?))))|İlk[\s\xa0]*Sa(?:m(?:uel)?)?)|(?:B(?:(?:[Iİ]r(?:inc(?:[İIi][\s\xa0]*Sa(?:m(?:uel)?)?)|(?:[Iİ]nci[\s\xa0]*Sa(?:m(?:uel)?)?)))|ir(?:[\s\xa0]*Sa(?:m(?:uel)?)?|(?:[iİI]nc(?:[Iiİ][\s\xa0]*Sa(?:m(?:uel)?)?))))|ilk[\s\xa0]*Sa(?:m(?:uel)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:\.[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|K(?:gs|r)|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))|I(?:k(?:[Iİ](?:[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|nc(?:[Iİ][\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))))|I(?:\.[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)))|İk(?:[Iİ](?:[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|nc(?:[Iİ][\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)))))|(?:2(?:[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar)|ik(?:[iİI](?:[\s\xa0]*K(?:r(?:a(?:llar)?)?|[ıİiI]rallar)|nc(?:[İIi][\s\xa0]*K(?:r(?:a(?:llar)?)?|[İiIı]rallar))))|I(?:k(?:(?:[İI](?:[\s\xa0]*Kirallar|nc(?:i[\s\xa0]*K(?:r(?:a(?:llar)?)?|[ıiIİ]rallar)|[Iİ][\s\xa0]*Kirallar)))|i(?:[\s\xa0]*K(?:r(?:a(?:llar)?)?|[İiıI]rallar)|nc(?:[iİI][\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİiı]rallar))))|I(?:[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar))|İk(?:(?:[Iİ](?:[\s\xa0]*Kirallar|nc(?:i[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iiİı]rallar)|[İI][\s\xa0]*Kirallar)))|i(?:[\s\xa0]*K(?:r(?:a(?:llar)?)?|[İiIı]rallar)|nc(?:[iİI][\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iıİi]rallar))))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:\.[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|lk[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))|1(?:\.[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|K(?:gs|r)|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))|İlk[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|B(?:[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)))|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))))|(?:B(?:(?:[Iİ]r(?:[\s\xa0]*Kirallar|(?:[İI]nc(?:i[\s\xa0]*K(?:r(?:a(?:llar)?)?|[ıIiİ]rallar)|[Iİ][\s\xa0]*Kirallar))|inc(?:[iIİ][\s\xa0]*K(?:r(?:a(?:llar)?)?|[İıiI]rallar))))|ir(?:[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iiıİ]rallar)|(?:[Iiİ]nc(?:[iIİ][\s\xa0]*K(?:r(?:a(?:llar)?)?|[ıIiİ]rallar)))))|1(?:[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar)|I(?:[\s\xa0]*Kirallar|lk[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar)|ilk[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iiıİ]rallar)|İlk[\s\xa0]*Kirallar))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:Chr|[\s\xa0]*Ta(?:r[Iİ]hler|h)?|Ta|\.[\s\xa0]*Ta(?:r[Iİ]hler|h)?)|I(?:k[Iİ](?:[\s\xa0]*Ta(?:r(?:[Iİ]hler|h)?|nc[Iİ][\s\xa0]*Ta(?:r(?:[Iİ]hler|h)?)))|I(?:[\s\xa0]*Ta(?:r[Iİ]hler|h)?|\.[\s\xa0]*Ta(?:r[Iİ]hler|h)?))|İk[Iİ](?:[\s\xa0]*Ta(?:r(?:[Iİ]hler|h)?|nc[Iİ][\s\xa0]*Ta(?:r(?:[Iİ]hler|h)?))))|(?:[Iİ]k(?:[Iİ](?:[\s\xa0]*Tah?|nc[Iİ][\s\xa0]*Ta(?:r(?:[Iİ]hler|h)?))))|[Iİ]k(?:[Iİ]nc(?:[Iİ][\s\xa0]*Tah?))|(?:ik[İiI](?:[\s\xa0]*Ta(?:r(?:[İIi]hler|h)?|nc[İiI][\s\xa0]*Ta(?:r(?:[İiI]hler|h)?)))|I(?:k(?:[Iİ](?:nc(?:i[\s\xa0]*Ta(?:r(?:[Iİi]hler|h)?|[Iİ][\s\xa0]*Tarihler)|[\s\xa0]*Tarihler))|i(?:[\s\xa0]*Ta(?:r[iİI]hler|h)?|nc[İiI][\s\xa0]*Ta(?:r(?:[İIi]hler|h)?)))|I(?:[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler))|2(?:[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|İk(?:[Iİ](?:nc(?:i[\s\xa0]*Ta(?:r(?:[Iiİ]hler|h)?|[Iİ][\s\xa0]*Tarihler)|[\s\xa0]*Tarihler))|i(?:[\s\xa0]*Ta(?:r[Iİi]hler|h)?|nc[Iiİ][\s\xa0]*Ta(?:r(?:[Iİi]hler|h)?))))|(?:ik[İiI](?:nc(?:[İiI][\s\xa0]*Ta(?:r(?:[İiI]hler|h)?)|[\s\xa0]*Tah?))|[Iİ]k(?:inc(?:[İiI][\s\xa0]*Tah?|(?:[Iİ](?:nc(?:i[\s\xa0]*Tah?|[Iİ][\s\xa0]*Tarihler)|[\s\xa0]*Tarihler)))))|(?:(?:[Iİ]k(?:[Iİ](?:nc(?:i[\s\xa0]*Tah?|[Iİ][\s\xa0]*Tarihler)|[\s\xa0]*Tarihler)))|ik[İiI](?:nc(?:[İiI][\s\xa0]*Tah?|[\s\xa0]*Tah?)))|ik(?:[İiI][\s\xa0]*Tah?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İlk[\s\xa0]*Ta(?:r[Iİ]hler|h)?|B[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*Ta(?:r(?:[Iİ]hler|h)?))|[\s\xa0]*Ta(?:r[Iİ]hler|h)?))|1(?:Chr|[\s\xa0]*Ta(?:r[Iİ]hler|h)?|Ta|\.[\s\xa0]*Ta(?:r[Iİ]hler|h)?)|I(?:lk[\s\xa0]*Ta(?:r[Iİ]hler|h)?|[\s\xa0]*Ta(?:r[Iİ]hler|h)?|\.[\s\xa0]*Ta(?:r[Iİ]hler|h)?))|B[Iİ]r(?:[Iİ]nc(?:[Iİ][\s\xa0]*Tah?))|(?:B(?:[Iİ]r(?:(?:[Iİ]nc(?:i[\s\xa0]*Ta(?:r(?:[İiI]hler|h)?|[İI][\s\xa0]*Tarihler))|inc[İiI][\s\xa0]*Ta(?:r(?:[iİI]hler|h)?)|[\s\xa0]*Tarihler))|ir(?:[\s\xa0]*Ta(?:r[iİI]hler|h)?|[iİI]nc(?:[iIİ][\s\xa0]*Ta(?:r(?:[iIİ]hler|h)?))))|I(?:lk[\s\xa0]*Tarihler|[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|1(?:[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|İlk[\s\xa0]*Tarihler|ilk[\s\xa0]*Ta(?:r[Iİi]hler|h)?)|B(?:[Iİ]r(?:inc(?:[İiI][\s\xa0]*Tah?|(?:[Iİ]nc(?:i[\s\xa0]*Tah?|[İI][\s\xa0]*Tarihler))))|ir[iİI]nc(?:[iIİ][\s\xa0]*Tah?))|B(?:[İI]r(?:[Iİ]nc(?:i[\s\xa0]*Tah?|[İI][\s\xa0]*Tarihler))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Azarya(?:n[Iİı]n[\\s\\xa0]*Duas[Iİı]|['’]n(?:[Iİı]n[\\s\\xa0]*Duas[Iİı]))|PrAzar)|Azarya(?:n(?:[ıIİ]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[iıİI])|[’']n(?:(?:[İIı]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[iİıI]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Prov|[OÖ]zd|Meseller|S(?:[\\s\\xa0]*(?:[OÖ]zdey(?:[Iİ](?:[sş](?:ler[Iİ])?)))|(?:[uü]leyman(?:(?:[Iİı]n[\\s\\xa0]*(?:Meseller[Iİ]|[OÖ]zdey(?:[Iİ](?:[sş]ler[Iİ]))))|(?:['’](?:[Iİı]n[\\s\\xa0]*(?:Meseller[Iİ]|[OÖ]zdey(?:[Iİ](?:[sş]ler[Iİ])))))))))|S(?:[uü]leyman(?:(?:[’'](?:in[\\s\\xa0]*(?:(?:[OÖ]zdey(?:[iİI](?:[şs]ler[iİI]))|Meseller[iİI])|(?:[İIı]n[\\s\\xa0]*(?:Meselleri|[OÖ]zdey(?:i(?:[sş]ler[iİI]|[Iİ](?:[şs]leri)))))))|in[\\s\\xa0]*(?:[ÖO]zdey(?:[Iiİ](?:[sş]ler[Iİi]))|Meseller[iİI])|(?:[Iİı]n[\\s\\xa0]*(?:Meselleri|[ÖO]zdey(?:i(?:[sş]ler[iIİ]|[İI](?:[sş]leri)))))))|[\\s\\xa0]*(?:[ÖO]zdey(?:i(?:[sş](?:ler[iIİ])?)|[İI](?:[şs]leri))))|S[üu]leyman(?:(?:[İIı]n[\\s\\xa0]*(?:[OÖ]zdey(?:[Iİ](?:[şs]leri)))|(?:[’'](?:[İIı]n[\\s\\xa0]*(?:Meselleri|[ÖO]zdey(?:i(?:[sş]ler[iİI]|[İI](?:[sş]leri))))))))|S[uü]leyman(?:['’](?:[Iİı]n[\\s\\xa0]*(?:[ÖO]zdey(?:[İI](?:[sş]leri))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        ...
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:SgThree|[UÜ](?:[cç][\\s\\xa0]*Gen(?:[cç][\\s\\xa0]*Adam(?:[Iİı]n[\\s\\xa0]*Ezg(?:[Iİ]s[Iİ])))))|[ÜU](?:[cç][\\s\\xa0]*Gen(?:[çc][\\s\\xa0]*Adam(?:in[\\s\\xa0]*Ezg(?:[Iiİ]s[iIİ]|[ıİI]n[\\s\\xa0]*Ezg(?:(?:[Iİ]si|is[İiI]))))))|[ÜU](?:[cç][\\s\\xa0]*Gen(?:[çc][\\s\\xa0]*Adam(?:[ıİI]n[\\s\\xa0]*Ezg(?:(?:[Iİ]si|is[İiI]))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|Ne[sş](?:[Iİ]deler[\\s\\xa0]*Ne(?:[sş](?:[Iİ]des[Iİ])))|Ezg[Iİ]ler[\\s\\xa0]*Ezg(?:[Iİ]s[Iİ])?)|Ezg|(?:Ne[şs](?:ideler[\\s\\xa0]*Ne(?:[şs](?:[Iiİ]des[Iİi])|[İI]deler[\\s\\xa0]*Ne(?:[sş](?:(?:[Iİ]desi|ides[iIİ])))))|Ezg(?:iler[\\s\\xa0]*Ezg[İiI]s[İIi]|[İI]ler[\\s\\xa0]*Ezg(?:(?:[İI]si|is[İIi]))))|Ne[sş](?:[Iİ]deler[\\s\\xa0]*Ne(?:[sş](?:(?:[Iİ]desi|ides[iİI])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        ...
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Matta(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Matta['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|Mat(?:t(?:a(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))?)?|Matta(?:'(?:un[\\s\\xa0]*(?:Incilİ|İnc(?:İli|il[iİ])|inc(?:ili|İl[İi]))|n(?:In[\\s\\xa0]*(?:incİl[Iİ]|İncilI|Incilİ)|İn[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[İi])|inc(?:Il[İI]|İlİ))|in[\\s\\xa0]*(?:incIli|İnc(?:İl[Iİ]|Ilİ))|ın[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:ili|İl[iİ]))|un[\\s\\xa0]*(?:Incili|İnc(?:[Iİ]li|ilİ)|inc(?:İl[iİ]|Ilİ)))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|In[\\s\\xa0]*(?:İncil[Iİ]|IncIli)|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Inc(?:İli|il[İI])|incİlİ)|ın[\\s\\xa0]*(?:Inc(?:İli|il[Iİ])|İnc(?:İli|il[iİ])|incİlİ)|in[\\s\\xa0]*(?:İncİl[İI]|incİlI|Inc[İi]lİ))|İn[\\s\\xa0]*(?:Incili|İnc(?:İli|il[Iİ])|inc(?:İl[İi]|ilİ))|’(?:un[\\s\\xa0]*(?:inc(?:IlI|İl[Iİ]|ilİ)|İnc(?:İli|il[Iİ]))|ın[\\s\\xa0]*(?:inc(?:Ili|İl[iİ]|ilİ)|İnc(?:İli|il[iİ]))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:İncil|inc[İi]l))|n(?:un[\\s\\xa0]*(?:Incilİ|inc(?:IlI|İl[Iİ])|İnc(?:İli|il[iİ]))|İn[\\s\\xa0]*(?:Incili|İnc(?:İli|il[iİ])|inc(?:İl[Iİ]|ilİ))|in[\\s\\xa0]*(?:inc[Iİ]l[Iİ]|İnc(?:Ili|İl[Iİ]|ilİ))|ın[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[İI])|inc(?:Il[İi]|İlİ)))|İn[\\s\\xa0]*(?:Inc[Iİ]li|İnc(?:İli|il[iİ])|inc[Iİ]lİ)|in[\\s\\xa0]*(?:incilİ|İnc(?:ili|[Iİ]lİ))|In[\\s\\xa0]*(?:İncİli|inc(?:ilI|İl[İi]))))|Matta(?:’(?:İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Incil[Iiİ]|inc(?:il[iİI]|[Iİ]l[iI]))|un[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:[İI]li|il[iİI])|inc(?:İli|Il[İi]|il[iI]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[İI]li|il[Iİi])|inc(?:İlI|Il[Iİ]|il[Ii]))|In[\\s\\xa0]*(?:inc(?:İlI|Il[iIİ]|il[iİ])|Inc(?:[İI]li|il[İIi])|İnc(?:Ili|il[İiI]))|n(?:un[\\s\\xa0]*(?:inc(?:İli|il[İIi]|Il[İi])|İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[Ii]))|ın[\\s\\xa0]*(?:İnc[iI]li|Inc(?:Ili|il[Iiİ])|inc(?:IlI|il[İiI]|İl[Ii]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[Iİ]li|il[İiI]))|inc[iIİ]l[iIİ])|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[İI])|inc(?:İli|Il[Iiİ]|il[Ii]))|in[\\s\\xa0]*(?:inc(?:[Iİ]li|il[iİI])|Inc[İiI]l[Iiİ]|İnc(?:İli|Il[İI]|il[Ii])))|in[\\s\\xa0]*(?:İnc(?:il[Iİ]|[İI]l[Ii])|Inc[iIİ]l[iİI]|inc(?:[Iİ]l[Iİi]|il[iI]))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*[Ii]ncil|ore[\\s\\xa0]*(?:incIl|Incil)))|'(?:İn[\\s\\xa0]*(?:Inc[Ii]li|İncil[iI]|inc(?:[iI]l[İiI]|İl[Ii]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc[Ii]li|inc(?:[Ii]l[iİI]|İl[iI]))|un[\\s\\xa0]*(?:inc(?:İlI|Il[iİI]|il[Iİ])|İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[Ii]))|n(?:ın[\\s\\xa0]*(?:inc(?:İlI|Il[iİI]|il[Iİ])|Inc(?:[Iİ]li|il[iI])|İncil[Ii])|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:Ili|il[İiI])|inc(?:Ili|il[İIi]|İl[Ii]))|un[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iİ])|İncil[Ii]|inc(?:İlI|il[Iİi]|Il[iI]))|In[\\s\\xa0]*(?:Inc(?:[İI]li|il[Ii])|İnc(?:[Iİ]li|il[iİ])|inc(?:İli|[Ii]l[Iİi]))|in[\\s\\xa0]*(?:inc(?:[İi]l[Iiİ]|Il[Iİ])|Inc[İiI]l[İIi]|İnc(?:İli|il[Iİi]|Il[Ii])))|in[\\s\\xa0]*(?:Inc(?:Il[iİI]|[İi]l[Ii])|inc(?:[iI]l[Iiİ]|İl[İi])|İnc(?:İli|[iI]l[İiI]))|In[\\s\\xa0]*(?:Inc(?:İli|il[İIi])|inc[İiI]l[iIİ]|İnc[iİI]li)|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*[Ii]ncil|ore[\\s\\xa0]*inc[iI]l))|İn[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:[Iİ]li|il[Iİ])|inc(?:İlI|Il[iIİ]|il[Ii])))|Matta(?:a[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:İncil|inc[iİ]l))|'ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|’ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[İi]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|In(?:cilİ|[\\s\\xa0]*(?:İnc(?:İli|ilI)|incİlI))|ın[\\s\\xa0]*(?:inc[Iİ]l[iİ]|İnc(?:İli|il[Iİ]))|in(?:c(?:Ili|İl[iİ])|[\\s\\xa0]*(?:inc(?:Ili|[iİ]lİ)|İnc[İI]lİ))|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[İI]l)|ore[\\s\\xa0]*(?:İncil|inc[iİ]l))|İnc(?:İli|il[iİ])|n(?:ın[\\s\\xa0]*(?:Incilİ|inc(?:ilI|İl[Iİ])|İnc(?:İli|il[İi]))|In[\\s\\xa0]*(?:incİl[Iİ]|İnc(?:İli|ilI))|in[\\s\\xa0]*(?:incIli|IncIlİ|İnc[iİ]lİ)|un[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:IlI|İl[Iİ]))|İn[\\s\\xa0]*(?:Inc[Iİ]li|İnc(?:[Iİ]li|ilİ)|inc[Iİ]lİ))|un[\\s\\xa0]*(?:IncIli|İnc(?:[Iİ]li|ilİ)|inc(?:İl[Iİ]|ilİ)))|Matta(?:İnc(?:Ili|ilI)|in(?:[\\s\\xa0]*(?:İnc(?:il[İiI]|[Iİ]l[Ii])|inc(?:Il[İI]|[iİ]l[iI])|Inc[İIi]l[iİI])|c(?:İlI|il[İiI]|Il[İI]))|un[\\s\\xa0]*(?:Inc(?:İli|il[iIİ])|İncil[Ii]|inc(?:İli|Il[iIİ]|il[iI]))|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*[iI]ncil|ore[\\s\\xa0]*(?:incIl|Incil))|In(?:[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iiİ])|inc(?:[iI]l[İiI]|İl[İi])|İnc(?:Ili|il[İi]))|c(?:[İI]li|il[Ii]))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*[Ii]ncil|ore[\\s\\xa0]*(?:incIl|Incil))|'ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*[iI]ncil|ore[\\s\\xa0]*inc[iI]l)|’ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:incIl|Incil)|ore[\\s\\xa0]*inc[Ii]l)|n(?:un[\\s\\xa0]*(?:inc(?:İli|il[İiI]|Il[İi])|Inc(?:[Iİ]li|il[iI])|İncil[iI])|ın[\\s\\xa0]*(?:inc(?:İli|Il[Iiİ]|il[İi])|İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[iI]))|in[\\s\\xa0]*(?:İnc(?:Il[iIİ]|[İi]l[iI])|inc(?:[İi]l[İIi]|Il[İI])|Inc(?:[İi]l[iİI]|Il[iI]))|İn[\\s\\xa0]*(?:Incil[İIi]|inc(?:il[iIİ]|[Iİ]l[Ii])|İncil[Ii])|In[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iiİ])|İnc(?:Ili|il[iİ])|inc(?:İli|[iI]l[İIi])))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:[Iİ]lI|il[Iiİ])|Inc(?:[Iİ]li|il[İiI])))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Markos(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Markos['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|Mar(?:k(?:os(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))?)?|Markos(?:’(?:In[\\s\\xa0]*(?:Inc[İI]li|incIlİ|İncilİ)|un[\\s\\xa0]*(?:inc(?:Ili|[iİ]lİ)|Incİli|İnc(?:İli|il[iİ]))|n(?:in[\\s\\xa0]*(?:İnc[iİ]l[İi]|incIli|IncİlI)|un[\\s\\xa0]*(?:inc(?:İl[iİ]|il[Iİ])|İnc(?:[Iİ]li|ilİ))|In[\\s\\xa0]*inc[iİ]lİ|ın[\\s\\xa0]*(?:incİl[iİ]|Incil[Iİ]|İnc(?:İli|il[Iİ]))|İn[\\s\\xa0]*(?:Inc(?:İli|ilİ)|inc(?:IlI|İlİ)|İnc(?:İli|il[iİ])))|in[\\s\\xa0]*(?:İnc(?:ili|İl[iİ])|Incİlİ)|ın[\\s\\xa0]*(?:inc[Iİ]l[İI]|İnc(?:[Iİ]li|ilİ))|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*(?:(?:[Iİ]ncil|incİl))|İn[\\s\\xa0]*(?:Incili|İnc(?:[Iİ]li|ilİ)|inc(?:İl[İi]|ilİ)))|'(?:un[\\s\\xa0]*(?:inc(?:IlI|İl[Iİ]|ilİ)|İnc(?:İli|il[Iİ]))|in[\\s\\xa0]*(?:Inc(?:İli|ilİ)|İnc(?:Ili|[iİ]lİ)|incİlİ)|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[İI]l)|öre[\\s\\xa0]*(?:[İI]ncil|incİl))|İn[\\s\\xa0]*(?:Inc(?:İli|il[Iİ])|İnc(?:İli|il[iİ])|incİlİ)|In[\\s\\xa0]*(?:IncilI|İncİli)|ın[\\s\\xa0]*(?:İnc(?:[İI]li|ilİ)|Incilİ|inc(?:IlI|İl[Iİ]))|n(?:In[\\s\\xa0]*İncİli|in[\\s\\xa0]*(?:incilİ|İnc(?:Ili|[iİ]lİ)|Inc(?:Ili|İl[İI]))|ın[\\s\\xa0]*(?:inc(?:Ili|[İi]lİ)|Incİli|İnc(?:İli|il[Iİ]))|un[\\s\\xa0]*(?:IncilI|İnc(?:İli|il[İI])|inc(?:İl[iİ]|ilİ))|İn[\\s\\xa0]*(?:IncIli|İnc(?:İli|il[Iİ])|inc(?:İl[iİ]|ilİ))))|İn[\\s\\xa0]*(?:Incilİ|inc(?:IlI|İl[İI])|İnc(?:İli|il[İI])))|Markos(?:İn[\\s\\xa0]*(?:inc(?:İli|il[Iiİ]|Il[İi])|İnc[Ii]li|Inc(?:[İI]li|il[Ii]))|'(?:ın[\\s\\xa0]*(?:inc(?:İli|il[iİI]|Il[iİ])|Inc(?:[Iİ]li|il[iI])|İncil[iI])|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc[iI]li|inc(?:[iI]l[Iİi]|İl[Ii]))|un[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:[Iİ]li|il[Iiİ])|inc(?:İli|Il[iİ]|il[Ii]))|In[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[İi])|inc[İiI]l[İIi]|İnc(?:Ili|il[Iİi]))|n(?:İn[\\s\\xa0]*(?:Inc(?:İli|il[İIi])|İnc[Ii]li|inc(?:İlI|Il[İIi]|il[iI]))|in[\\s\\xa0]*(?:Inc(?:İli|il[iİI]|Il[İI])|İnc(?:Il[İI]|[iİ]l[iI])|inc(?:[İI]l[İiI]|il[iI]))|In[\\s\\xa0]*(?:Inc(?:[İI]li|il[İIi])|inc[İIi]l[Iİi]|İnc(?:Ili|il[Iiİ]))|un[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:[İI]li|il[iİ])|inc(?:İlI|Il[iİI]|il[Ii]))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:Il[İI]|[iİ]l[iI])|Inc(?:Ili|il[iIİ])))|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*[Ii]ncil|öre[\\s\\xa0]*inc[Ii]l)|in[\\s\\xa0]*(?:Inc(?:Il[iİI]|İl[Iİ]|il[iI])|İnc(?:Il[İI]|[İi]l[Ii])|inc(?:[Ii]l[İiI]|İl[Ii])))|’(?:In[\\s\\xa0]*(?:Incil[Iİi]|İnc(?:[Iİ]li|il[iI])|inc(?:[İi]l[iIİ]|Il[iI]))|ın[\\s\\xa0]*(?:[iI]nc(?:(?:[İI]li|il[İiI]))|İncil[Ii])|İn[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[İI])|İncil[Ii]|inc(?:İlI|Il[iIİ]|il[Ii]))|in[\\s\\xa0]*(?:İnc(?:İlI|Il[İIi]|il[İI])|inc[Iiİ]l[Iİi]|Inc(?:[iI]l[İiI]|İl[Ii]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:Il[İI]|[İi]l[iI])|Inc(?:Ili|il[İIi]))|n(?:In[\\s\\xa0]*(?:[İI]nc(?:(?:[İI]li|il[İiI]))|inc(?:Il[iIİ]|[İi]l[iI]))|ın[\\s\\xa0]*(?:İnc[Ii]li|inc(?:İlI|[iI]l[Iiİ])|Inc[iIİ]li)|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:il[Iiİ]|Il[iİ]|İl[Ii])|Inc(?:Ili|il[iI]))|un[\\s\\xa0]*(?:inc(?:ili|İlI|Il[iİI])|Inc(?:[İI]li|il[Iİi])|İncil[iI])|in[\\s\\xa0]*(?:İnc(?:[İi]lI|Il[iIİ])|inc(?:[İi]l[İIi]|Il[Iİ])|Inc(?:[iI]l[iİI]|İl[İi])))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*inc(?:[iI]l)))|Markos(?:a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[Iİ]l)|öre[\\s\\xa0]*(?:İncil|inc[iİ]l))|n(?:in[\\s\\xa0]*(?:İnc(?:Il[iİ]|İl[Iİ])|Inc(?:ili|İlİ)|incilİ)|ın[\\s\\xa0]*(?:inc(?:İl[iİ]|Il[İI])|İnc(?:İli|il[iİ]))|In[\\s\\xa0]*Incİli|un[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[iİ])|inc(?:il[iİ]|İlİ))|İn[\\s\\xa0]*(?:(?:[Iİ]nc(?:İli|il[iİ]))|incİlİ))|In[\\s\\xa0]*(?:[Iİ]ncilİ|incİlI)|ın[\\s\\xa0]*(?:inc(?:İl[iİ]|Il[İI])|İnc(?:İli|il[Iİ]))|un[\\s\\xa0]*(?:inc(?:IlI|İl[İI]|ilİ)|İnc(?:[Iİ]li|ilİ))|İnc(?:[Iİ]li|ilİ)|ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[iİ]l))|'ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:(?:[İI]ncil|incİl))|in(?:c(?:Il[iİ]|İl[Iİ])|[\\s\\xa0]*(?:Inc(?:IlI|İlİ)|İnc(?:IlI|İl[İi])))|’ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[Iİ]l)))|Markos(?:un[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[İiI])|İncil[iI]|inc(?:İli|Il[İi]|il[iI]))|ya[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:incIl|Incil))|İncil[iI]|In(?:c(?:[İI]li|il[iİI])|[\\s\\xa0]*(?:[İI]nc(?:(?:[Iİ]li|il[iI]))|inc(?:[iI]l[İIi]|İl[iİ])))|’ya[\\s\\xa0]*G[öo]re[\\s\\xa0]*(?:[Ii]ncil)|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*[Ii]ncil|öre[\\s\\xa0]*(?:incIl|Incil))|in(?:c(?:İli|IlI|il[İiI])|[\\s\\xa0]*(?:İnc(?:İlI|il[İiI]|Il[iİ])|Inc(?:il[İiI]|Il[İi]|İl[iI])|inc[İiI]l[iİI]))|'ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*inc(?:[iI]l)|ın[\\s\\xa0]*(?:İnc[Ii]li|inc(?:Ili|İlI|il[İiI])|Inc(?:[İI]li|il[Iiİ]))|n(?:in[\\s\\xa0]*(?:İnc(?:İli|IlI|il[İiI])|Inc(?:Il[Iiİ]|il[İI]|İl[iI])|inc(?:[Iİ]l[İiI]|il[Ii]))|İn[\\s\\xa0]*(?:(?:[İI]nc(?:Ili|ilI))|inc(?:[iI]l[iİI]|İl[Ii]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:Ili|il[Iiİ])|inc(?:ilI|Il[iIİ]|İl[Ii]))|In[\\s\\xa0]*(?:İnc(?:[İI]li|il[Iiİ])|inc[İiI]l[İIi]|Inc(?:Ili|il[Iiİ]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:Ili|İlI|il[Iİi])|Inc(?:[Iİ]li|il[İIi]))))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Luka(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Luka['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|Luk(?:a(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|e)?|Luka(?:’(?:a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[Iİ]l)|öre[\\s\\xa0]*(?:İncil|inc[İi]l))|n(?:In[\\s\\xa0]*(?:Incil[iİ]|İncİli)|İn[\\s\\xa0]*(?:inc(?:İl[İi]|Il[Iİ])|İnc(?:İli|il[İi]))|ın[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|inc(?:IlI|[iİ]lİ)|Incİli)|in[\\s\\xa0]*(?:Incİl[iİ]|İnc(?:Il[iİ]|İlİ))|un[\\s\\xa0]*(?:incİl[iİ]|Inc(?:Ili|ilİ)|İnc(?:[Iİ]li|ilİ)))|In[\\s\\xa0]*incİlI|un[\\s\\xa0]*(?:inc(?:Il[iİ]|İl[Iİ])|İnc(?:[İI]li|ilİ))|İn[\\s\\xa0]*(?:incİl[iİ]|Incil[iİ]|İnc(?:İli|il[İI]))|ın[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:IlI|İl[Iİ]))|in[\\s\\xa0]*(?:İnc(?:ilI|İl[İi]|Ilİ)|inc(?:ilI|[İI]lİ)))|'(?:In[\\s\\xa0]*(?:İnc[iİ]li|IncIli)|n(?:in[\\s\\xa0]*(?:inc(?:ili|Ilİ)|Incİlİ|İnc(?:İl[İi]|ilİ))|In[\\s\\xa0]*(?:İncili|Incİli)|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:Ili|İl[iİ]))|ın[\\s\\xa0]*(?:Inc(?:İli|ilİ)|inc(?:ili|İlİ)|İnc(?:İli|il[İI]))|un[\\s\\xa0]*(?:IncilI|İnc(?:[İI]li|ilİ)|inc(?:İl[Iİ]|ilİ)))|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[iİ]l)|öre[\\s\\xa0]*(?:[Iİ]ncil|incİl))|ın[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Inc(?:İli|il[iİ])|incİlİ)|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incİli|inc(?:il[Iİ]|İlİ))|in[\\s\\xa0]*(?:incİl[Iİ]|IncIlİ|İnc[iİ]lİ)|un[\\s\\xa0]*(?:IncIli|İnc(?:[Iİ]li|ilİ)|inc(?:İl[Iİ]|Ilİ)))|İn[\\s\\xa0]*(?:Incilİ|İnc(?:İli|il[Iİ])|inc(?:ilI|İl[İi])))|Luka(?:'(?:ın[\\s\\xa0]*(?:Inc(?:Ili|ilI)|İncil[iI]|inc(?:[Ii]l[İIi]|İl[Ii]))|n(?:İn[\\s\\xa0]*(?:inc(?:İlI|il[iİI]|Il[İI])|Inc(?:[İI]li|il[Ii])|İncil[Ii])|In[\\s\\xa0]*(?:İnc(?:[İI]li|il[Iİ])|inc[iİI]l[iİI]|Inc(?:Ili|il[İiI]))|in[\\s\\xa0]*(?:inc(?:İl[Iİi]|il[İI]|Il[Ii])|Inc(?:[Ii]l[iİI]|İl[iI])|İnc(?:İlI|Il[İiI]|il[iI]))|ın[\\s\\xa0]*(?:İnc[Ii]li|inc(?:Il[iİI]|il[İI]|İl[iI])|Inc(?:Ili|il[iI]))|un[\\s\\xa0]*(?:Inc(?:[İI]li|il[iİ])|İncil[iI]|inc(?:İli|Il[İIi]|il[iI])))|İn[\\s\\xa0]*(?:İncil[iI]|Inc(?:Ili|il[iIİ])|inc(?:ili|Il[Iİi]|İl[Ii]))|un[\\s\\xa0]*(?:Inc(?:İli|il[Iiİ])|İncil[Ii]|inc(?:İli|il[iIİ]|Il[Ii]))|in[\\s\\xa0]*(?:İnc(?:Il[İiI]|[İi]l[iI])|Inc(?:[İi]l[İIi]|Il[Ii])|inc(?:İli|[Ii]l[Iİi]))|In[\\s\\xa0]*(?:Inc(?:İli|il[İIi])|İnc(?:Ili|il[Iİ])|inc[Iiİ]l[Iİi])|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:incIl|Incil)|öre[\\s\\xa0]*inc[iI]l))|İn[\\s\\xa0]*(?:inc(?:İlI|Il[İIi]|il[iİ])|İnc[iI]li|Inc(?:[Iİ]li|il[iI]))|’(?:n(?:un[\\s\\xa0]*(?:İncil[Ii]|Inc(?:İli|il[Ii])|inc(?:İlI|[Ii]l[Iİi]))|ın[\\s\\xa0]*(?:İncil[iI]|inc(?:Il[İi]|[iİ]l[Ii])|Inc(?:Ili|il[Iİi]))|In[\\s\\xa0]*(?:inc[Iiİ]l[İIi]|İnc(?:Ili|il[İIi])|Inc(?:[Iİ]li|ilI))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:Ili|İlI|il[Iİi])|Inc(?:[Iİ]li|il[İIi]))|in[\\s\\xa0]*(?:inc[İIi]l[Iiİ]|Inc(?:İlI|[Ii]l[İiI])|İnc(?:IlI|il[iİI]|İl[Ii])))|ın[\\s\\xa0]*(?:inc(?:İli|il[iİI]|Il[İi])|Inc(?:[İI]li|il[Ii])|İncil[iI])|In[\\s\\xa0]*(?:[Iİ]nc(?:(?:[İI]li|il[Iiİ]))|inc(?:[iI]l[İIi]|İl[iİ]))|İn[\\s\\xa0]*(?:İnc[Ii]li|inc(?:İlI|[iI]l[Iiİ])|Inc(?:[Iİ]li|ilI))|in[\\s\\xa0]*(?:inc(?:il[İi]|[Iİ]l[iI])|Inc[İIi]l[Iİi]|İnc(?:İlI|il[iİ]|Il[Ii]))|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*[iI]ncil|öre[\\s\\xa0]*(?:incIl|Incil))|un[\\s\\xa0]*(?:inc(?:İli|IlI|il[iİI])|Inc(?:[Iİ]li|il[iIİ])|İncil[iI])))|Luka(?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[iİ]l))|’ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[İI]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|'ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[Iİ]l)|öre[\\s\\xa0]*(?:[İI]ncil|incİl))|n(?:ın[\\s\\xa0]*(?:inc(?:ili|İl[iİ]|Ilİ)|İnc(?:İli|il[İi]))|In[\\s\\xa0]*(?:İncilI|incIlİ)|in[\\s\\xa0]*(?:inc(?:ili|İlİ)|Incİli|İnc(?:İl[iİ]|ilİ))|İn[\\s\\xa0]*(?:IncIli|İnc(?:İli|il[İI])|inc(?:İl[Iİ]|Ilİ))|un[\\s\\xa0]*(?:Incili|İnc(?:İli|il[İi])|inc(?:İl[Iİ]|ilİ)))|un[\\s\\xa0]*(?:Inc[iİ]li|İnc(?:İli|il[İI])|inc[Iİ]lİ)|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[İi]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|in(?:c(?:Ili|İl[Iİ])|[\\s\\xa0]*(?:Incil[iİ]|İnc(?:İl[Iİ]|Ilİ)))|İnc(?:İli|il[Iİ])|ın[\\s\\xa0]*(?:incİl[Iİ]|Incil[İI]|İnc(?:İli|il[Iİ]))|In(?:[\\s\\xa0]*(?:İncIli|Incİli|incİlİ)|cilİ))|Luka(?:İnc[iI]li|ın[\\s\\xa0]*(?:İnc[Ii]li|inc(?:İli|[Ii]l[iIİ])|Inc[Iİi]li)|In(?:[\\s\\xa0]*(?:İnc(?:İli|il[İiI])|inc(?:[iI]l[Iİi]|İl[Ii])|Inc(?:Ili|il[Iiİ]))|c(?:[İI]li|il[iI]))|’ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*[iI]ncil|ore[\\s\\xa0]*inc[Ii]l)|'ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*[iI]ncil|öre[\\s\\xa0]*inc[Ii]l)|in(?:[\\s\\xa0]*(?:inc[iİI]l[Iİi]|Inc(?:ilI|[Iİ]l[İiI])|İnc(?:İli|il[İiI]|Il[iI]))|c(?:İli|il[iİI]|Il[Iİ]))|a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:incIl|Incil))|un[\\s\\xa0]*(?:İnc[Ii]li|inc(?:il[İiI]|[Iİ]l[Ii])|Inc(?:Ili|il[İI]))|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:incIl|Incil)|ore[\\s\\xa0]*inc[Ii]l)|n(?:in[\\s\\xa0]*(?:Inc(?:[iI]l[İiI]|İl[Iİ])|inc(?:Il[Iİi]|il[İI]|İl[iI])|İnc(?:İlI|Il[Iiİ]|il[iI]))|In[\\s\\xa0]*(?:Inc(?:[İI]li|il[Iİi])|İnc(?:[Iİ]li|il[iİ])|inc(?:[iİ]l[İIi]|Il[Ii]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[iİI])|inc(?:İlI|il[İI]|Il[Ii]))|İn[\\s\\xa0]*(?:Inc(?:İli|il[Iİi])|İnc[Ii]li|inc(?:İli|il[İiI]|Il[Ii]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[İI])|inc(?:İli|Il[İiI]|il[iI]))))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        ...
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Yu(?:h(?:anna)?)?|Yu|John|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|I(?:I(?:[\s\xa0]*Yu(?:h(?:anna)?)?|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|k(?:[Iİ](?:[\s\xa0]*Yu(?:h(?:anna)?)?|nc(?:[Iİ][\s\xa0]*Yu(?:h(?:anna)?)?))))|İk(?:[Iİ](?:[\s\xa0]*Yu(?:h(?:anna)?)?|nc(?:[Iİ][\s\xa0]*Yu(?:h(?:anna)?)?)))|Yuhanna(?:(?:['’]n(?:[Iİı]n[\s\xa0]*(?:İk(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|I(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|k(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu))))))|n(?:[Iİı]n[\s\xa0]*(?:İk(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|I(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|k(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu)))))))|(?:Yuhanna(?:(?:['’]n(?:(?:[Iİı]n[\s\xa0]*(?:(?:[İI]k(?:i(?:[\s\xa0]*Mektubu|nc[iIİ][\s\xa0]*Mektubu)|[Iİ]nci[\s\xa0]*Mektubu))|ik(?:[İIi](?:[\s\xa0]*Mektubu|nc[İIi][\s\xa0]*Mektubu))))|in[\s\xa0]*(?:I(?:k(?:[İIi](?:[\s\xa0]*Mektubu|nc[iIİ][\s\xa0]*Mektubu))|I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))|(?:[iİ]k(?:[iIİ](?:[\s\xa0]*Mektubu|nc[iIİ][\s\xa0]*Mektubu)))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))|n(?:(?:[ıİI]n[\s\xa0]*(?:(?:[Iİ]k(?:i(?:[\s\xa0]*Mektubu|nc[Iiİ][\s\xa0]*Mektubu)|[İI]nci[\s\xa0]*Mektubu))|ik(?:[iIİ](?:[\s\xa0]*Mektubu|nc[İIi][\s\xa0]*Mektubu))))|in[\s\xa0]*(?:I(?:k(?:[Iİi](?:[\s\xa0]*Mektubu|nc[İiI][\s\xa0]*Mektubu))|I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))|(?:[İi]k(?:[Iiİ](?:[\s\xa0]*Mektubu|nc[Iiİ][\s\xa0]*Mektubu)))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))|(?:[İI]k(?:(?:[Iİ]nci[\s\xa0]*Yu(?:h(?:anna)?)?)|i(?:[\s\xa0]*Yu(?:h(?:anna)?)?|nc(?:[Iiİ][\s\xa0]*Yu(?:h(?:anna)?)?))))|ik(?:[iIİ](?:[\s\xa0]*Yu(?:h(?:anna)?)?|nc(?:[iIİ][\s\xa0]*Yu(?:h(?:anna)?)?)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[UÜ](?:[cç](?:[\s\xa0]*Yu(?:h(?:anna)?)?|(?:[uü]nc(?:[uü][\s\xa0]*Yu(?:h(?:anna)?)?)))))|3(?:[\s\xa0]*Yu(?:h(?:anna)?)?|Yu|John|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|III(?:[\s\xa0]*Yu(?:h(?:anna)?)?|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|Yuhanna(?:n[Iİı]n[\s\xa0]*(?:(?:[UÜ](?:[cç](?:(?:[uü]nc(?:[uü][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)))|['’]n(?:[Iİı]n[\s\xa0]*(?:(?:[UÜ](?:[cç](?:(?:[uü]nc(?:[uü][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))))|Yuhanna(?:[’']nin[\s\xa0]*(?:(?:[ÜU](?:[cç](?:(?:[üu]nc(?:[uü][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)))|nin[\s\xa0]*(?:[ÜU](?:[çc](?:(?:[üu]nc(?:[üu][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Yuhanna(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Yuhanna['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|(?:John|Yu(?:h(?:anna(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))?)?)|Yuhanna(?:İn[\\s\\xa0]*(?:incİl[Iİ]|Inc(?:Ili|ilİ)|İnc(?:İli|il[İI]))|'(?:in[\\s\\xa0]*(?:Inc(?:ilI|İlİ)|İnc(?:İl[iİ]|Ilİ))|In[\\s\\xa0]*(?:inc(?:İli|ilİ)|İncilI)|ın[\\s\\xa0]*(?:incİl[Iİ]|Incil[İi]|İnc(?:[İI]li|ilİ))|İn[\\s\\xa0]*(?:İnc(?:[İI]li|ilİ)|Inc(?:İli|il[iİ])|incİlİ)|n(?:in[\\s\\xa0]*(?:İnc(?:Ili|İl[Iİ])|Inc[Iİ]lİ)|un[\\s\\xa0]*(?:IncilI|İnc(?:İli|il[iİ])|inc(?:İl[Iİ]|ilİ))|ın[\\s\\xa0]*(?:Inc[iİ]li|İnc(?:İli|il[İi])|inc[İI]lİ)|İn[\\s\\xa0]*(?:inc(?:İl[iİ]|Il[İI])|İnc(?:[Iİ]li|ilİ))|In[\\s\\xa0]*(?:incili|İncilİ|Incİli))|un[\\s\\xa0]*(?:IncIli|İnc(?:İli|il[Iİ])|inc(?:İl[iİ]|Ilİ))|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*(?:(?:[İI]ncil|incİl)))|’(?:n(?:İn[\\s\\xa0]*(?:inc(?:ilI|İl[İi]|Ilİ)|İnc(?:İli|il[İI]))|un[\\s\\xa0]*(?:IncilI|İnc(?:İli|il[Iİ])|inc(?:İl[iİ]|ilİ))|in[\\s\\xa0]*(?:İnc(?:IlI|İl[iİ]|ilİ)|incIlİ|Inc(?:ilI|İl[İi]))|ın[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[iİ])|inc(?:Il[Iİ]|İlİ)))|a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[iİ]l))|in[\\s\\xa0]*(?:Inc(?:ili|İl[İi]|Ilİ)|İnc(?:İl[iİ]|ilİ))|ın[\\s\\xa0]*(?:incİl[iİ]|Inc(?:Ili|ilİ)|İnc(?:İli|il[iİ]))|un[\\s\\xa0]*(?:Inc(?:İli|ilI)|İnc(?:İli|il[Iİ])|inc[Iİ]lİ)|In[\\s\\xa0]*İncili|İn[\\s\\xa0]*(?:[Iİ]nc(?:(?:[Iİ]li|ilİ))|incİlİ)))|Yuhanna(?:’(?:In[\\s\\xa0]*(?:Inc(?:[İI]li|il[Iiİ])|İnc(?:[İI]li|il[Iİ])|inc[İIi]l[İIi])|n(?:İn[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:[İI]li|il[Iİi])|inc(?:İlI|il[iİ]|Il[iI]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:Ili|il[İIi])|inc(?:Ili|il[Iiİ]|İl[Ii]))|in[\\s\\xa0]*(?:Inc(?:İlI|Il[İiI]|il[iİ])|İnc(?:İlI|Il[İi]|il[Ii])|inc(?:[İi]l[iİI]|Il[Ii]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[Iİ]li|il[İiI]))|inc[Iİi]l[iIİ])|un[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[Iİ]li|il[İi])|inc(?:İlI|Il[iIİ]|il[iI])))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:İli|il[Ii])|inc(?:İlI|[Ii]l[iIİ]))|a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:incIl|Incil))|İn[\\s\\xa0]*(?:[Iİ]ncil[iI]|inc(?:[Ii]l[iIİ]|İl[Ii]))|in[\\s\\xa0]*(?:inc[iİI]l[İiI]|Inc(?:İlI|il[İI]|Il[Ii])|İnc(?:İlI|Il[iIİ]|il[iI]))|un[\\s\\xa0]*(?:İnc[Ii]li|inc(?:il[iİI]|[Iİ]l[Ii])|Inc(?:Ili|il[İi])))|İn[\\s\\xa0]*(?:İnc[iI]li|Inc(?:İli|il[Ii])|inc(?:İli|[Ii]l[iİI]))|'(?:ın[\\s\\xa0]*(?:İncil[iI]|inc(?:İli|[Ii]l[İiI])|Inc(?:[Iİ]li|ilI))|İn[\\s\\xa0]*(?:Inc(?:Ili|ilI)|İncil[iI]|inc(?:[iI]l[İiI]|İl[iI]))|In[\\s\\xa0]*(?:Inc(?:[İI]li|il[iİI])|İnc(?:[İI]li|il[iİ])|inc(?:Il[Iİi]|İl[Iİ]|il[iI]))|in[\\s\\xa0]*(?:Inc(?:Il[iİI]|il[iİ]|İl[iI])|inc[Iİi]l[İIi]|İnc(?:İlI|il[iIİ]|Il[iI]))|n(?:In[\\s\\xa0]*(?:İnc(?:[İI]li|il[Ii])|inc(?:[Iİ]l[iIİ]|il[İI])|Inc(?:Ili|il[İIi]))|İn[\\s\\xa0]*(?:inc(?:Ili|İlI|il[iIİ])|Inc(?:[Iİ]li|il[iIİ])|İncil[Ii])|in[\\s\\xa0]*(?:İnc(?:İli|il[iİI]|Il[Iİ])|Inc(?:il[İIi]|[Iİ]l[Ii])|inc[Iİi]l[iİI])|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[İI]li|il[İi])|inc(?:İli|Il[Iiİ]|il[Ii]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:il[Iİi]|[İI]l[iI])|Inc(?:Ili|il[Iİ])))|un[\\s\\xa0]*(?:Inc(?:İli|il[Iiİ])|İnc[iI]li|inc(?:İlI|il[Iiİ]|Il[iI]))|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*inc(?:[Ii]l)))|Yuhanna(?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[iİ]l))|n(?:in[\\s\\xa0]*(?:Inc(?:Ili|İlİ)|İncİlİ)|In[\\s\\xa0]*(?:incilİ|Incİli|İnc(?:İli|il[İi]))|İn[\\s\\xa0]*(?:Incilİ|inc(?:ilI|İl[iİ])|İnc(?:İli|il[İi]))|un[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[Iİ])|inc(?:il[Iİ]|İlİ))|ın[\\s\\xa0]*(?:Inc[İi]li|İnc(?:[İI]li|ilİ)|inc[Iİ]lİ))|in(?:c[iİ]l[iİ]|[\\s\\xa0]*(?:İnc[iİ]l[Iİ]|incili|Incİli))|In[\\s\\xa0]*(?:Incilİ|incİlİ)|'ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[iİ]l)|öre[\\s\\xa0]*(?:[Iİ]ncil|incİl))|İnc(?:[Iİ]li|ilİ)|un[\\s\\xa0]*(?:Incili|İnc(?:İli|il[Iİ])|inc(?:İl[İI]|ilİ))|ın[\\s\\xa0]*(?:Incili|İnc(?:İli|il[İi])|inc(?:İl[iİ]|ilİ))|ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[İI]l)|öre[\\s\\xa0]*(?:İncil|inc[iİ]l))|’ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[iİ]l)))|Yuhanna(?:ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*[Ii]ncil|öre[\\s\\xa0]*(?:incIl|Incil))|İncil[iI]|’ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:incIl|Incil))|in(?:c(?:[iİ]lI|Il[İiI])|[\\s\\xa0]*(?:İnc(?:[İi]li|Il[İIi])|Inc(?:[Ii]l[İiI]|İl[Iİ])|inc(?:[Iİ]l[Iiİ]|il[Iİ])))|a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:incIl|Incil))|'ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:incIl|Incil)|öre[\\s\\xa0]*inc[Ii]l)|n(?:İn[\\s\\xa0]*(?:inc(?:İlI|Il[Iİi]|il[İi])|İnc(?:Ili|ilI)|Inc(?:[İI]li|il[iI]))|un[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:Ili|il[İiI])|inc(?:ili|Il[Iİi]|İl[iI]))|In[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:[İI]l[İIi]|il[Ii])|Inc(?:Ili|il[iIİ]))|in[\\s\\xa0]*(?:Inc(?:il[Iiİ]|Il[Iİ]|İl[Ii])|inc[İIi]l[Iİi]|İnc(?:[Ii]l[Iİi]|İl[Ii]))|ın[\\s\\xa0]*(?:inc(?:il[Iiİ]|[Iİ]l[iI])|İncil[Ii]|Inc(?:Ili|il[İI])))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[Iİ])|inc(?:İlI|Il[İIi]|il[Ii]))|un[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[Iİ]li|il[İI])|inc(?:İli|Il[İIi]|il[Ii]))|In(?:c(?:[İI]li|il[iİI])|[\\s\\xa0]*(?:İnc(?:[İI]li|il[Iiİ])|Inc(?:[Iİ]li|il[Ii])|inc(?:[iI]l[İIi]|İl[Ii]))))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kutsal[\\s\\xa0]*Resuller[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]ler[Iİ]))|E(?:[\\s\\xa0]*[Iİ](?:[sş]ler[Iİ])|l[cç](?:(?:[Iİ]ler(?:[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]ler[Iİ])))|[\\s\\xa0]*[Iİ][sş])))|Ha(?:berc[Iİ]ler(?:[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]ler[Iİ])))|var[Iİ]ler(?:[Iİ]n[\\s\\xa0]*Faal(?:[Iİ]yetler[Iİ])))|Acts)|El[çc]İlerİn[\\s\\xa0]*(?:i(?:[sş]ler[Iiİ]|[İI](?:[sş]leri)))|El[çc]İlerİn[\\s\\xa0]*(?:[İI](?:[sş]leri))|(?:Kutsal[\\s\\xa0]*Resuller(?:in[\\s\\xa0]*(?:Işlerİ|işlerI|İ[şs]lerİ)|In[\\s\\xa0]*(?:İ[sş]leri|islerİ|Isleri)|İn[\\s\\xa0]*(?:İ[şs]leri|i(?:şler[iİ]|slerİ)|Isleri))|Resullerİn[\\s\\xa0]*İ[şs]lerİ|Ha(?:berc(?:iler(?:İn[\\s\\xa0]*(?:işlerİ|I[şs]lerI|İ(?:sler[Iİ]|şlerİ))|in[\\s\\xa0]*(?:Işlerİ|[iİ]slerI))|Iler(?:(?:[Iİ]n[\\s\\xa0]*(?:İşleri|islerİ))|in[\\s\\xa0]*(?:IşlerI|İ[şs]lerİ))|İler(?:in[\\s\\xa0]*(?:i(?:şler[Iİ]|sler[İi])|İ(?:sler[İI]|şlerİ))|In[\\s\\xa0]*İşleri|İn[\\s\\xa0]*(?:İ[şs]leri|i(?:şler[İI]|slerİ)|Isleri)))|var(?:iler(?:In[\\s\\xa0]*Faalİyetlerİ|in[\\s\\xa0]*FaalIyetlerI|İn[\\s\\xa0]*Faal(?:iyetlerİ|IyetlerI|İyetler[Iİ]))|İler(?:In[\\s\\xa0]*Faaliyetlerİ|in[\\s\\xa0]*Faal(?:IyetlerI|İyetler[iİ])|İn[\\s\\xa0]*Faal(?:İyetleri|iyetler[Iİ]))|Iler(?:In[\\s\\xa0]*Faalİyetleri|in[\\s\\xa0]*FaalIyetlerİ)))|E(?:[\\s\\xa0]*(?:İ[şs]leri|i[şs]ler[Iİ])|l(?:c(?:İlerin[\\s\\xa0]*(?:i[şs]ler[Iİ]|İ(?:şler[İI]|sler[iİ]))|[\\s\\xa0]*i[sş]|iler(?:İn[\\s\\xa0]*(?:İ(?:sler[Iİ]|şlerİ)|I[sş]lerİ|islerI)|in[\\s\\xa0]*(?:IslerI|İ(?:şlerI|sler[Iİ])))|Iler(?:İn[\\s\\xa0]*[Iİ]şleri|in[\\s\\xa0]*(?:İşlerİ|IşlerI|i[sş]lerİ)))|ç(?:İler(?:In[\\s\\xa0]*işleri|in[\\s\\xa0]*(?:i(?:sleri|şlerİ)|İ[sş]ler[iİ]|Islerİ))|Iler(?:In[\\s\\xa0]*işleri|İn[\\s\\xa0]*(?:islerİ|İsleri)|in[\\s\\xa0]*(?:i(?:sleri|şlerİ)|İ[sş]ler[iİ]))|[\\s\\xa0]*i[şs]|iler(?:İn[\\s\\xa0]*(?:İ(?:şler[iİ]|slerİ)|I(?:slerI|şler[Iİ]))|in[\\s\\xa0]*islerİ)))))|(?:Resuller(?:[Ii]n[\\s\\xa0]*(?:[iIİ](?:[sş]ler[İiI]))|İn[\\s\\xa0]*(?:İ[sş]ler[Ii]|[iI](?:[sş]ler[iİI])))|Kutsal[\\s\\xa0]*Resuller(?:In[\\s\\xa0]*(?:i(?:şler[İiI]|sler[Ii])|Işleri)|İn[\\s\\xa0]*(?:i(?:şlerI|sler[iI])|Işleri)|in[\\s\\xa0]*(?:İ[sş]ler[iI]|I(?:sler[Iiİ]|şler[iI])|i(?:sler[Iİi]|şler[İi])))|E(?:l(?:ç(?:Iler(?:İn[\\s\\xa0]*(?:i(?:şler[iIİ]|sler[Ii])|İşleri|I[şs]leri)|in[\\s\\xa0]*(?:I[şs]ler[Iİi]|İ[şs]lerI|i(?:şler[Ii]|sler[Iİ]))|In[\\s\\xa0]*(?:[İI](?:[şs]leri)|i(?:sler[iIİ]|şler[Iİ])))|İler(?:in[\\s\\xa0]*(?:I(?:şler[iİI]|sler[Ii])|İ[sş]lerI|i(?:şler[iI]|sler[Iİ]))|In[\\s\\xa0]*(?:[İI](?:[sş]leri)|i(?:sler[iİI]|şler[Iİ])))|iler(?:İn[\\s\\xa0]*(?:i[sş]ler[iİI]|İ(?:şlerI|sler[Ii])|I(?:şleri|sler[iİ]))|In[\\s\\xa0]*[iIİ](?:[sş]ler[Iiİ])|in[\\s\\xa0]*(?:i(?:şler[İIi]|sler[Ii])|[Iİ](?:[şs]ler[İIi]))))?|c(?:İler(?:In[\\s\\xa0]*(?:i[şs]ler[İIi]|[İI](?:[sş]leri))|in[\\s\\xa0]*(?:I[sş]ler[İIi]|İ(?:şleri|slerI)|i[sş]leri))|iler(?:in[\\s\\xa0]*(?:i[şs]ler[Iiİ]|I(?:şler[İIi]|sler[İi])|İ(?:sleri|şler[İi]))|In[\\s\\xa0]*[İIi](?:[sş]ler[İiI])|İn[\\s\\xa0]*(?:I[sş]ler[iI]|İ(?:sleri|şler[Ii])|i(?:şler[iIİ]|sler[İi])))|Iler(?:In[\\s\\xa0]*(?:i[sş]ler[Iiİ]|[Iİ](?:[sş]leri))|İn[\\s\\xa0]*(?:i[sş]ler[Iiİ]|[Iİ]sleri)|in[\\s\\xa0]*(?:i[sş]ler[Ii]|İ(?:sler[iİI]|şler[Ii])|I(?:sler[iİI]|şler[İi]))))?)|[\\s\\xa0]*[iI](?:[sş]leri))|Ha(?:var(?:İler(?:İn[\\s\\xa0]*Faal[iI]yetleri|In[\\s\\xa0]*Faal(?:iyetler[Ii]|[İI]yetleri)|in[\\s\\xa0]*Faal(?:İyetlerI|iyetler[iİI]|Iyetler[iİ]))|iler(?:In[\\s\\xa0]*Faal(?:İyetler[iI]|[iI]yetler[Iiİ])|in[\\s\\xa0]*Faal(?:[İi]yetler[iİI]|Iyetler[İi])|İn[\\s\\xa0]*Faal(?:iyetler[iI]|İyetleri|Iyetler[İi]))|Iler(?:in[\\s\\xa0]*Faal(?:Iyetler[iI]|[iİ]yetler[iİI])|İn[\\s\\xa0]*Faal(?:[Iİ]yetleri|iyetler[iİI])|In[\\s\\xa0]*Faal(?:Iyetleri|iyetler[iIİ])))|berc(?:iler(?:in[\\s\\xa0]*(?:I(?:sler[İIi]|şler[Ii])|(?:[iİ](?:şler[iİI]|sler[iİ])))|In[\\s\\xa0]*[İiI](?:[şs]ler[Iiİ])|İn[\\s\\xa0]*(?:i(?:sler[İiI]|şler[Ii])|İ(?:sleri|şler[iI])|I[sş]ler[İi]))|Iler(?:in[\\s\\xa0]*(?:İ[şs]ler[iI]|i[şs]ler[Iİi]|I(?:sler[iIİ]|şler[İi]))|(?:[İI]n[\\s\\xa0]*(?:i(?:şler[İiI]|sler[Ii])|I[sş]leri|İsleri)))|İler(?:In[\\s\\xa0]*(?:i[şs]ler[Iİi]|I[sş]leri|İsleri)|İn[\\s\\xa0]*(?:i(?:şleri|sler[iI])|Işleri)|in[\\s\\xa0]*(?:I[şs]ler[Iiİ]|İ(?:sleri|şler[iI])|i(?:şleri|slerI)))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Rom|Pavlus(?:['’]tan[\\s\\xa0]*Romal(?:[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)))|tan[\\s\\xa0]*Romal[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|(?:Pavlus(?:[’']tan[\\s\\xa0]*Romal(?:ilar(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[Iİı]lar))|tan[\\s\\xa0]*Romal(?:ilar(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[ıİI]lar))|Romal[İiıI]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?))|Pavlus[’']tan[\\s\\xa0]*Romal(?:[Iİı]lar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:k(?:[Iİ](?:[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|nc(?:[Iİ][\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?)))|I(?:\.[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?))|Kor(?:[Iİ]ntoslular(?:a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))|İk(?:[Iİ](?:[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|nc(?:[Iİ][\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?)))|2(?:\.[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|Ko|[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|Cor)|Pavlus(?:(?:['’]tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))))|tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))))))))|(?:Pavlus(?:tan[\s\xa0]*Kor(?:intl(?:[Iiİ]ler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[İiI](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[Iİ]ntl(?:(?:[İI]ler(?:(?:[’']e[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|iler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:[’']tan[\s\xa0]*Kor(?:intl(?:[iİI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[İi]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]ntl(?:(?:[İI]ler(?:(?:['’]e[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup)))))|iler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[İIi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))))|2(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[Iiİ]ler)?|[Iİ]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[İIi]ler)?|[Iİ]ntliler))|I(?:I(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)?|[Iİ]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[Iiİ]ler)?|[İI]ntliler))|k(?:i(?:[\s\xa0]*Ko(?:r(?:[İIi]nt(?:oslular|l[iIİ]ler)?)?)?|nc(?:[Iİi][\s\xa0]*Ko(?:r(?:[iIİ]nt(?:oslular|l[İiI]ler)?)?)?))|(?:[İI](?:nc(?:(?:[İI][\s\xa0]*Kor(?:int(?:oslular|l[Iiİ]ler)?|[İI]ntliler))|i[\s\xa0]*Ko(?:r(?:[Iiİ]nt(?:oslular|l[Iİi]ler)?)?)?)|[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)?|[İI]ntliler)))))|ik(?:[İIi](?:[\s\xa0]*Ko(?:r(?:[iİI]nt(?:oslular|l[iİI]ler)?)?)?|nc(?:[İIi][\s\xa0]*Ko(?:r(?:[Iiİ]nt(?:oslular|l[Iiİ]ler)?)?)?)))|İk(?:i(?:[\s\xa0]*Ko(?:r(?:[iIİ]nt(?:oslular|l[İiI]ler)?)?)?|nc(?:[iIİ][\s\xa0]*Ko(?:r(?:[iİI]nt(?:oslular|l[İiI]ler)?)?)?))|(?:[İI](?:nc(?:(?:[İI][\s\xa0]*Kor(?:int(?:oslular|l[Iİi]ler)?|[İI]ntliler))|i[\s\xa0]*Ko(?:r(?:[İIi]nt(?:oslular|l[Iİi]ler)?)?)?)|[\s\xa0]*Kor(?:int(?:oslular|l[Iİi]ler)?|[Iİ]ntliler))))|Kor(?:int(?:oslular(?:(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|l(?:[iIİ]ler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|(?:[İI]nt(?:oslular(?:a[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))|(?:[’']a[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|l(?:[İIi]ler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[İi]k(?:[İIi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlus(?:tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:['’]tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))))|B(?:[Iİ]r(?:[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|(?:[Iİ]nc(?:[Iİ][\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?))))|İlk[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|1(?:\.[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|Ko|[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|Cor)|I(?:\.[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?|lk[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler)?)?)?)|Kor(?:[Iİ]ntoslular(?:a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:B(?:ir(?:[\s\xa0]*Ko(?:r(?:[İiI]nt(?:oslular|l[İIi]ler)?)?)?|(?:[iİI]nc(?:[Iİi][\s\xa0]*Ko(?:r(?:[iİI]nt(?:oslular|l[İiI]ler)?)?)?)))|(?:[İI]r(?:(?:[İI]nc(?:(?:[Iİ][\s\xa0]*Kor(?:int(?:oslular|l[iIİ]ler)?|[İI]ntliler))|i[\s\xa0]*Ko(?:r(?:[iİI]nt(?:oslular|l[İiI]ler)?)?)?))|inc(?:[İIi][\s\xa0]*Ko(?:r(?:[iIİ]nt(?:oslular|l[Iiİ]ler)?)?)?)|[\s\xa0]*Kor(?:int(?:oslular|l[İiI]ler)?|[Iİ]ntliler))))|1(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[iIİ]ler)?|[İI]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[İiI]ler)?|[Iİ]ntliler))|İlk[\s\xa0]*Kor(?:int(?:oslular|l[Iiİ]ler)?|[Iİ]ntliler)|Pavlus(?:tan[\s\xa0]*Kor(?:intl(?:[Iİi]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[iIİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İIi]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]ntl(?:iler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[Iİi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[Iİ]ler(?:(?:[’']e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[İiI]nc(?:[iIİ][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[iİI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[iIİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[İIi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))))|(?:[’']tan[\s\xa0]*Kor(?:intl(?:[İiI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İIi]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İIi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[Iİ]ntl(?:iler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[Iiİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[Iİ]ler(?:(?:['’]e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[iİI][\s\xa0]*Mektup))|[İI]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[İiI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iiİ][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))))))|ilk[\s\xa0]*Ko(?:r(?:[Iİi]nt(?:oslular|l[Iiİ]ler)?)?)?|Kor(?:int(?:l(?:[iİI]ler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[İiI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|oslular(?:(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[İiI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[İiI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]nt(?:l(?:[Iiİ]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[Iİi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[Iiİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|oslular(?:a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[Iiİ][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iiİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)|(?:[’']a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup))|[İI]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[iİI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))))|I(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[iIİ]ler)?|[Iİ]ntliler)|lk[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)?|[Iİ]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[İiI]ler)?|[İI]ntliler))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pavlus(?:tan[\\s\\xa0]*Galatyal[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))|['’]tan[\\s\\xa0]*Galatyal(?:[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|Gal)|(?:Pavlus(?:tan[\\s\\xa0]*Galatyal(?:ilar(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[İıI]lar)|['’]tan[\\s\\xa0]*Galatyal(?:ilar(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[ıIİ]lar)))|Galatyal[Iıiİ]lar(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?))|Pavlus[’']tan[\\s\\xa0]*Galatyal(?:[ıİI]lar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pavlus(?:tan[\\s\\xa0]*Efesl[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|['’]tan[\\s\\xa0]*Efesl(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|E(?:ph|f(?:e(?:s(?:oslular(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))?)?)?))|Pavlus(?:['’]tan[\\s\\xa0]*Efesliler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|tan[\\s\\xa0]*Efesliler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|(?:Pavlus(?:tan[\\s\\xa0]*Efesl[Iİ]ler|[’']tan[\\s\\xa0]*Efesl(?:[iİ]ler))|Efes(?:oslular|l(?:Iler’e[\\s\\xa0]*Mektup|iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|EfeslIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|(?:Efesl(?:iler(?:’e[\\s\\xa0]*Mektup)?|[Iİ]ler)|Pavlus(?:tan[\\s\\xa0]*Efesliler|['’]tan[\\s\\xa0]*EfeslIler)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlus(?:['’]tan[\\s\\xa0]*F(?:[Iİ]l(?:[Iİ]p(?:[Iİ]l(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))))|tan[\\s\\xa0]*F[Iİ]l(?:[Iİ]p(?:[Iİ]l(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))))|hil)|F(?:il|lp))|Pavlus(?:’tan[\\s\\xa0]*Fİlİp(?:İliler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:ilere[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ililer[’']e[\\s\\xa0]*Mektup)|'tan[\\s\\xa0]*Fİlİp(?:İliler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:ilere[\\s\\xa0]*Mektup|Iler['’]e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|tan[\\s\\xa0]*Fİlİp(?:İliler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ililer(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Pavlus(?:'tan[\\s\\xa0]*Fİlİp(?:Ililer(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:Ilere[\\s\\xa0]*Mektup|iler[’']e[\\s\\xa0]*Mektup))|’tan[\\s\\xa0]*Fİlİp(?:Ililere[\\s\\xa0]*Mektup|il(?:iler[’']e[\\s\\xa0]*Mektup|Iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|tan[\\s\\xa0]*Fİlİp(?:Ililer'e[\\s\\xa0]*Mektup|il(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|(?:Pavlus(?:tan[\\s\\xa0]*F(?:il(?:ip(?:ilIlere[\\s\\xa0]*Mektup|İl(?:İlere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup)|Ilİler'e[\\s\\xa0]*Mektup)|Ipİl(?:ilere[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup)|İp(?:İl(?:iler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ilİler'e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup))|Il(?:İp(?:il(?:ilere[\\s\\xa0]*Mektup|Iler[’']e[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup)|İlilere[\\s\\xa0]*Mektup)|ip(?:il(?:İler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|İl[iİ]ler'e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup)|Ipililer’e[\\s\\xa0]*Mektup)|İl(?:Ip(?:Ililer'e[\\s\\xa0]*Mektup|İlilere[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|İp(?:İl[Iİ]ler|il[İi]ler)|ip(?:Ilİler’e[\\s\\xa0]*Mektup|İl(?:Iler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler'e[\\s\\xa0]*Mektup))))|'tan[\\s\\xa0]*F(?:il(?:Ip(?:İlİler’e[\\s\\xa0]*Mektup|IlIler’e[\\s\\xa0]*Mektup)|ip(?:Il[İi]ler'e[\\s\\xa0]*Mektup|İlİler'e[\\s\\xa0]*Mektup)|İp(?:İl(?:Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:ilere[\\s\\xa0]*Mektup|Iler['’]e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ilİler'e[\\s\\xa0]*Mektup))|Il(?:Ip(?:ilİler’e[\\s\\xa0]*Mektup|İliler’e[\\s\\xa0]*Mektup)|ip(?:il[İi]lere[\\s\\xa0]*Mektup|İl(?:İlere[\\s\\xa0]*Mektup|Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İpİliler’e[\\s\\xa0]*Mektup)|İl(?:İp[İI]l(?:[İI]ler)|Ip(?:İliler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|ip(?:il(?:[İi]ler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|İl(?:ilere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Il(?:Ilere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))))|’tan[\\s\\xa0]*F(?:il(?:Ip(?:Il(?:İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler'e[\\s\\xa0]*Mektup)|İlİler'e[\\s\\xa0]*Mektup)|İp(?:İl(?:Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|IlIler’e[\\s\\xa0]*Mektup|il(?:İlere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup))|ipİliler’e[\\s\\xa0]*Mektup)|İl(?:ip(?:İl(?:ilere[\\s\\xa0]*Mektup|Iler['’]e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Il(?:İler['’]e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|il(?:Ilere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup))|Ipilİlere[\\s\\xa0]*Mektup|İp(?:il[İI]ler|İl[iİ]ler))|Il(?:ip(?:ilIlere[\\s\\xa0]*Mektup|Ilİler’e[\\s\\xa0]*Mektup|İl(?:Ilere[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler'e[\\s\\xa0]*Mektup))|İpil(?:Ilere[\\s\\xa0]*Mektup|İler['’]e[\\s\\xa0]*Mektup)|IpilIler’e[\\s\\xa0]*Mektup)))|Fİlİp(?:Il(?:[İi]ler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il[iİ]ler'e[\\s\\xa0]*Mektup))|(?:Fİlİp(?:İlIler'e[\\s\\xa0]*Mektup|Il[İi]ler'e[\\s\\xa0]*Mektup)|Pavlus(?:'tan[\\s\\xa0]*F(?:il(?:İp(?:Il(?:İlere[\\s\\xa0]*Mektup|Iler’e[\\s\\xa0]*Mektup)|İlIler’e[\\s\\xa0]*Mektup|il[İi]ler'e[\\s\\xa0]*Mektup)|Ip(?:ilIler’e[\\s\\xa0]*Mektup|[İI]lİler'e[\\s\\xa0]*Mektup)|ip(?:IlIler'e[\\s\\xa0]*Mektup|ilIlere[\\s\\xa0]*Mektup|İl(?:İlere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup)))|İl(?:Ipil(?:Ilere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup)|ipİlIlere[\\s\\xa0]*Mektup)|Il(?:ip(?:İlİler’e[\\s\\xa0]*Mektup|Ilİler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İpil(?:Ilere[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup)))|’tan[\\s\\xa0]*F(?:Il(?:Ipİlilere[\\s\\xa0]*Mektup|ipİlİler'e[\\s\\xa0]*Mektup|İp(?:Ililere[\\s\\xa0]*Mektup|İliler’e[\\s\\xa0]*Mektup))|il(?:Ip(?:İl(?:iler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler'e[\\s\\xa0]*Mektup)|ilİler’e[\\s\\xa0]*Mektup)|ip(?:il[iİ]lere[\\s\\xa0]*Mektup|Il(?:Iler[’']e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|İp(?:İl(?:ilere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|Ilİler’e[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup))|İl(?:Ipİliler'e[\\s\\xa0]*Mektup|ip(?:İl(?:Ilere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup)|ilİlere[\\s\\xa0]*Mektup)))|tan[\\s\\xa0]*F(?:Il(?:İp(?:İliler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|Ipİliler’e[\\s\\xa0]*Mektup|ipIlilere[\\s\\xa0]*Mektup)|ilIpİlİlere[\\s\\xa0]*Mektup|İl(?:Ip(?:İliler’e[\\s\\xa0]*Mektup|il(?:Ilere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|ipIliler’e[\\s\\xa0]*Mektup))))|(?:Pavlus(?:’tan[\\s\\xa0]*F(?:il(?:ip(?:il(?:[İi]ler(?:[’']e[\\s\\xa0]*Mektup)|Iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Il(?:Ilere[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İp(?:İliler’e[\\s\\xa0]*Mektup|Il(?:[iI]lere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup)|il(?:[iI]lere[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup))|Ip(?:Il(?:İler’e[\\s\\xa0]*Mektup|Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[Ii]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İl(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|Il(?:ip(?:il(?:Iler[’']e[\\s\\xa0]*Mektup|[iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İl(?:Iler[’']e[\\s\\xa0]*Mektup|iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Il(?:İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[Ii]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|Ip(?:Ililer(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İliler['’]e[\\s\\xa0]*Mektup)|İp(?:ililere[\\s\\xa0]*Mektup|İliler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İl(?:ip(?:İliler'e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup)|Ipİliler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|'tan[\\s\\xa0]*F(?:Il(?:Ip(?:Ililer(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[iI]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|ip(?:İl(?:[iI]ler’e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup)|il(?:[İi]ler(?:[’']e[\\s\\xa0]*Mektup)|Iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Il(?:İler'e[\\s\\xa0]*Mektup|[iI]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|İp(?:Ililer(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:Iler['’]e[\\s\\xa0]*Mektup|İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|il(?:İp(?:Il(?:İler’e[\\s\\xa0]*Mektup|Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İliler’e[\\s\\xa0]*Mektup|il(?:Ilere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup))|Ip(?:Il(?:Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:İlere[\\s\\xa0]*Mektup|[Ii]ler’e[\\s\\xa0]*Mektup)|il(?:Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[İi]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|ip(?:İl[İI]ler’e[\\s\\xa0]*Mektup|il(?:Iler[’']e[\\s\\xa0]*Mektup|[İi]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Il(?:[İIi]ler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|İl(?:ip(?:Ililere[\\s\\xa0]*Mektup|il(?:[iI]lere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|Ip[İIi]lilere[\\s\\xa0]*Mektup))|tan[\\s\\xa0]*F(?:İl(?:Ip(?:il(?:Iler’e[\\s\\xa0]*Mektup|iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ililer(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ip(?:İliler’e[\\s\\xa0]*Mektup|ilIler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Il(?:ilere[\\s\\xa0]*Mektup|Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler'e[\\s\\xa0]*Mektup)))|il(?:İp(?:İlIler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|ip(?:ililere[\\s\\xa0]*Mektup|Il[Ii]lere[\\s\\xa0]*Mektup|İlIler’e[\\s\\xa0]*Mektup)|Ip(?:[iI]l(?:[iI]lere[\\s\\xa0]*Mektup)|İl[iI]ler’e[\\s\\xa0]*Mektup))|Il(?:ip(?:İl(?:İlere[\\s\\xa0]*Mektup|[iI]ler’e[\\s\\xa0]*Mektup)|IlIlere[\\s\\xa0]*Mektup|il[Ii]lere[\\s\\xa0]*Mektup)|Ip(?:Ililere[\\s\\xa0]*Mektup|il[iI]lere[\\s\\xa0]*Mektup))))|Fİlİp[Ii]lIler'e[\\s\\xa0]*Mektup)|Pavlus’tan[\\s\\xa0]*FilİpIlİlere[\\s\\xa0]*Mektup|(?:F(?:Il(?:İpİlİler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|ipİlİlere[\\s\\xa0]*Mektup)|il(?:İpİlIler’e[\\s\\xa0]*Mektup|Ip(?:Ililere[\\s\\xa0]*Mektup|İliler’e[\\s\\xa0]*Mektup))|İl(?:ipİlİler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İp(?:il(?:[İi]ler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler))|Ipİlİler'e[\\s\\xa0]*Mektup))|Pavlus(?:tan[\\s\\xa0]*F(?:il(?:İp(?:ililere[\\s\\xa0]*Mektup|İliler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Il(?:İler['’]e[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup))|Ip(?:İlIler'e[\\s\\xa0]*Mektup|il(?:Iler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|ipİlİler'e[\\s\\xa0]*Mektup)|İl(?:ip(?:Ililer'e[\\s\\xa0]*Mektup|İl(?:Ilere[\\s\\xa0]*Mektup|İler)|ilİlere[\\s\\xa0]*Mektup)|İp(?:İliler|Il[iİ]ler)|Ip(?:İliler'e[\\s\\xa0]*Mektup|ilİler’e[\\s\\xa0]*Mektup))|Il(?:Ip(?:İlilere[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup)|İpİlİler|ip(?:Ililer'e[\\s\\xa0]*Mektup|İlİler’e[\\s\\xa0]*Mektup)))|'tan[\\s\\xa0]*F(?:il(?:İpİl(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler)|Ipİl(?:İler|Iler'e[\\s\\xa0]*Mektup))|Il(?:İpil[Iİ]ler|ip(?:IlIler|İlilere[\\s\\xa0]*Mektup|ilİler))|İl(?:ip(?:İlIler’e[\\s\\xa0]*Mektup|Il(?:İlere[\\s\\xa0]*Mektup|Iler['’]e[\\s\\xa0]*Mektup))|İp(?:[Iİ]liler|ilİler)|Ip(?:ilİler’e[\\s\\xa0]*Mektup|İl(?:İler|iler'e[\\s\\xa0]*Mektup))))|’tan[\\s\\xa0]*F(?:Il(?:İp(?:İliler|ilIler’e[\\s\\xa0]*Mektup|Il(?:İler|iler'e[\\s\\xa0]*Mektup))|ipilİler|Ip[Iİ]liler)|İl(?:ip(?:Ililere[\\s\\xa0]*Mektup|il[Iİ]ler'e[\\s\\xa0]*Mektup|İlİler)|İp(?:İlIler|Il[iİ]ler)|Ip(?:İliler|il[Iİ]ler’e[\\s\\xa0]*Mektup))|il[iİ]pİlİler)))|(?:Pavlus(?:’tan[\\s\\xa0]*Fİl(?:Ipilİler'e[\\s\\xa0]*Mektup|ip(?:IlIlere[\\s\\xa0]*Mektup|ilİler’e[\\s\\xa0]*Mektup))|'tan[\\s\\xa0]*F(?:ilipİl(?:ilere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|İlipilİlere[\\s\\xa0]*Mektup)|tan[\\s\\xa0]*F(?:Ilİp(?:İliler'e[\\s\\xa0]*Mektup|il(?:iler’e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|İl(?:Ipililer'e[\\s\\xa0]*Mektup|ip(?:İl(?:ilere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|ilİler’e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup))|il(?:ip[iİ]lİler’e[\\s\\xa0]*Mektup|Ip(?:İliler'e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup)|İpilİler’e[\\s\\xa0]*Mektup)))|F(?:il(?:İpİlİler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|ipİlİlere[\\s\\xa0]*Mektup)|İlipİlİler'e[\\s\\xa0]*Mektup))|(?:F[Ii]lIpİlİlere[\\s\\xa0]*Mektup|Pavlus(?:'tan[\\s\\xa0]*F(?:Il(?:ipİliler'e[\\s\\xa0]*Mektup|Ipİliler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:ipİl(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|Ipİl(?:Ilere[\\s\\xa0]*Mektup|iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|tan[\\s\\xa0]*F(?:İl(?:ip(?:IlIler'e[\\s\\xa0]*Mektup|il[Ii]ler'e[\\s\\xa0]*Mektup)|IpilIler'e[\\s\\xa0]*Mektup)|Il(?:Ip(?:İliler'e[\\s\\xa0]*Mektup|ilİler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ip(?:İlIler'e[\\s\\xa0]*Mektup|Ilİler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|İpIliler’e[\\s\\xa0]*Mektup)|il(?:ip(?:Ilİler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İl[iI]ler'e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|İp(?:il[Ii]ler’e[\\s\\xa0]*Mektup|IlIler’e[\\s\\xa0]*Mektup)|IpIlİler’e[\\s\\xa0]*Mektup))|’tan[\\s\\xa0]*Fİl(?:Ip(?:Ililere[\\s\\xa0]*Mektup|il[iI]lere[\\s\\xa0]*Mektup)|ipililere[\\s\\xa0]*Mektup)))|(?:F(?:Il(?:Ipİlİler’e[\\s\\xa0]*Mektup|İpIlİler’e[\\s\\xa0]*Mektup|ip(?:IlIlere[\\s\\xa0]*Mektup|İliler’e[\\s\\xa0]*Mektup))|il(?:ip(?:İliler'e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup)|İp(?:İliler’e[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup)|Ipilİler’e[\\s\\xa0]*Mektup)|İl(?:İp(?:İliler|il(?:Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler))|Ip(?:il[İi]lere[\\s\\xa0]*Mektup|İl(?:ilere[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|ipIlİler'e[\\s\\xa0]*Mektup))|Pavlus(?:’tan[\\s\\xa0]*F(?:Il(?:İp(?:il(?:İlere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|İlİler)|Ipİlİler)|İl(?:İpililer|ipil(?:Iler’e[\\s\\xa0]*Mektup|İler|iler'e[\\s\\xa0]*Mektup)|Ipİl[Iİ]ler)|il(?:ip(?:İliler|Il[Iİ]ler)|İp(?:İliler|ilIler’e[\\s\\xa0]*Mektup|Ilİler)))|tan[\\s\\xa0]*F(?:Il(?:İpil(?:Ilere[\\s\\xa0]*Mektup|İler|iler'e[\\s\\xa0]*Mektup)|ipil(?:Iler’e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|il(?:İpİl(?:Iler(?:e[\\s\\xa0]*Mektup)?|İler)|ipİliler(?:e[\\s\\xa0]*Mektup)?|Ip(?:ililer'e[\\s\\xa0]*Mektup|İlİler'e[\\s\\xa0]*Mektup))|İl(?:İpilIler|ip(?:İliler|ilİler)|Ip(?:ilIler|İlİler)))|'tan[\\s\\xa0]*F(?:İl(?:ip(?:Ilİler’e[\\s\\xa0]*Mektup|ilIler’e[\\s\\xa0]*Mektup|İl(?:iler['’]e[\\s\\xa0]*Mektup|İler))|İpilIler|Ipililer'e[\\s\\xa0]*Mektup)|il(?:İpIliler|ip(?:IlIler|İl[Iİ]ler)|IpIlİler)|Ilİp(?:İl(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler)|Ilİler))))|(?:F(?:İl(?:IpİlIlere[\\s\\xa0]*Mektup|ipil[İi]lere[\\s\\xa0]*Mektup|İpIlIler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Il(?:Ipİliler’e[\\s\\xa0]*Mektup|ipililere[\\s\\xa0]*Mektup)|ilİpilİler’e[\\s\\xa0]*Mektup)|Pavlustan[\\s\\xa0]*F(?:ilIpilİler'e[\\s\\xa0]*Mektup|IlİpIliler'e[\\s\\xa0]*Mektup))|(?:Pavlustan[\\s\\xa0]*F(?:IlipIlİler'e[\\s\\xa0]*Mektup|il(?:IpIlİler'e[\\s\\xa0]*Mektup|ipilİler'e[\\s\\xa0]*Mektup|İp(?:Ililer'e[\\s\\xa0]*Mektup|il[iI]ler'e[\\s\\xa0]*Mektup)))|F(?:il(?:İpIlİler’e[\\s\\xa0]*Mektup|Ip(?:IlIlere[\\s\\xa0]*Mektup|il[Ii]lere[\\s\\xa0]*Mektup|İlIler’e[\\s\\xa0]*Mektup)|ip(?:[iI]l(?:[iI]lere[\\s\\xa0]*Mektup)|İl[iI]ler’e[\\s\\xa0]*Mektup))|Il(?:ip(?:Ililere[\\s\\xa0]*Mektup|ilIlere[\\s\\xa0]*Mektup|İlIler’e[\\s\\xa0]*Mektup)|İpilİler’e[\\s\\xa0]*Mektup|Ip(?:[Ii]l(?:[iI]lere[\\s\\xa0]*Mektup)|İlIler’e[\\s\\xa0]*Mektup))|İl(?:ip(?:Il[İiI]lere[\\s\\xa0]*Mektup|ilIlere[\\s\\xa0]*Mektup|İl[Ii]lere[\\s\\xa0]*Mektup)|Ip(?:Il[İiI]lere[\\s\\xa0]*Mektup|ilIlere[\\s\\xa0]*Mektup))))|(?:Pavlus(?:'tan[\\s\\xa0]*F(?:İl(?:ip(?:ililer'e[\\s\\xa0]*Mektup|Ilİler)|İpililer|Ip(?:İliler|ililer’e[\\s\\xa0]*Mektup))|il(?:IpİlIler|İp(?:[İi]liler|Ilİler)|ipIlİler)|Il(?:IpIlIler|ipİlİler))|’tan[\\s\\xa0]*F(?:il(?:İp(?:Ililer’e[\\s\\xa0]*Mektup|ilİler)|Ip[Iİ]lIler)|İl(?:Ip(?:Ililer'e[\\s\\xa0]*Mektup|ililer’e[\\s\\xa0]*Mektup)|İpIlIler|ip(?:İliler|Ilİler))|Il(?:ipİlİler|İp(?:ililer'e[\\s\\xa0]*Mektup|İlIler)|Ipilİler))|tan[\\s\\xa0]*F(?:il(?:IpIl(?:Iler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|İpIl(?:Iler(?:e[\\s\\xa0]*Mektup)?|İler))|İl(?:Ip(?:IlIler|ilİler)|ipİlIler|İpIlIler)|Il(?:Ip[İI]lİler|İpİlIler|ipİl(?:ilere[\\s\\xa0]*Mektup|Iler))))|F(?:Il(?:Ipilİlere[\\s\\xa0]*Mektup|İp(?:İliler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Ilİlere[\\s\\xa0]*Mektup)|ipilİler’e[\\s\\xa0]*Mektup)|il(?:Ipİlİler[’']e[\\s\\xa0]*Mektup|İp(?:Ilİler'e[\\s\\xa0]*Mektup|İlİler)|ip(?:İlIler'e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup))|İl(?:Ip(?:Ilİler'e[\\s\\xa0]*Mektup|İliler[’']e[\\s\\xa0]*Mektup)|İp(?:İlIler|Ilİler)|ip(?:Ilİler’e[\\s\\xa0]*Mektup|İlİler))))|(?:F(?:ilİpİlIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Il(?:İp(?:İlIler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|ip(?:İlİler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)))|Pavlus’tan[\\s\\xa0]*F(?:İlIpililer'e[\\s\\xa0]*Mektup|ilİpIliler'e[\\s\\xa0]*Mektup))|(?:Pavlus’tan[\\s\\xa0]*F(?:ilİp[Ii]lIler'e[\\s\\xa0]*Mektup|İl(?:ipIliler'e[\\s\\xa0]*Mektup|IpilIler'e[\\s\\xa0]*Mektup))|F(?:Il(?:[iI]pIlİlere[\\s\\xa0]*Mektup|İpİlIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:Ip[iI]lİlere[\\s\\xa0]*Mektup|ip(?:İlİler’e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|İp(?:İliler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[Ii]lİlere[\\s\\xa0]*Mektup))))|Pavlustan[\\s\\xa0]*FilipİlIlere[\\s\\xa0]*Mektup|(?:Pavlus(?:'tan[\\s\\xa0]*F(?:İl(?:ip(?:Ililer'e[\\s\\xa0]*Mektup|İlIler|ilİler)|IpilIler’e[\\s\\xa0]*Mektup)|il(?:İp(?:IlIler|ilİler)|IpilIler|ipilİler)|Il(?:İpİliler|ipİlIler|Ipİlİler))|tan[\\s\\xa0]*F(?:il(?:İp(?:İliler|ilIlere[\\s\\xa0]*Mektup)|Ip(?:İl[iİ]ler|Ilİler)|ipIliler'e[\\s\\xa0]*Mektup)|Il(?:İpIl[İi]ler|ipIlIler’e[\\s\\xa0]*Mektup)|İlIp(?:İliler|Il[iİ]ler))|’tan[\\s\\xa0]*F(?:İl(?:ipİlIler|Ip(?:Ililer’e[\\s\\xa0]*Mektup|ilİler))|Il(?:Ip(?:ilIler|Ilİler)|ipİlIler|İpilİler)|il(?:Ipİlİler|İp(?:İlIler|ililer’e[\\s\\xa0]*Mektup))))|F(?:ilipilİler['’]e[\\s\\xa0]*Mektup|Il(?:Ipİliler'e[\\s\\xa0]*Mektup|İp(?:ililer'e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup|İlİler)|ipİlİler'e[\\s\\xa0]*Mektup)|İl(?:Ip(?:İl(?:Iler’e[\\s\\xa0]*Mektup|İler)|ilİler'e[\\s\\xa0]*Mektup)|İpililer|ip(?:İlIler'e[\\s\\xa0]*Mektup|ilİler’e[\\s\\xa0]*Mektup))))|(?:Pavlus(?:tan[\\s\\xa0]*F(?:ilIpİlIlere[\\s\\xa0]*Mektup|IlipİlIlere[\\s\\xa0]*Mektup)|’tan[\\s\\xa0]*F(?:İlipIl[iI]ler’e[\\s\\xa0]*Mektup|Ilİp[iI]liler’e[\\s\\xa0]*Mektup)|'tan[\\s\\xa0]*Fİl(?:Ip(?:ilIler'e[\\s\\xa0]*Mektup|Ililer['’]e[\\s\\xa0]*Mektup)|ipIliler’e[\\s\\xa0]*Mektup))|F(?:ilipİlİler'e[\\s\\xa0]*Mektup|İl(?:ipilİler'e[\\s\\xa0]*Mektup|Ip[iI]lİler’e[\\s\\xa0]*Mektup)|Il(?:İpilİler'e[\\s\\xa0]*Mektup|Ipİlİler'e[\\s\\xa0]*Mektup)))|Pavlustan[\\s\\xa0]*FIlİpIlilere[\\s\\xa0]*Mektup|(?:F(?:il(?:ipIlİler’e[\\s\\xa0]*Mektup|İpilIler’e[\\s\\xa0]*Mektup|Ip(?:İl(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|ilİler'e[\\s\\xa0]*Mektup))|İl(?:IpİlIler'e[\\s\\xa0]*Mektup|İpIliler|ip(?:ilIler'e[\\s\\xa0]*Mektup|İlIler’e[\\s\\xa0]*Mektup|Ililer’e[\\s\\xa0]*Mektup))|IlİpIlIler'e[\\s\\xa0]*Mektup)|Pavlus(?:'tan[\\s\\xa0]*F(?:IlIpIlİler|il(?:ipİliler|IpIlIler|İp[İi]lIler)|İlIp(?:İlIler|Il[İi]ler))|’tan[\\s\\xa0]*F(?:il(?:Ipİliler|İpilIler|ipilİler)|İlIpIl[Iİ]ler|IlipilIler)|tan[\\s\\xa0]*F(?:il(?:İp(?:Ililer|ilİler)|ip(?:IlIler'e[\\s\\xa0]*Mektup|ililer’e[\\s\\xa0]*Mektup|İlİler)|Ipilİler)|Il[İi]pİliler|İl(?:ip(?:ilIler|Ilİler)|IpİlIler))))|(?:Pavlustan[\\s\\xa0]*Fil(?:İpIlilere[\\s\\xa0]*Mektup|ipililer'e[\\s\\xa0]*Mektup)|FIl(?:ipİliler'e[\\s\\xa0]*Mektup|İpIliler’e[\\s\\xa0]*Mektup))|(?:Pavlustan[\\s\\xa0]*F(?:il(?:Ip[Ii]lIler'e[\\s\\xa0]*Mektup|ipilIler'e[\\s\\xa0]*Mektup)|Il(?:ip(?:ililer'e[\\s\\xa0]*Mektup|IlIler'e[\\s\\xa0]*Mektup)|Ip(?:Ililer'e[\\s\\xa0]*Mektup|il[iI]ler'e[\\s\\xa0]*Mektup)))|F(?:Il(?:[Ii]pİlIler'e[\\s\\xa0]*Mektup|İp(?:il[Ii]ler’e[\\s\\xa0]*Mektup|IlIler’e[\\s\\xa0]*Mektup))|il(?:IpİlIler'e[\\s\\xa0]*Mektup|İp(?:Il[iI]ler’e[\\s\\xa0]*Mektup|ililer’e[\\s\\xa0]*Mektup))))|(?:F(?:il(?:İp(?:il(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|Ilİler)|ip(?:IlIler'e[\\s\\xa0]*Mektup|İlilere[\\s\\xa0]*Mektup))|Il(?:Ipilİler'e[\\s\\xa0]*Mektup|ipIlİler’e[\\s\\xa0]*Mektup)|İl(?:ip[iİ]liler(?:['’]e[\\s\\xa0]*Mektup)|İpIlIler))|Pavlus(?:’tan[\\s\\xa0]*F(?:il(?:Ip(?:ilIler|Ilİler)|İpIlIler)|IlIpİlIler|İlIpIliler)|'tan[\\s\\xa0]*F(?:İl(?:ipİliler|Ipil[Iİ]ler)|il(?:Ipİliler|ipIliler)|Il(?:Ipilİler|İp(?:Ililer|İlIler)))|tan[\\s\\xa0]*F(?:ilIpililer’e[\\s\\xa0]*Mektup|Il(?:İpIlIler|ipİlİler|Ip(?:İlIler|ilİler))|İlIpililer)))|F(?:Ilİp(?:Ililer'e[\\s\\xa0]*Mektup|ilIler'e[\\s\\xa0]*Mektup)|ilİp(?:ilIler'e[\\s\\xa0]*Mektup|Il[Ii]ler'e[\\s\\xa0]*Mektup))|(?:F(?:İl(?:ip(?:Ililer'e[\\s\\xa0]*Mektup|İliler|ilİler)|İpilIler|IpilIler’e[\\s\\xa0]*Mektup)|Il(?:İpIl(?:ilere[\\s\\xa0]*Mektup|İler)|ipIlIler'e[\\s\\xa0]*Mektup)|il(?:ipİl(?:Ilere[\\s\\xa0]*Mektup|İler)|İpİliler|IpIlİler['’]e[\\s\\xa0]*Mektup))|Pavlus(?:'tan[\\s\\xa0]*F(?:Il(?:Ipİliler|İpililer)|ilIp(?:Ililer|ilİler)|İlIpililer)|’tan[\\s\\xa0]*F(?:IlİpIlIler|İlIpililer|il(?:Ipilİler|ip(?:ililer|İlIler)))|tan[\\s\\xa0]*F(?:Il(?:İpililer|ipIlİler)|ilip(?:İlIler|ilIler’e[\\s\\xa0]*Mektup)|İlipIliler)))|(?:Pavlus(?:’tan[\\s\\xa0]*F(?:Il(?:ip(?:Il[iIİ]ler|[İi]liler)|Ip(?:ililer|IlIler)|İp(?:Ililer|il[Ii]ler))|il(?:[İI]p(?:[iI]liler)|ip(?:Ililer|ilIler))|İl(?:ip[Ii]l(?:[Ii]ler)|IpilIler))|'tan[\\s\\xa0]*F(?:il(?:Ipililer|ipil[Ii]ler)|Il(?:ip(?:İliler|il[Ii]ler|Il[İi]ler)|Ip(?:Ililer|İlIler|il[Ii]ler)|İpIlIler)|İl(?:ip[iI]l(?:[iI]ler)|IpIlIler))|tan[\\s\\xa0]*F(?:Il(?:ip(?:il(?:iler(?:’e[\\s\\xa0]*Mektup)?|[Iİ]ler)|Il(?:iler(?:’e[\\s\\xa0]*Mektup)?|Iler))|Ip(?:İliler|il(?:Iler(?:’e[\\s\\xa0]*Mektup)?|iler)|Il(?:iler(?:’e[\\s\\xa0]*Mektup)?|Iler))|İpilIler)|il(?:Ip(?:İlIler|il[iI]ler|Il(?:iler(?:’e[\\s\\xa0]*Mektup)?|Iler))|ip(?:il[İIi]ler|Il(?:(?:[Ii]ler(?:’e[\\s\\xa0]*Mektup)?)|İler))|İpil[iI]ler)|İlip(?:ililer|IlIler)))|F(?:Il(?:Ip(?:İl(?:(?:[iI]ler(?:e[\\s\\xa0]*Mektup)?)|İler)|Il(?:[iIİ]ler(?:[’']e[\\s\\xa0]*Mektup)?)|il(?:(?:[Ii]ler(?:['’]e[\\s\\xa0]*Mektup)?)|İler(?:’e[\\s\\xa0]*Mektup)?))|İp(?:il(?:(?:[Ii]ler(?:e[\\s\\xa0]*Mektup)?)|İler)|İl[Ii]ler|Il(?:Iler(?:e[\\s\\xa0]*Mektup)?|iler))|ip(?:İl(?:(?:[iI]ler(?:e[\\s\\xa0]*Mektup)?)|İler)|Il(?:iler(?:['’]e[\\s\\xa0]*Mektup)?|Iler(?:’e[\\s\\xa0]*Mektup)?|İler(?:'e[\\s\\xa0]*Mektup)?)|il(?:(?:[iI]ler(?:[’']e[\\s\\xa0]*Mektup)?)|İler(?:'e[\\s\\xa0]*Mektup)?)))|il(?:ip(?:Il(?:iler(?:['’]e[\\s\\xa0]*Mektup)?|Iler(?:’e[\\s\\xa0]*Mektup)?|İler)|İl[Ii]ler|il(?:(?:[Ii]ler(?:[’']e[\\s\\xa0]*Mektup)?)|İler))|İp(?:il(?:iler(?:e[\\s\\xa0]*Mektup)?|[İI]ler)|İlIler|Il(?:[Ii]ler(?:e[\\s\\xa0]*Mektup)?))|Ip(?:İl(?:iler(?:e[\\s\\xa0]*Mektup)?|[İI]ler)|(?:[Ii]l(?:(?:[Ii]ler(?:[’']e[\\s\\xa0]*Mektup)?)|İler))))|İl(?:Ip(?:İl[Ii]ler|Il(?:(?:[Ii]ler(?:['’]e[\\s\\xa0]*Mektup)?)|İler)|il(?:iler(?:[’']e[\\s\\xa0]*Mektup)?|İler|Iler(?:'e[\\s\\xa0]*Mektup)?))|ip(?:İlIler|il(?:Iler(?:’e[\\s\\xa0]*Mektup)?|iler)|Il(?:Iler(?:[’']e[\\s\\xa0]*Mektup)?|[İi]ler))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CK]ol|Pavlus(?:tan[\\s\\xa0]*Kolosel[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|['’]tan[\\s\\xa0]*Kolosel(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))))|Pavlus(?:tan[\\s\\xa0]*Koloseliler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|['’]tan[\\s\\xa0]*Koloseliler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|(?:Kolosel(?:iler’e[\\s\\xa0]*Mektup|Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Pavlus(?:tan[\\s\\xa0]*Kolosel[İi]ler|['’]tan[\\s\\xa0]*Kolosel(?:[İI]ler)))|Koloseliler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|(?:Kolosel(?:Iler(?:’e[\\s\\xa0]*Mektup)?|[İi]ler)|Pavlus(?:['’]tan[\\s\\xa0]*Koloseliler|tan[\\s\\xa0]*KoloselIler)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:Thess|[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|\.[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|Se)|I(?:k[Iİ](?:[\s\xa0]*Se(?:l(?:an(?:[Iİ]kl(?:[Iİ]ler))?)?|nc[Iİ][\s\xa0]*Se(?:l(?:an(?:[Iİ]kl(?:[Iİ]ler))?)?)))|I(?:[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|\.[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?))|Pavlus(?:tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))))))|(?:['’]tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))))))))|İk[Iİ](?:[\s\xa0]*Se(?:l(?:an(?:[Iİ]kl(?:[Iİ]ler))?)?|nc[Iİ][\s\xa0]*Se(?:l(?:an(?:[Iİ]kl(?:[Iİ]ler))?)?))))|(?:[Iİ]k(?:[Iİ](?:[\s\xa0]*Se|nc[Iİ][\s\xa0]*Se(?:l(?:an(?:[Iİ]kl(?:[Iİ]ler))?)?))))|[Iİ]k(?:[Iİ]nc(?:[Iİ][\s\xa0]*Se))|(?:İk(?:i(?:nc[Iİi][\s\xa0]*Se(?:l(?:an(?:[iİI]kl(?:[iIİ]ler))?)?)|[\s\xa0]*Se(?:l(?:an[iİI]kl(?:[iIİ]ler))?)?)|[Iİ](?:nc(?:(?:[Iİ][\s\xa0]*Selan(?:(?:[Iİ]kliler|ikl[Iİi]ler))|i[\s\xa0]*Se(?:l(?:an[Iiİ]kl(?:[Iiİ]ler))?)?)|[\s\xa0]*Selan(?:[İI]kliler|ikl[Iİi]ler))))|Selan(?:[Iİi]kl(?:[Iİi]ler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|Pavlus(?:tan[\s\xa0]*Selan(?:ikl(?:[Iiİ]ler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[İi]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]kl(?:(?:[Iİ]ler(?:(?:[’']e[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[İIi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup)))))|iler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:[’']tan[\s\xa0]*Selan(?:ikl(?:[İIi]ler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]kl(?:(?:[İI]ler(?:(?:['’]e[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|iler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))))|ik[Iiİ](?:nc(?:[iİI][\s\xa0]*Se(?:l(?:an(?:[Iiİ]kl(?:[Iİi]ler))?)?)|[\s\xa0]*Se(?:l(?:an[İIi]kl(?:[Iiİ]ler))?)?))|2(?:[\s\xa0]*Selan(?:[Iİ]kliler|ikl[İiI]ler)|\.[\s\xa0]*Selan(?:[Iİ]kliler|ikl[İIi]ler))|I(?:k(?:i(?:nc[Iiİ][\s\xa0]*Se(?:l(?:an(?:[Iiİ]kl(?:[iIİ]ler))?)?)|[\s\xa0]*Se(?:l(?:an[iIİ]kl(?:[İIi]ler))?)?)|[Iİ](?:nc(?:(?:[Iİ][\s\xa0]*Selan(?:(?:[İI]kliler|ikl[iIİ]ler))|i[\s\xa0]*Se(?:l(?:an[Iiİ]kl(?:[İIi]ler))?)?)|[\s\xa0]*Selan(?:[İI]kliler|ikl[iİI]ler))))|I(?:[\s\xa0]*Selan(?:[Iİ]kliler|ikl[iİI]ler)|\.[\s\xa0]*Selan(?:[Iİ]kliler|ikl[iIİ]ler))))|(?:ik[Iiİ](?:nc(?:[iİI][\s\xa0]*Se|[\s\xa0]*Se(?:l(?:an[İIi]kl(?:[Iiİ]ler))?)?))|[İI]k(?:(?:[İI][\s\xa0]*Selan(?:(?:[İI]kliler|ikl[iİI]ler))|inc[Iİi][\s\xa0]*Se)))|ik[Iiİ][\s\xa0]*Se(?:l(?:an(?:[İIi]kl(?:[Iiİ]ler))?)?)|ik(?:[Iiİ][\s\xa0]*Se))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlus(?:(?:['’]tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|B[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*Se(?:l(?:an(?:[Iİ]kl(?:[Iİ]ler))?)?))|[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?))|İlk[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|1(?:Thess|[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|\.[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|Se)|I(?:lk[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|\.[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?))|B[Iİ]r(?:[Iİ]nc(?:[Iİ][\s\xa0]*Se))|(?:Pavlus(?:(?:[’']tan[\s\xa0]*Selan(?:(?:[Iİ]kl(?:iler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[İiI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[Iİ]ler(?:(?:[’']e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iİI]nc(?:[İiI][\s\xa0]*Mektup))|[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iİi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[İIi][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iiİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)))))|ikl(?:[iIİ]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[iIİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|tan[\s\xa0]*Selan(?:(?:[İI]kl(?:iler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[Iİi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[iİI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[İI]ler(?:(?:[’']e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[Iiİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[Iiİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iİI]nc(?:[Iiİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[İiI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)))))|ikl(?:[iIİ]ler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iiİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[Iİi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|B(?:[Iİ]r(?:inc(?:[Iiİ][\s\xa0]*Se(?:l(?:an(?:[İiI]kl(?:[İiI]ler))?)?)|[İI]nc(?:(?:[İI][\s\xa0]*Selan(?:(?:[Iİ]kliler|ikl[iİI]ler))|i[\s\xa0]*Se(?:l(?:an[iİI]kl(?:[İIi]ler))?)?))|[\s\xa0]*Selan(?:[İI]kliler|ikl[Iiİ]ler)))|ir(?:[Iİi]nc(?:[İIi][\s\xa0]*Se(?:l(?:an(?:[İIi]kl(?:[iIİ]ler))?)?))|[\s\xa0]*Se(?:l(?:an[İIi]kl(?:[İiI]ler))?)?))|Selan(?:[iIİ]kl(?:[iIİ]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[iİI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|I(?:lk[\s\xa0]*Selan(?:[İI]kliler|ikl[iİI]ler)|[\s\xa0]*Selan(?:[İI]kliler|ikl[Iİi]ler)|\.[\s\xa0]*Selan(?:[İI]kliler|ikl[Iİi]ler))|1(?:[\s\xa0]*Selan(?:[İI]kliler|ikl[iIİ]ler)|\.[\s\xa0]*Selan(?:[İI]kliler|ikl[İiI]ler))|İlk[\s\xa0]*Selan(?:[Iİ]kliler|ikl[iIİ]ler)|ilk[\s\xa0]*Se(?:l(?:an[Iiİ]kl(?:[İIi]ler))?)?)|B(?:[Iİ]r(?:(?:[İI]nc(?:(?:[İI][\s\xa0]*Selan(?:(?:[Iİ]kliler|ikl[iİI]ler))|i[\s\xa0]*Se(?:l(?:an[iİI]kl(?:[İIi]ler))?)?))|[\s\xa0]*Selan(?:[İI]kliler|ikl[Iiİ]ler)|inc[Iiİ][\s\xa0]*Se))|ir[Iİi]nc(?:[İIi][\s\xa0]*Se)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:Tim?|\.[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))|Pavlus(?:tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))|(?:['’]tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))))|I(?:k(?:[Iİ](?:nc(?:[Iİ][\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)))|I(?:\.[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)))|İk(?:[Iİ](?:nc(?:[Iİ][\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))))|(?:Pavlus(?:tan[\s\xa0]*T(?:imoteos(?:(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[Iİ]moteos(?:a[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))|(?:[’']a[\s\xa0]*(?:ik(?:[İIi](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup)))))))|(?:['’]tan[\s\xa0]*T(?:imoteos(?:(?:[’']a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[İI]moteos(?:a[\s\xa0]*(?:ik(?:[Iİi](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))))))|T(?:[Iİi]moteos(?:(?:[’']a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|2(?:[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|\.[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?)|ik(?:[iIİ](?:[\s\xa0]*T(?:[iİI](?:m(?:ot(?:e(?:yus|os))?)?)?)|nc(?:[Iİi][\s\xa0]*T(?:[Iiİ](?:m(?:ot(?:e(?:yus|os))?)?)?))))|I(?:I(?:[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|\.[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?)|k(?:(?:[İI](?:nc(?:i[\s\xa0]*T(?:[İiI](?:m(?:ot(?:e(?:yus|os))?)?)?)|(?:[İI][\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?))|[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?))|i(?:[\s\xa0]*T(?:[iİI](?:m(?:ot(?:e(?:yus|os))?)?)?)|nc(?:[İiI][\s\xa0]*T(?:[Iİi](?:m(?:ot(?:e(?:yus|os))?)?)?)))))|İk(?:(?:[Iİ](?:nc(?:i[\s\xa0]*T(?:[İIi](?:m(?:ot(?:e(?:yus|os))?)?)?)|(?:[İI][\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?))|[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?))|i(?:[\s\xa0]*T(?:[Iiİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|nc(?:[iIİ][\s\xa0]*T(?:[iIİ](?:m(?:ot(?:e(?:yus|os))?)?)?))))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İlk[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|1(?:Tim?|\.[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))|Pavlus(?:tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|(?:['’]tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|I(?:lk[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|\.[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))|B(?:[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?)))|[\s\xa0]*T(?:[Iİ](?:m(?:ot(?:e(?:yus|os))?)?)?))))|(?:İlk[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|B(?:(?:[Iİ]r(?:[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|inc(?:[İIi][\s\xa0]*T(?:[İIi](?:m(?:ot(?:e(?:yus|os))?)?)?))|(?:[İI]nc(?:i[\s\xa0]*T(?:[İIi](?:m(?:ot(?:e(?:yus|os))?)?)?)|(?:[İI][\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?)))))|ir(?:[\s\xa0]*T(?:[iİI](?:m(?:ot(?:e(?:yus|os))?)?)?)|(?:[Iİi]nc(?:[Iİi][\s\xa0]*T(?:[iIİ](?:m(?:ot(?:e(?:yus|os))?)?)?)))))|T(?:[İIi]moteos(?:(?:[’']a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[Iİi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[Iİi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|1(?:[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|\.[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?)|I(?:lk[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?|\.[\s\xa0]*Ti(?:m(?:ot(?:e(?:yus|os))?)?)?)|Pavlus(?:tan[\s\xa0]*T(?:(?:[Iİ]moteos(?:a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup))|[İI]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)|(?:['’]a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[İIi]nc(?:[İIi][\s\xa0]*Mektup))|[Iİ]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[iİI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))|imoteos(?:(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[’']tan[\s\xa0]*T(?:(?:[Iİ]moteos(?:a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[Iiİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)|(?:['’]a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[Iİi][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iiİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))|imoteos(?:(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[iIİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[iIİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|ilk[\s\xa0]*T(?:[İIi](?:m(?:ot(?:e(?:yus|os))?)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pavlus(?:['’]tan[\\s\\xa0]*T(?:[Iİ]t(?:[ou]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|tan[\\s\\xa0]*T[Iİ]t(?:[ou]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|T[Iİ]t)|(?:T(?:it[ou]s(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)?|[Iİ]t(?:[ou]s(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)))|Pavlus(?:[’']tan[\\s\\xa0]*T(?:it(?:[uo]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[İI]t(?:[uo]s)))|tan[\\s\\xa0]*T(?:it[uo]s(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[İI]t(?:[uo]s))))|(?:Pavlus['’]tan[\\s\\xa0]*T(?:[İI]t(?:[uo]s))|Tit))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Flm|P(?:hlm|avlus(?:tan[\\s\\xa0]*F[Iİ]l(?:[Iİ]mon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)))|['’]tan[\\s\\xa0]*F(?:[Iİ]l(?:[Iİ]mon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)))))))|(?:Pavlus(?:tan[\\s\\xa0]*F(?:il[iIİ]mon(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[Iİ]l(?:imon(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[İI]mon)))|['’]tan[\\s\\xa0]*F(?:il(?:[iIİ]mon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[İI]l(?:imon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[Iİ]mon)))))|F[İiI]l(?:[İiI]mon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)))|Pavlus(?:['’]tan[\\s\\xa0]*F(?:[İI]l(?:imon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[Iİ]mon)))|tan[\\s\\xa0]*F[Iİ]l(?:[İI]mon))|Pavlus['’]tan[\\s\\xa0]*F(?:[İI]l(?:[Iİ]mon)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Heb|[Iİ]br(?:an(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))?))|(?:[Iİ]br)|(?:[İI]braniler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ibran[Iİi]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|(?:[Iİ]bran(?:[iIİ]ler)|ibr(?:an[İiI]ler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],

    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yar(?:at[Iİı]l(?:[Iİı][sş]))?|Ba[sş](?:lang(?:[Iİı][cç])?)|Tekv[Iİ]n|Gen)|Ba[sş]|(?:Yarat(?:il[Iİiı][sş]|[ıİI]li[şs])|Tekvin|Ba[sş]langi[cç]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Exod|M[Iİı]s(?:[Iİı]r(?:dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş]))|['’]dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş]))))))|[CÇ](?:[Iİı]k))|M[Iİı]s(?:[Iİı]r(?:['’]dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş])))))|(?:M(?:is[Iiİı]r(?:(?:[’']dan[\\s\\xa0]*(?:[CÇ](?:[iİIı]k(?:[iİıI][sş])))|dan[\\s\\xa0]*[CÇ](?:[iİıI]k(?:[İIıi][sş]))))|[İıI]s(?:(?:[ıİI]r(?:dan[\\s\\xa0]*(?:[ÇC](?:(?:[ıİI]ki[şs]|ik[ıiIİ][sş]))|[’']dan[\\s\\xa0]*(?:[ÇC](?:(?:[ıIİ]ki[sş]|ik[İıIi][sş])))))|ir(?:['’]dan[\\s\\xa0]*(?:[CÇ](?:[İIiı]k(?:[ıİiI][şs])))|dan[\\s\\xa0]*[ÇC](?:[Iiİı]k(?:[ıIiİ][şs]))))))|(?:[ÇC](?:ik(?:[ıiİI][sş])?|[İIı]k(?:[İiıI][şs]))))|M[İIı]s(?:[İIı]r(?:['’]dan[\\s\\xa0]*(?:[ÇC](?:(?:[ıİI]ki[şs]|ik[ıIİi][sş]))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Num"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CÇ](?:[oö]lde[\\s\\xa0]*Say(?:[Iİı]m))|Say(?:[Iİı]lar)?|Num)|(?:[CÇ](?:[oö]lde[\\s\\xa0]*Sayim)|Sayilar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sir"],
        apocrypha: true,
        ...
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yeremya(?:['’]n(?:[Iİı]n[\\s\\xa0]*Mers(?:[Iİ]yeler[Iİ]))|n[Iİı]n[\\s\\xa0]*Mers(?:[Iİ]yeler[Iİ]))|Lam|A(?:[gğ](?:[Iİı](?:t(?:lar)?)?)))|(?:Yeremya(?:(?:['’]n(?:(?:[Iİı]n[\\s\\xa0]*Mers(?:iyeler[iIİ]|[Iİ]yeleri))|in[\\s\\xa0]*Mers[Iiİ]yeler[Iİi]))|n(?:(?:[İIı]n[\\s\\xa0]*Mers(?:iyeler[İIi]|[Iİ]yeleri))|in[\\s\\xa0]*Mers[iİI]yeler[Iİi]))|A(?:[gğ]i(?:t(?:lar)?)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        ...
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:PrMan|Mana[sş](?:[sş]e(?:(?:['’]n(?:[Iİ]n[\\s\\xa0]*Duas[Iİı])|n[Iİ]n[\\s\\xa0]*Duas[Iİı]))))|Mana[sş](?:[şs]e(?:(?:[’']n(?:(?:[İI]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[Iİıi]))|n(?:[İI]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[Iİıi])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kunun(?:un[\\s\\xa0]*Tekrar[Iİı]|['’]un[\\s\\xa0]*Tekrar[Iİı])|Tesn[Iİ]ye|Yas(?:a(?:['’]n(?:[Iİı]n[\\s\\xa0]*Tekrar[Iİı])|n[Iİı]n[\\s\\xa0]*Tekrar[Iİı]))?|Deut)|(?:Kunun(?:[’']un[\\s\\xa0]*Tekrari|un[\\s\\xa0]*Tekrari)|Yasa(?:n(?:in[\\s\\xa0]*Tekrar[iİIı]|[İıI]n[\\s\\xa0]*Tekrari)|(?:[’']n(?:in[\\s\\xa0]*Tekrar[İıIi]|[İıI]n[\\s\\xa0]*Tekrari)))|Tesniye))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        ...
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Sa(?:m(?:uel)?)?|\.[\s\xa0]*Sa(?:m(?:uel)?)?|Sam?)|I(?:k[Iİ](?:nc(?:[Iİ][\s\xa0]*Samuel|[\s\xa0]*Samuel))|I(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel))|İk[Iİ](?:nc(?:[Iİ][\s\xa0]*Samuel|[\s\xa0]*Samuel)))|[Iİ]k(?:[Iİ][\s\xa0]*Samuel)|(?:[İI]k(?:(?:[Iİ]nci[\s\xa0]*Samuel|i(?:nc[Iİi][\s\xa0]*Samuel|[\s\xa0]*Samuel)))|ik[Iiİ](?:nc(?:[Iİi][\s\xa0]*Samuel|[\s\xa0]*Samuel)))|ik(?:[Iiİ][\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İlk[\s\xa0]*Samuel|1(?:[\s\xa0]*Sa(?:m(?:uel)?)?|\.[\s\xa0]*Sa(?:m(?:uel)?)?|Sam?)|I(?:lk[\s\xa0]*Samuel|\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|B[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*Samuel)|[\s\xa0]*Samuel)))|(?:ilk[\s\xa0]*Samuel|B(?:ir(?:[İiI]nc(?:[İiI][\s\xa0]*Samuel)|[\s\xa0]*Samuel)|[Iİ]r(?:inc(?:[İiI][\s\xa0]*Samuel|[İI]nci[\s\xa0]*Samuel))))|B[Iİ]r(?:[İI]nci[\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:\.[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|K(?:gs|r)|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))|I(?:k(?:[Iİ](?:[\s\xa0]*K(?:rallar|[Iİı]rallar)|nc(?:[Iİ][\s\xa0]*K(?:rallar|[Iİı]rallar))))|I(?:\.[\s\xa0]*K(?:rallar|[Iİı]rallar)|[\s\xa0]*K(?:rallar|[Iİı]rallar)))|İk(?:[Iİ](?:[\s\xa0]*K(?:rallar|[Iİı]rallar)|nc(?:[Iİ][\s\xa0]*K(?:rallar|[Iİı]rallar)))))|(?:2(?:[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar)|ik(?:[İiI](?:[\s\xa0]*K(?:rallar|[Iİıi]rallar)|nc(?:[İiI][\s\xa0]*K(?:rallar|[iİIı]rallar))))|I(?:k(?:(?:[Iİ](?:[\s\xa0]*Kirallar|nc(?:i[\s\xa0]*K(?:rallar|[Iiİı]rallar)|[Iİ][\s\xa0]*Kirallar)))|i(?:[\s\xa0]*K(?:rallar|[İıIi]rallar)|nc(?:[İiI][\s\xa0]*K(?:rallar|[İıIi]rallar))))|I(?:[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar))|İk(?:(?:[Iİ](?:[\s\xa0]*Kirallar|nc(?:i[\s\xa0]*K(?:rallar|[ıİiI]rallar)|[İI][\s\xa0]*Kirallar)))|i(?:[\s\xa0]*K(?:rallar|[iIıİ]rallar)|nc(?:[Iiİ][\s\xa0]*K(?:rallar|[Iıiİ]rallar))))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:\.[\s\xa0]*K(?:rallar|[Iİı]rallar)|[\s\xa0]*K(?:rallar|[Iİı]rallar)|lk[\s\xa0]*K(?:rallar|[Iİı]rallar))|1(?:\.[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar)|K(?:gs|r)|[\s\xa0]*K(?:r(?:a(?:llar)?)?|[Iİı]rallar))|İlk[\s\xa0]*K(?:rallar|[Iİı]rallar)|B(?:[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*K(?:rallar|[Iİı]rallar)))|[\s\xa0]*K(?:rallar|[Iİı]rallar))))|(?:B(?:(?:[Iİ]r(?:[\s\xa0]*Kirallar|(?:[Iİ]nc(?:i[\s\xa0]*K(?:rallar|[ıIiİ]rallar)|[İI][\s\xa0]*Kirallar))|inc(?:[iİI][\s\xa0]*K(?:rallar|[ıiIİ]rallar))))|ir(?:[\s\xa0]*K(?:rallar|[iIıİ]rallar)|(?:[iİI]nc(?:[İIi][\s\xa0]*K(?:rallar|[İIıi]rallar)))))|1(?:[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar)|I(?:[\s\xa0]*Kirallar|lk[\s\xa0]*Kirallar|\.[\s\xa0]*Kirallar)|ilk[\s\xa0]*K(?:rallar|[Iİiı]rallar)|İlk[\s\xa0]*Kirallar))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İk[Iİ](?:nc(?:[Iİ][\s\xa0]*Tar(?:[Iİ]hler)|[\s\xa0]*Tar[Iİ]hler))|2(?:Chr|[\s\xa0]*Ta(?:r[Iİ]hler|h)?|Ta|\.[\s\xa0]*Ta(?:r[Iİ]hler|h)?)|I(?:k[Iİ](?:nc(?:[Iİ][\s\xa0]*Tar(?:[Iİ]hler)|[\s\xa0]*Tar[Iİ]hler))|I(?:\.[\s\xa0]*Tar[Iİ]hler|[\s\xa0]*Tar[Iİ]hler)))|[Iİ]k(?:[Iİ][\s\xa0]*Tar(?:[Iİ]hler))|(?:İk(?:[İI](?:nc(?:i[\s\xa0]*Tar(?:[İiI]hler|[Iİ][\s\xa0]*Tarihler)|[\s\xa0]*Tarihler))|i(?:nc[iIİ][\s\xa0]*Tar(?:[Iiİ]hler)|[\s\xa0]*Tar[Iiİ]hler))|ik[Iiİ](?:nc(?:[İiI][\s\xa0]*Tar(?:[İIi]hler)|[\s\xa0]*Tar[İIi]hler))|2(?:[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|I(?:I(?:[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|k(?:[İI](?:nc(?:i[\s\xa0]*Tar(?:[Iİi]hler|[İI][\s\xa0]*Tarihler)|[\s\xa0]*Tarihler))|i(?:nc[Iİi][\s\xa0]*Tar(?:[Iİi]hler)|[\s\xa0]*Tar[İiI]hler))))|(?:[Iİ]k(?:[İI](?:nc(?:[İI][\s\xa0]*Tarihler|[\s\xa0]*Tarihler)))|ik[Iiİ][\s\xa0]*Tar(?:[İIi]hler))|[Iİ]k(?:[İI][\s\xa0]*Tarihler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:B[Iİ]r(?:(?:[Iİ]nc(?:[Iİ][\s\xa0]*Tar(?:[Iİ]hler))|[\s\xa0]*Tar[Iİ]hler))|İlk[\s\xa0]*Tar[Iİ]hler|1(?:Chr|[\s\xa0]*Ta(?:r[Iİ]hler|h)?|Ta|\.[\s\xa0]*Ta(?:r[Iİ]hler|h)?)|I(?:\.[\s\xa0]*Tar[Iİ]hler|lk[\s\xa0]*Tar[Iİ]hler|[\s\xa0]*Tar[Iİ]hler))|(?:ilk[\s\xa0]*Tar[İiI]hler|B(?:ir(?:[İIi]nc(?:[İIi][\s\xa0]*Tar(?:[iİI]hler))|[\s\xa0]*Tar[İiI]hler)|[İI]r(?:(?:[Iİ]nc(?:i[\s\xa0]*Tar(?:[İIi]hler|[Iİ][\s\xa0]*Tarihler))|inc[iİI][\s\xa0]*Tar(?:[Iiİ]hler)|[\s\xa0]*Tarihler)))|I(?:lk[\s\xa0]*Tarihler|[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|1(?:[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler)|İlk[\s\xa0]*Tarihler)|B[Iİ]r(?:[Iİ]nc(?:[İI][\s\xa0]*Tarihler)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Azarya(?:n[Iİı]n[\\s\\xa0]*Duas[Iİı]|['’]n(?:[Iİı]n[\\s\\xa0]*Duas[Iİı]))|PrAzar)|Azarya(?:n(?:[Iİı]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[ıIİi])|[’']n(?:(?:[İIı]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İIıi]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S(?:[uü]leyman(?:(?:[Iİı]n[\\s\\xa0]*(?:Meseller[Iİ]|[OÖ]zdey(?:[Iİ](?:[sş]ler[Iİ]))))|(?:['’](?:[Iİı]n[\\s\\xa0]*(?:Meseller[Iİ]|[OÖ]zdey(?:[Iİ](?:[sş]ler[Iİ])))))))|Prov|[OÖ]zd|Meseller)|S[uü]leyman(?:(?:[’'](?:in[\\s\\xa0]*(?:(?:[ÖO]zdey(?:[iİI](?:[sş]ler[Iİi]))|Meseller[İIi])|(?:[Iıİ]n[\\s\\xa0]*(?:Meselleri|[ÖO]zdey(?:i(?:[şs]ler[Iiİ]|[Iİ](?:[şs]leri)))))))|in[\\s\\xa0]*(?:[ÖO]zdey(?:[iİI](?:[şs]ler[Iİi]))|Meseller[Iİi])|(?:[Iİı]n[\\s\\xa0]*(?:Meselleri|[ÖO]zdey(?:i(?:[şs]ler[İIi]|[İI](?:[sş]leri)))))))|S[uü]leyman(?:(?:[ıIİ]n[\\s\\xa0]*(?:[OÖ]zdey(?:[İI](?:[şs]leri)))|(?:['’](?:[ıIİ]n[\\s\\xa0]*(?:Meselleri|[ÖO]zdey(?:i(?:[şs]ler[İIi]|[İI](?:[şs]leri))))))))|S[üu]leyman(?:[’'](?:[ıİI]n[\\s\\xa0]*(?:[ÖO]zdey(?:[Iİ](?:[şs]leri))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        ...
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:SgThree|[UÜ](?:[cç][\\s\\xa0]*Gen(?:[cç][\\s\\xa0]*Adam(?:[Iİı]n[\\s\\xa0]*Ezg(?:[Iİ]s[Iİ])))))|[ÜU](?:[çc][\\s\\xa0]*Gen(?:[cç][\\s\\xa0]*Adam(?:in[\\s\\xa0]*Ezg(?:[iİI]s[Iiİ]|[İIı]n[\\s\\xa0]*Ezg(?:(?:[İI]si|is[İiI]))))))|[ÜU](?:[çc][\\s\\xa0]*Gen(?:[çc][\\s\\xa0]*Adam(?:[Iıİ]n[\\s\\xa0]*Ezg(?:(?:[İI]si|is[Iİi]))))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|Ne[sş](?:[Iİ]deler[\\s\\xa0]*Ne(?:[sş](?:[Iİ]des[Iİ])))|Ezg[Iİ]ler[\\s\\xa0]*Ezg(?:[Iİ]s[Iİ])?)|Ezg|(?:Ne[sş](?:ideler[\\s\\xa0]*Ne(?:[şs](?:[Iİi]des[iİI])|[İI]deler[\\s\\xa0]*Ne(?:[şs](?:(?:[Iİ]desi|ides[Iiİ])))))|Ezg(?:iler[\\s\\xa0]*Ezg[Iiİ]s[Iİi]|[İI]ler[\\s\\xa0]*Ezg(?:(?:[Iİ]si|is[İIi]))))|Ne[şs](?:[Iİ]deler[\\s\\xa0]*Ne(?:[sş](?:(?:[Iİ]desi|ides[İIi])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        ...
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Matta(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Matta['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|Mat(?:t(?:a(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))?)?|Matta(?:İn[\\s\\xa0]*(?:Inc[iİ]li|İnc(?:İli|il[İI])|inc[iİ]lİ)|'(?:a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:İncil|inc[İI]l))|n(?:in[\\s\\xa0]*(?:Inc(?:ilI|İlİ)|incilİ|İnc[İI]lİ)|In[\\s\\xa0]*(?:İnc[iİ]li|Incİli)|ın[\\s\\xa0]*(?:inc(?:Il[iİ]|İl[İI])|İnc(?:İli|il[Iİ]))|un[\\s\\xa0]*(?:inc[iİ]l[Iİ]|İnc(?:İli|il[iİ]))|İn[\\s\\xa0]*(?:(?:[Iİ]nc(?:İli|il[Iİ]))|incİlİ))|In[\\s\\xa0]*(?:incİl[iİ]|İncil[iİ]|Incilİ)|İn[\\s\\xa0]*(?:inc(?:IlI|[İi]lİ)|Incİli|İnc(?:İli|il[Iİ]))|ın[\\s\\xa0]*(?:Incili|İnc(?:İli|il[Iİ])|inc(?:İl[iİ]|Ilİ))|un[\\s\\xa0]*(?:Inc[iİ]li|İnc(?:İli|il[İi])|inc[İI]lİ)|in[\\s\\xa0]*(?:İncİl[iİ]|incilI))|’(?:in[\\s\\xa0]*(?:incIlI|İnc[iİ]lİ)|n(?:In[\\s\\xa0]*İncİli|in[\\s\\xa0]*(?:incilI|İnc(?:Ili|[İi]lİ)|Inc(?:İl[İi]|Ilİ))|ın[\\s\\xa0]*(?:inc[İi]l[İi]|İnc(?:İli|il[Iİ]))|İn[\\s\\xa0]*(?:inc(?:Ili|İl[iİ]|ilİ)|İnc(?:[Iİ]li|ilİ))|un[\\s\\xa0]*(?:incİl[Iİ]|Inc(?:Ili|ilİ)|İnc(?:[Iİ]li|ilİ)))|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[iİ]l)|öre[\\s\\xa0]*(?:[İI]ncil|incİl))|un[\\s\\xa0]*(?:incİl[Iİ]|Inc(?:Ili|ilİ)|İnc(?:İli|il[iİ]))|In[\\s\\xa0]*(?:İnc[Iİ]li|inc(?:İl[Iİ]|Ilİ))|ın[\\s\\xa0]*(?:Inc[İI]li|İnc(?:[Iİ]li|ilİ)|inc[iİ]lİ)|İn[\\s\\xa0]*(?:Inc(?:İli|ilI)|İnc(?:[Iİ]li|ilİ)|inc[Iİ]lİ)))|Matta(?:'(?:In[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[iI])|inc(?:İlI|[iI]l[Iiİ])|İnc(?:[Iİ]li|ilI))|in[\\s\\xa0]*(?:inc(?:[Iİ]l[İIi]|il[İi])|Inc[Iİi]l[İIi]|İnc(?:İlI|[Ii]l[İIi]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Ii]ncil)|İn[\\s\\xa0]*(?:İnc[iI]li|inc(?:Il[iİ]|[iİ]l[Ii])|Inc(?:Ili|il[iIİ]))|ın[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[Iİ]li|il[İI])|inc(?:İlI|il[Iiİ]|Il[Ii]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:il[İIi]|[İI]l[Ii])|Inc(?:Ili|il[Iİ]))|n(?:In[\\s\\xa0]*(?:İnc(?:Ili|il[İI])|inc[İiI]l[iIİ]|Inc(?:Ili|il[Iİi]))|İn[\\s\\xa0]*(?:[İI]nc(?:[iI]li)|inc(?:[iI]l[Iiİ]|İl[Ii]))|in[\\s\\xa0]*(?:İnc(?:il[İiI]|[İI]l[Ii])|Inc(?:Il[İIi]|il[İi]|İl[iI])|inc(?:[İI]l[iIİ]|il[iI]))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:İli|IlI|il[iİI])|Inc(?:[İI]li|il[Iiİ]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[iİI])|inc(?:[iİ]li|Il[İiI]))))|’(?:In[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[iIİ])|İncil[Iiİ]|inc(?:İli|il[Iİi]|Il[Ii]))|n(?:İn[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iiİ])|İncil[iI]|inc(?:İlI|Il[Iİ]|il[iI]))|un[\\s\\xa0]*(?:İncil[iI]|Inc(?:İli|il[Ii])|inc(?:İli|[iI]l[iİI]))|In[\\s\\xa0]*(?:Inc(?:[İI]li|il[İiI])|inc[Iİi]l[İiI]|İnc(?:Ili|il[Iiİ]))|in[\\s\\xa0]*(?:inc(?:[İI]l[iİI]|il[İi])|İnc(?:Il[İI]|[İi]l[Ii])|Inc(?:İlI|il[iIİ]|Il[iI]))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:[iİ]lI|Il[Iİi])|Inc(?:[İI]li|il[Iİi])))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:İli|il[Ii])|inc(?:İli|[iI]l[iİI]))|in[\\s\\xa0]*(?:İnc(?:Il[iİI]|[İi]l[iI])|inc(?:[iİ]l[iIİ]|Il[iİ])|Inc[iİI]l[iIİ])|İn[\\s\\xa0]*(?:inc(?:il[İiI]|[Iİ]l[iI])|İncil[iI]|Inc(?:Ili|il[İi]))|ın[\\s\\xa0]*(?:Incil[iIİ]|inc(?:Il[iIİ]|[iİ]l[iI])|İncil[Ii])|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:incIl|Incil)|öre[\\s\\xa0]*inc[Ii]l))|İn[\\s\\xa0]*(?:İnc[iI]li|inc(?:Il[iİI]|[İi]l[Ii])|Inc(?:Ili|il[İI])))|Matta(?:'ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[İI]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|’ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[iİ]l)|öre[\\s\\xa0]*(?:[Iİ]ncil|incİl))|n(?:un[\\s\\xa0]*(?:inc(?:Ili|İl[Iİ]|ilİ)|İnc(?:İli|il[iİ]))|ın[\\s\\xa0]*(?:inc(?:Il[İi]|İl[Iİ])|İnc(?:İli|il[Iİ]))|İn[\\s\\xa0]*(?:Inc(?:İli|ilİ)|inc(?:IlI|İlİ)|İnc(?:İli|il[iİ]))|In[\\s\\xa0]*incIlİ|in[\\s\\xa0]*(?:İnc[İi]l[İI]|Inc(?:ili|İlI)|incİlİ))|In(?:c(?:İli|ilİ)|[\\s\\xa0]*incilI)|in(?:[\\s\\xa0]*(?:İnc[Iİ]l[Iİ]|incİli|Inc[İI]lİ)|c(?:ili|İlİ))|ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[İI]l)|öre[\\s\\xa0]*(?:İncil|inc[İi]l))|İnc(?:İli|il[İi])|ın[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[iİ])|inc(?:il[Iİ]|İlİ))|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*(?:(?:[İI]ncil|incİl))|un[\\s\\xa0]*(?:inc(?:Ili|İlİ)|Inc(?:İli|ilİ)|İnc(?:İli|il[iİ])))|Matta(?:İnc(?:Ili|ilI)|In(?:c(?:Ili|il[Ii])|[\\s\\xa0]*(?:[Iİ]nc(?:(?:[İI]li|il[Iİi]))|inc(?:[İI]l[İIi]|il[iİ])))|ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*[iI]ncil|öre[\\s\\xa0]*(?:incIl|Incil))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:Ili|il[İIi])|inc(?:ili|Il[Iiİ]|İl[iI]))|n(?:in[\\s\\xa0]*(?:İnc(?:[İi]li|Il[Iİi])|Inc(?:Il[iİI]|İl[İi]|il[Iİ])|inc(?:[Ii]l[Iİi]|İl[iI]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[İI]li|il[iİI])|inc(?:İli|Il[İI]|il[iI]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[İI]li|il[Iİi]))|inc(?:[İi]l[İIi]|Il[iI]))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:il[Iİi]|Il[İi]|İl[iI])|Inc(?:Ili|il[Ii]))|ın[\\s\\xa0]*(?:İnc[Ii]li|inc(?:İli|IlI|il[Iiİ])|Inc(?:[İI]li|il[Iiİ])))|'ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*[iI]ncil|ore[\\s\\xa0]*inc[Ii]l)|’ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:incIl|Incil)|öre[\\s\\xa0]*inc[Ii]l)|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:il[İIi]|Il[Iİ]|İl[Ii])|Inc(?:Ili|il[iI]))|in(?:c(?:Il[iİI]|il[İI]|İl[Ii])|[\\s\\xa0]*(?:İnc(?:[Iİ]li|il[Iiİ])|Inc(?:il[İiI]|[Iİ]l[iI])|inc(?:[Ii]l[iIİ]|İl[Iİ])))|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*inc(?:[Ii]l))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Markos(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Markos['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|Mar(?:k(?:os(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))?)?|Markos(?:İn[\\s\\xa0]*(?:Incili|İnc(?:İli|il[iİ])|inc(?:İl[İi]|ilİ))|’(?:a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:İncil|inc[Iİ]l))|in[\\s\\xa0]*(?:incİl[İI]|İnc(?:Ili|İl[İi]|ilİ)|Incilİ)|In[\\s\\xa0]*Incili|un[\\s\\xa0]*(?:inc(?:ilI|[Iİ]lİ)|Incİli|İnc(?:İli|il[Iİ]))|ın[\\s\\xa0]*(?:Inc[İi]li|İnc(?:İli|il[Iİ])|inc[iİ]lİ)|İn[\\s\\xa0]*(?:incİl[İi]|Incil[Iİ]|İnc(?:İli|il[İi]))|n(?:In[\\s\\xa0]*inc(?:[İi]li|Ilİ)|in[\\s\\xa0]*(?:İnc(?:Ili|İl[iİ]|ilİ)|Incİlİ)|un[\\s\\xa0]*(?:Inc(?:İli|ilİ)|inc(?:IlI|İlİ)|İnc(?:[İI]li|ilİ))|ın[\\s\\xa0]*(?:Incilİ|inc(?:ilI|İl[iİ])|İnc(?:İli|il[iİ]))|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:IlI|İl[iİ]))))|'(?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[Iİ]l))|In[\\s\\xa0]*(?:IncIli|İncilİ)|ın[\\s\\xa0]*(?:incİl[İi]|Incil[İi]|İnc(?:[Iİ]li|ilİ))|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Inc(?:İli|il[İi])|incİlİ)|un[\\s\\xa0]*(?:Inc[İI]li|İnc(?:İli|il[Iİ])|inc[Iİ]lİ)|n(?:in[\\s\\xa0]*İnc(?:ili|[Iİ]lİ)|In[\\s\\xa0]*(?:Incilİ|İncİli|inc(?:ili|İl[iİ]))|ın[\\s\\xa0]*(?:inc(?:il[iİ]|İl[İI])|İnc(?:İli|il[Iİ]))|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:ilI|İl[İI]))|un[\\s\\xa0]*(?:IncilI|İnc(?:[Iİ]li|ilİ)|inc(?:İl[İI]|Ilİ)))|in[\\s\\xa0]*(?:Incİl[iİ]|incIlİ|İnc(?:IlI|İl[iİ]))))|Markos(?:'(?:un[\\s\\xa0]*(?:İnc[Ii]li|Incil[Iiİ]|inc(?:il[iİI]|[Iİ]l[Ii]))|ın[\\s\\xa0]*(?:İncil[iI]|inc(?:İlI|[Ii]l[Iiİ])|Inc(?:[İI]li|ilI))|İn[\\s\\xa0]*(?:Inc(?:Ili|ilI)|İncil[iI]|inc(?:[iI]l[İIi]|İl[Ii]))|n(?:İn[\\s\\xa0]*(?:inc(?:İli|Il[İiI]|il[İi])|Inc(?:[İI]li|il[iI])|İncil[Ii])|In[\\s\\xa0]*(?:inc(?:İlI|Il[iIİ]|il[İI])|Inc(?:[Iİ]li|il[Ii])|İnc(?:Ili|il[İIi]))|in[\\s\\xa0]*(?:İnc(?:il[Iİ]|[İI]l[Ii])|[iI]nc(?:[İiI]l[İiI]))|un[\\s\\xa0]*(?:Inc(?:[İI]li|il[İi])|İncil[Ii]|inc(?:İli|il[Iİi]|Il[Ii]))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:İli|ilI|Il[İiI])|Inc(?:[İI]li|il[Iiİ])))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[iI]ncil)|In[\\s\\xa0]*(?:Inc(?:İli|il[Iiİ])|İnc(?:[İI]li|il[Ii])|inc[iİI]l[iIİ])|in[\\s\\xa0]*(?:İnc(?:İlI|il[İiI]|Il[iİ])|inc(?:[iİ]l[iİI]|Il[iI])|Inc(?:İlI|[Ii]l[Iİi])))|’(?:in[\\s\\xa0]*(?:İnc(?:İlI|Il[Iİ]|il[Ii])|Inc(?:[İI]l[Iiİ]|il[Ii])|inc(?:İli|[Ii]l[İIi]))|In[\\s\\xa0]*(?:İnc(?:[Iİ]li|il[İiI])|Inc(?:[Iİ]li|il[Iİ])|inc[İIi]l[İiI])|n(?:İn[\\s\\xa0]*(?:inc(?:İlI|il[iIİ]|Il[İi])|Inc(?:[İI]li|il[iI])|İncil[Ii])|ın[\\s\\xa0]*(?:inc(?:İlI|Il[İiI]|il[İi])|İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[Ii]))|in[\\s\\xa0]*(?:inc[iIİ]l[İiI]|İnc(?:İlI|Il[İI]|il[Ii])|Inc(?:[iI]l[iIİ]|İl[Ii]))|un[\\s\\xa0]*(?:İncil[Ii]|inc(?:il[İiI]|Il[iİ]|İl[iI])|Inc(?:Ili|il[Ii]))|In[\\s\\xa0]*(?:[Iİ]nc(?:(?:[Iİ]li|il[iIİ]))|inc(?:[iİ]l[İI]|Il[Ii])))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:İlI|[Ii]l[İIi])|Inc[İiI]li)|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*(?:[iI]ncil)|un[\\s\\xa0]*(?:İnc[Ii]li|inc(?:il[iİ]|[İI]l[Ii])|Inc(?:Ili|il[Iİi]))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:Il[İIi]|[İi]l[Ii])|Inc(?:Ili|il[Iİ])))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[İI]li|il[İI])|inc(?:İlI|Il[İIi]|il[Ii])))|Markos(?:In(?:[\\s\\xa0]*İnc(?:İli|ilİ)|cili)|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:İncil|inc[iİ]l))|İnc(?:[İI]li|ilİ)|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:(?:[Iİ]ncil|incİl)))|in(?:c(?:İl[Iİ]|Ilİ)|[\\s\\xa0]*(?:İnc(?:Ili|İlİ)|Inc(?:ili|İl[Iİ]|Ilİ)))|un[\\s\\xa0]*(?:Inc(?:İli|il[Iİ])|İnc(?:İli|il[İi])|incİlİ)|n(?:ın[\\s\\xa0]*(?:Inc(?:[Iİ]li|ilİ)|İnc(?:İli|il[İi])|incİlİ)|İn[\\s\\xa0]*(?:Inc[İI]li|İnc(?:İli|il[iİ])|inc[iİ]lİ)|un[\\s\\xa0]*(?:incİl[iİ]|Incil[İi]|İnc(?:İli|il[İi]))|In[\\s\\xa0]*(?:inc(?:Ili|İlI)|İnc(?:İli|ilİ))|in[\\s\\xa0]*(?:İnc(?:Ili|İlİ)|Inc[iİ]lİ))|ın[\\s\\xa0]*(?:incİl[Iİ]|Inc(?:Ili|ilİ)|İnc(?:[İI]li|ilİ)))|Markos(?:in(?:[\\s\\xa0]*(?:İnc(?:il[İiI]|Il[Iİ]|İl[Ii])|inc[İIi]l[Iİi]|Inc(?:İli|il[İI]|Il[iI]))|c(?:İli|il[İIi]|Il[Ii]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc[Ii]li|inc(?:[iI]l[İIi]|İl[iI]))|ın[\\s\\xa0]*(?:İncil[Ii]|Inc(?:İli|il[Ii])|inc(?:İli|[iI]l[iIİ]))|İncil[iI]|In(?:[\\s\\xa0]*(?:Inc(?:[İI]li|il[Iİi])|inc[Iİi]l[İiI]|İnc(?:Ili|il[Ii]))|c(?:[Iİ]li|il[Iİ]))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*[iI]ncil|ore[\\s\\xa0]*(?:incIl|Incil))|n(?:İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Incil[İIi]|inc(?:Il[Iİi]|[iİ]l[Ii]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Incil[iI]|inc(?:[iI]l[iİI]|İl[Ii]))|in[\\s\\xa0]*(?:Inc(?:Il[iIİ]|[İi]l[Ii])|İnc(?:il[İiI]|Il[Iİ]|İl[iI])|inc[İiI]l[iİI])|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:İlI|[iI]l[İIi])|Inc(?:[Iİ]li|ilI))|In[\\s\\xa0]*(?:Inc(?:[İI]li|il[Iİi])|inc(?:il[İiI]|İl[iİ]|Il[İI])|İnc(?:Ili|il[Ii])))|['’]ya[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*inc(?:[iI]l))|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*[Ii]ncil|ore[\\s\\xa0]*inc[iI]l))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Luka(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Luka['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|Luk(?:a(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|e)?|Luka(?:’(?:in[\\s\\xa0]*(?:İnc(?:Ili|İl[Iİ]|ilİ)|incİlI)|un[\\s\\xa0]*(?:inc(?:İl[iİ]|il[Iİ])|İnc(?:İli|il[İI]))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|İn[\\s\\xa0]*(?:Incili|İnc(?:İli|il[iİ])|inc(?:İl[Iİ]|Ilİ))|ın[\\s\\xa0]*(?:IncilI|İnc(?:İli|il[iİ])|inc(?:İl[Iİ]|ilİ))|n(?:In[\\s\\xa0]*İncİli|in[\\s\\xa0]*(?:Inc(?:IlI|[iİ]lİ)|İnc(?:ilI|[Iİ]lİ)|incİlI)|ın[\\s\\xa0]*(?:inc(?:İl[iİ]|il[İI])|İnc(?:İli|il[İI]))|İn[\\s\\xa0]*(?:incİl[iİ]|Incil[iİ]|İnc(?:İli|il[Iİ]))|un[\\s\\xa0]*(?:incİl[İI]|Incil[iİ]|İnc(?:İli|il[Iİ])))|In[\\s\\xa0]*inc(?:ili|[Iİ]lİ))|İn[\\s\\xa0]*(?:Incilİ|inc(?:ili|İl[İI])|İnc(?:İli|il[iİ]))|'(?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:İncil|inc[iİ]l))|In[\\s\\xa0]*(?:İnc(?:İli|ilİ)|incİlİ)|in[\\s\\xa0]*(?:Inc(?:ili|Ilİ)|İnc(?:ilI|İlİ)|incİli)|un[\\s\\xa0]*(?:inc(?:ili|İl[Iİ]|Ilİ)|İnc(?:[Iİ]li|ilİ))|İn[\\s\\xa0]*(?:IncIli|İnc(?:İli|il[Iİ])|inc(?:İl[iİ]|ilİ))|n(?:in[\\s\\xa0]*(?:inc(?:İli|Ilİ)|Incİlİ|İnc(?:İl[iİ]|Ilİ))|un[\\s\\xa0]*(?:inc(?:Ili|İl[iİ]|ilİ)|İnc(?:İli|il[İI]))|İn[\\s\\xa0]*(?:inc[Iİ]l[iİ]|İnc(?:İli|il[iİ]))|In[\\s\\xa0]*[Iİ]ncIli|ın[\\s\\xa0]*(?:İnc(?:[İI]li|ilİ)|Inc(?:İli|il[Iİ])|incİlİ))|ın[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|inc(?:ili|[Iİ]lİ)|Incİli)))|Luka(?:'(?:n(?:ın[\\s\\xa0]*(?:Inc[iI]li|İncil[iI]|inc(?:[Ii]l[Iİi]|İl[iI]))|In[\\s\\xa0]*(?:(?:[Iİ]nc(?:İli|il[İiI]))|inc[İIi]l[Iİi])|un[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:[İI]li|il[İIi])|inc(?:İlI|Il[Iİ]|il[Ii]))|in[\\s\\xa0]*(?:inc(?:il[iİI]|İl[Iİ]|Il[Ii])|Inc(?:[Ii]l[İiI]|İl[iI])|İnc(?:İlI|il[iIİ]|Il[Ii]))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:[İI]lI|il[İiI])|Inc(?:[İI]li|il[iIİ])))|un[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iiİ])|İncil[Ii]|inc(?:İli|il[Iİ]|Il[Ii]))|in[\\s\\xa0]*(?:inc(?:[Ii]l[iİI]|İl[İI])|Inc(?:İl[Iİi]|il[İI]|Il[Ii])|İnc(?:Il[iIİ]|il[İi]|İl[iI]))|İn[\\s\\xa0]*(?:Inc(?:İli|il[Iiİ])|İnc[iI]li|inc(?:İlI|Il[Iİi]|il[Ii]))|a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:incIl|Incil))|ın[\\s\\xa0]*(?:İncil[iI]|inc(?:il[İI]|[Iİ]l[Ii])|Inc(?:Ili|il[İIi]))|In[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iİi])|inc(?:[Ii]l[iIİ]|İl[Ii])|İnc(?:Ili|il[iI])))|İn[\\s\\xa0]*(?:inc(?:İli|Il[Iiİ]|il[İI])|İnc(?:Ili|ilI)|Inc(?:[İI]li|il[iI]))|’(?:in[\\s\\xa0]*(?:inc(?:[iI]l[iIİ]|İl[iİ])|Inc[Iiİ]l[Iİi]|İnc(?:İli|Il[Iİ]|il[Ii]))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*[iI]ncil|ore[\\s\\xa0]*inc[Ii]l)|un[\\s\\xa0]*(?:İnc[Ii]li|inc(?:ili|İlI|Il[İiI])|Inc(?:[İI]li|il[iİI]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[İi])|inc(?:İli|Il[İiI]|il[Ii]))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[İI]li|il[İI])|inc(?:İli|il[iİI]|Il[iI]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[İI]li|il[İiI]))|inc(?:il[Iİ]|[Iİ]l[Ii]))|n(?:un[\\s\\xa0]*(?:İnc[iI]li|inc(?:İli|[Ii]l[İiI])|Inc(?:[Iİ]li|ilI))|İn[\\s\\xa0]*(?:İnc[iI]li|inc(?:İlI|[Ii]l[iİI])|Inc(?:[İI]li|ilI))|in[\\s\\xa0]*(?:inc(?:[iI]l[Iiİ]|İl[İi])|Inc(?:Il[iİ]|[iİ]l[Ii])|İnc(?:il[iİ]|[İI]l[iI]))|In[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[Iİi])|inc[Iiİ]l[İIi]|İnc(?:Ili|il[İiI]))|ın[\\s\\xa0]*(?:İnc[iI]li|inc(?:ili|İlI|Il[iİI])|Inc(?:[İI]li|il[İIi])))))|Luka(?:a[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*(?:İncil|inc[İI]l))|in(?:[\\s\\xa0]*(?:Incilİ|İnc(?:IlI|[iİ]lİ))|c(?:İl[İi]|ilİ))|ın[\\s\\xa0]*(?:Inc(?:İli|ilİ)|inc(?:ili|İlİ)|İnc(?:[Iİ]li|ilİ))|n(?:In[\\s\\xa0]*inc(?:ili|İlİ)|ın[\\s\\xa0]*(?:IncilI|İnc(?:İli|il[Iİ])|inc(?:İl[İi]|Ilİ))|in[\\s\\xa0]*(?:İnc[İi]l[iİ]|inc(?:İlI|ilİ))|İn[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[Iİ])|inc(?:Il[Iİ]|İlİ))|un[\\s\\xa0]*(?:IncilI|İnc(?:[İI]li|ilİ)|inc(?:İl[iİ]|ilİ)))|un[\\s\\xa0]*(?:Inc[iİ]li|İnc(?:İli|il[Iİ])|inc[iİ]lİ)|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[iİ]l)|ore[\\s\\xa0]*(?:[Iİ]ncil|incİl))|In(?:[\\s\\xa0]*(?:İncİli|inc(?:ilI|İl[iİ]))|cilI)|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:(?:[Iİ]ncil|incİl)))|İnc(?:İli|il[İi]))|Luka(?:İnc(?:Ili|ilI)|In(?:[\\s\\xa0]*(?:inc(?:İlI|Il[iIİ]|il[İi])|Inc(?:[İI]li|il[iIİ])|İnc(?:Ili|il[İIi]))|c(?:[İI]li|il[İi]))|ın[\\s\\xa0]*(?:İncil[Ii]|inc(?:Il[İIi]|il[İI]|İl[iI])|Inc(?:Ili|il[Ii]))|n(?:in[\\s\\xa0]*(?:İnc(?:[İi]lI|Il[iİI])|inc(?:Il[iİI]|İl[İi]|il[iI])|Inc[Iiİ]l[iIİ])|İn[\\s\\xa0]*(?:İnc[iI]li|Inc(?:Ili|il[İiI])|inc(?:Ili|il[İiI]|İl[Ii]))|In[\\s\\xa0]*(?:[Iİ]nc(?:(?:[Iİ]li|il[İIi]))|inc(?:Il[Iiİ]|il[Iİ]|İl[iI]))|un[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[iİ])|İncil[Ii]|inc(?:İlI|Il[Iiİ]|il[Ii]))|ın[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[İI]li|il[iİ])|inc(?:İlI|il[İIi]|Il[iI])))|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*(?:[Ii]ncil)|in(?:[\\s\\xa0]*(?:İnc(?:Il[İi]|[İi]l[iI])|inc[Iiİ]l[iIİ]|Inc(?:[İI]l[Iİi]|il[Ii]))|c(?:İlI|Il[İIi]|il[iI]))|['’]ya[\\s\\xa0]*G(?:[öo]re[\\s\\xa0]*inc(?:[Ii]l))|un[\\s\\xa0]*(?:İnc[Ii]li|inc(?:Il[Iiİ]|[İi]l[iI])|Inc(?:Ili|il[İI]))|ya[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:incIl|Incil)|ore[\\s\\xa0]*inc[iI]l))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:1(?:[\s\xa0]*Yu(?:h(?:anna)?)?|Yu|John|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|I(?:[\s\xa0]*Yuhanna|lk[\s\xa0]*Yuhanna|\.[\s\xa0]*Yuhanna)|B(?:[Iİ]r(?:[\s\xa0]*Yuhanna|[Iİ]nc(?:[Iİ][\s\xa0]*Yuhanna)))|İlk[\s\xa0]*Yuhanna|Yuhanna(?:(?:['’]n(?:[Iİı]n[\s\xa0]*(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu|lk[\s\xa0]*Mektubu)|İlk[\s\xa0]*Mektubu|B(?:[Iİ]r(?:[\s\xa0]*Mektubu|[Iİ]nc(?:[Iİ][\s\xa0]*Mektubu)))|1(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))|n(?:[Iİı]n[\s\xa0]*(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu|lk[\s\xa0]*Mektubu)|İlk[\s\xa0]*Mektubu|B(?:[Iİ]r(?:[\s\xa0]*Mektubu|[Iİ]nc(?:[Iİ][\s\xa0]*Mektubu)))|1(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)))))|(?:B(?:ir(?:[\s\xa0]*Yuhanna|[iİI]nc(?:[iİI][\s\xa0]*Yuhanna))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Yuhanna|inc[İIi][\s\xa0]*Yuhanna)))|ilk[\s\xa0]*Yuhanna|Yuhanna(?:(?:[’']n(?:in[\s\xa0]*(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu|lk[\s\xa0]*Mektubu)|[iİ]lk[\s\xa0]*Mektubu|1(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|B(?:[İIi]r(?:[\s\xa0]*Mektubu|[İiI]nc(?:[İiI][\s\xa0]*Mektubu))))|(?:[ıIİ]n[\s\xa0]*(?:ilk[\s\xa0]*Mektubu|B(?:[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektubu|inc[iIİ][\s\xa0]*Mektubu))|ir(?:[\s\xa0]*Mektubu|[iIİ]nc(?:[iIİ][\s\xa0]*Mektubu)))))))|n(?:in[\s\xa0]*(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu|lk[\s\xa0]*Mektubu)|[iİ]lk[\s\xa0]*Mektubu|1(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|B(?:[Iİi]r(?:[\s\xa0]*Mektubu|[Iİi]nc(?:[Iiİ][\s\xa0]*Mektubu))))|(?:[İıI]n[\s\xa0]*(?:ilk[\s\xa0]*Mektubu|B(?:[İI]r(?:(?:[İI]nci[\s\xa0]*Mektubu|inc[İIi][\s\xa0]*Mektubu))|ir(?:[\s\xa0]*Mektubu|[iİI]nc(?:[Iİi][\s\xa0]*Mektubu)))))))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:2(?:[\s\xa0]*Yu(?:h(?:anna)?)?|Yu|John|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|I(?:I(?:[\s\xa0]*Yuhanna|\.[\s\xa0]*Yuhanna)|k(?:[Iİ](?:[\s\xa0]*Yuhanna|nc[Iİ][\s\xa0]*Yuhanna)))|İk(?:[Iİ](?:[\s\xa0]*Yuhanna|nc[Iİ][\s\xa0]*Yuhanna))|Yuhanna(?:(?:['’]n(?:[Iİı]n[\s\xa0]*(?:İk(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|I(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|k(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu))))))|n(?:[Iİı]n[\s\xa0]*(?:İk(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|I(?:I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|k(?:[Iİ](?:[\s\xa0]*Mektubu|nc[Iİ][\s\xa0]*Mektubu)))))))|(?:Yuhanna(?:(?:['’]n(?:(?:[İIı]n[\s\xa0]*(?:(?:[Iİ]k(?:i(?:[\s\xa0]*Mektubu|nc[iİI][\s\xa0]*Mektubu)|[İI]nci[\s\xa0]*Mektubu))|ik(?:[iİI](?:[\s\xa0]*Mektubu|nc[Iiİ][\s\xa0]*Mektubu))))|in[\s\xa0]*(?:I(?:k(?:[İIi](?:[\s\xa0]*Mektubu|nc[iIİ][\s\xa0]*Mektubu))|I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))|(?:[İi]k(?:[İIi](?:[\s\xa0]*Mektubu|nc[Iiİ][\s\xa0]*Mektubu)))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))|n(?:(?:[İIı]n[\s\xa0]*(?:(?:[İI]k(?:i(?:[\s\xa0]*Mektubu|nc[Iİi][\s\xa0]*Mektubu)|[İI]nci[\s\xa0]*Mektubu))|ik(?:[İIi](?:[\s\xa0]*Mektubu|nc[Iİi][\s\xa0]*Mektubu))))|in[\s\xa0]*(?:I(?:k(?:[İIi](?:[\s\xa0]*Mektubu|nc[İiI][\s\xa0]*Mektubu))|I(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektubu|nc[iİI][\s\xa0]*Mektubu)))|2(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))|[İI]k(?:(?:[Iİ]nci[\s\xa0]*Yuhanna|i(?:[\s\xa0]*Yuhanna|nc[iIİ][\s\xa0]*Yuhanna)))|ik(?:[iIİ](?:[\s\xa0]*Yuhanna|nc[Iiİ][\s\xa0]*Yuhanna))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[UÜ](?:[cç](?:[\s\xa0]*Yuhanna|[uü]nc(?:[uü][\s\xa0]*Yuhanna))))|3(?:[\s\xa0]*Yu(?:h(?:anna)?)?|Yu|John|\.[\s\xa0]*Yu(?:h(?:anna)?)?)|III(?:[\s\xa0]*Yuhanna|\.[\s\xa0]*Yuhanna)|Yuhanna(?:n[Iİı]n[\s\xa0]*(?:(?:[UÜ](?:[cç](?:(?:[uü]nc(?:[uü][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)))|['’]n(?:[Iİı]n[\s\xa0]*(?:(?:[UÜ](?:[cç](?:(?:[uü]nc(?:[uü][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))))|Yuhanna(?:[’']nin[\s\xa0]*(?:(?:[UÜ](?:[çc](?:(?:[üu]nc(?:[üu][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)))|nin[\s\xa0]*(?:[UÜ](?:[çc](?:(?:[üu]nc(?:[üu][\s\xa0]*Mektubu)|[\s\xa0]*Mektubu)))|3(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu)|III(?:[\s\xa0]*Mektubu|\.[\s\xa0]*Mektubu))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Yuhanna(?:['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|[Iİ]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ])))|Yuhanna['’](?:(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))|(?:John|Yu(?:h(?:anna(?:ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))|[Iİ]nc(?:[Iİ]l[Iİ])|[’']ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l)))|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|[ıu]n[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l[Iİ]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]nc(?:[Iİ]l))))?)?)|Yuhanna(?:İn[\\s\\xa0]*(?:Incilİ|inc(?:ilI|İl[Iİ])|İnc(?:İli|il[iİ]))|’(?:a[\\s\\xa0]*G(?:öre[\\s\\xa0]*(?:İncil|inc[Iİ]l)|ore[\\s\\xa0]*(?:[İI]ncil|incİl))|ın[\\s\\xa0]*(?:Inc[İI]li|İnc(?:İli|il[Iİ])|inc[iİ]lİ)|In[\\s\\xa0]*incİli|un[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[İi])|inc(?:Il[İI]|İlİ))|in[\\s\\xa0]*(?:İnc(?:ilI|İl[iİ]|Ilİ)|Inc(?:Ili|[İi]lİ))|n(?:in[\\s\\xa0]*(?:Inc(?:ili|İlİ)|İnc(?:Ili|İl[İI]))|ın[\\s\\xa0]*(?:inc(?:Ili|İl[İi]|ilİ)|İnc(?:İli|il[iİ]))|In[\\s\\xa0]*(?:[İI]ncilİ|incİlI)|un[\\s\\xa0]*(?:incİl[iİ]|Inc(?:Ili|ilİ)|İnc(?:İli|il[İI]))|İn[\\s\\xa0]*(?:IncilI|İnc(?:İli|il[Iİ])|inc(?:İl[iİ]|Ilİ)))|İn[\\s\\xa0]*(?:Inc(?:İli|ilİ)|inc(?:IlI|İlİ)|İnc(?:İli|il[Iİ])))|'(?:in[\\s\\xa0]*(?:İnc(?:ili|İlİ)|IncİlI)|un[\\s\\xa0]*(?:inc(?:ilI|İl[Iİ]|Ilİ)|İnc(?:[İI]li|ilİ))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:(?:[Iİ]ncil|incİl))|İn[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[Iİ])|inc(?:il[Iİ]|İlİ))|n(?:in[\\s\\xa0]*(?:inc(?:İli|ilİ)|İnc(?:IlI|İl[Iİ]|ilİ)|Incili)|un[\\s\\xa0]*(?:inc[Iİ]l[İI]|İnc(?:İli|il[Iİ]))|In[\\s\\xa0]*incİlİ|ın[\\s\\xa0]*(?:incİl[İi]|Incil[iİ]|İnc(?:İli|il[iİ]))|İn[\\s\\xa0]*(?:İnc(?:[Iİ]li|ilİ)|Incilİ|inc(?:IlI|İl[iİ])))|In[\\s\\xa0]*(?:İnc(?:İli|ilİ)|IncIli|inc[Iİ]lİ)|ın[\\s\\xa0]*(?:Inc[iİ]li|İnc(?:[Iİ]li|ilİ)|inc[iİ]lİ)))|Yuhanna(?:İn[\\s\\xa0]*(?:inc(?:İli|Il[Iİi]|il[iİ])|İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[iI]))|’(?:ın[\\s\\xa0]*(?:İnc[Ii]li|Incil[Iİi]|inc(?:Il[Iİi]|[iİ]l[Ii]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[İI]li|il[iİI]))|inc(?:[Ii]l[İiI]|İl[İI]))|in[\\s\\xa0]*(?:Inc(?:Il[Iİ]|[iİ]l[Ii])|inc[iİI]l[iİI]|İnc(?:İlI|il[İi]|Il[iI]))|un[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:Ili|il[İIi])|inc(?:Ili|il[Iiİ]|İl[iI]))|İn[\\s\\xa0]*(?:İnc[iI]li|inc(?:il[İiI]|Il[İi]|İl[Ii])|Inc(?:Ili|il[iI]))|n(?:In[\\s\\xa0]*(?:[İI]nc(?:(?:[İI]li|il[Ii]))|inc(?:[iI]l[iİI]|İl[İi]))|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|Inc(?:[Iİ]li|il[Iİi])|inc(?:İlI|Il[İI]|il[iI]))|in[\\s\\xa0]*(?:İnc(?:İli|il[iIİ]|Il[Iİ])|Inc(?:Il[iİI]|il[İI]|İl[Ii])|inc[Iİi]l[İIi])|un[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:İli|il[Ii])|inc(?:İlI|[iI]l[iIİ]))|İn[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[Iİ]li|il[iİ])|inc(?:İlI|il[iIİ]|Il[iI])))|a[\\s\\xa0]*G(?:öre[\\s\\xa0]*[Ii]ncil|ore[\\s\\xa0]*inc[iI]l))|'(?:in[\\s\\xa0]*(?:Inc(?:[iI]l[iİI]|İl[iİ])|İnc(?:Il[Iİi]|il[İI]|İl[iI])|inc[İIi]l[iİI])|un[\\s\\xa0]*(?:Inc(?:[Iİ]li|il[iİI])|İncil[Ii]|inc(?:İli|il[İi]|Il[iI]))|İn[\\s\\xa0]*(?:İnc[Ii]li|Inc(?:Ili|il[iIİ])|inc(?:ili|Il[İiI]|İl[Ii]))|n(?:İn[\\s\\xa0]*(?:inc(?:İlI|il[İiI]|Il[İi])|Inc(?:[Iİ]li|il[iI])|İncil[Ii])|ın[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:İlI|[Ii]l[Iİi])|Inc(?:[Iİ]li|ilI))|in[\\s\\xa0]*(?:Inc(?:[İI]l[İiI]|il[Iİ])|inc(?:Il[iİI]|İl[Iİ]|il[Ii])|İnc(?:İli|Il[iİ]|il[Ii]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[Iİ]li|il[iİI]))|inc(?:[iI]l[iİI]|İl[Ii]))|un[\\s\\xa0]*(?:İnc[Ii]li|[Ii]nc(?:(?:[Iİ]li|il[Iiİ]))))|In[\\s\\xa0]*(?:Inc(?:İli|il[iIİ])|inc(?:il[İiI]|[İI]l[Ii])|İnc(?:Ili|il[Ii]))|ın[\\s\\xa0]*(?:inc(?:Il[İIi]|[iİ]l[iI])|İncil[iI]|Inc(?:Ili|il[İI]))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*inc(?:[iI]l)))|Yuhanna(?:in(?:c(?:ili|İl[iİ])|[\\s\\xa0]*(?:inc(?:İli|Ilİ)|İnc(?:Ili|İl[iİ])))|’ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[Iİ]l)|öre[\\s\\xa0]*(?:[Iİ]ncil|incİl))|'ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[iİ]l)|öre[\\s\\xa0]*(?:[Iİ]ncil|incİl))|n(?:un[\\s\\xa0]*(?:inc(?:Ili|İl[İI]|ilİ)|İnc(?:İli|il[Iİ]))|in[\\s\\xa0]*(?:İnc(?:ili|İl[iİ]|Ilİ)|inc(?:IlI|İlİ))|In[\\s\\xa0]*inc(?:İli|Ilİ)|ın[\\s\\xa0]*(?:Incİli|İnc(?:İli|il[İI])|inc(?:Il[iİ]|İlİ))|İn[\\s\\xa0]*(?:inc(?:ili|İlİ)|Inc(?:İli|ilİ)|İnc(?:İli|il[iİ])))|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[İi]l)|öre[\\s\\xa0]*(?:[Iİ]ncil|incİl))|un[\\s\\xa0]*(?:inc[iİ]l[Iİ]|İnc(?:İli|il[İI]))|ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:İncil|inc[Iİ]l)|öre[\\s\\xa0]*(?:İncil|inc[iİ]l))|İnc(?:İli|il[Iİ])|In(?:[\\s\\xa0]*(?:inc(?:ili|İlİ)|İncilİ)|cilİ)|ın[\\s\\xa0]*(?:Inc(?:İli|ilI)|İnc(?:[Iİ]li|ilİ)|inc[İI]lİ))|Yuhanna(?:İnc[Ii]li|In(?:[\\s\\xa0]*(?:Inc(?:[İI]li|il[iİI])|İnc(?:[Iİ]li|il[iI])|inc(?:Il[Iiİ]|il[Iİ]|İl[iI]))|c(?:[Iİ]li|il[Ii]))|in(?:c(?:İlI|Il[Iİi]|il[Iİ])|[\\s\\xa0]*(?:İnc(?:İlI|il[Iİi]|Il[İI])|inc(?:il[İiI]|İl[Iİ]|Il[iI])|Inc[iIİ]l[Iiİ]))|ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*[iI]ncil|öre[\\s\\xa0]*(?:incIl|Incil))|n(?:ın[\\s\\xa0]*(?:İnc[iI]li|Inc(?:Ili|il[iİI])|inc(?:IlI|il[Iİi]|İl[iI]))|un[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[İI]li|il[İIi])|inc(?:İli|Il[İI]|il[Ii]))|in[\\s\\xa0]*(?:inc(?:il[iIİ]|Il[İi]|İl[iI])|Inc[iIİ]l[iİI]|İnc(?:İlI|il[İI]|Il[iI]))|In[\\s\\xa0]*(?:[İI]nc(?:(?:[Iİ]li|il[iIİ]))|inc(?:il[iIİ]|İl[Iİ]|Il[Ii]))|İn[\\s\\xa0]*(?:İnc(?:Ili|ilI)|inc(?:Il[İIi]|il[İI]|İl[Ii])|Inc(?:Ili|il[Ii])))|’ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*[iI]ncil|öre[\\s\\xa0]*inc[Ii]l)|'ya[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:incIl|Incil)|öre[\\s\\xa0]*inc[Ii]l)|ın[\\s\\xa0]*(?:inc(?:il[iİI]|[İI]l[iI])|İncil[Ii]|Inc(?:Ili|il[iİ]))|a[\\s\\xa0]*G(?:ore[\\s\\xa0]*(?:incIl|Incil)|öre[\\s\\xa0]*inc[Ii]l)|un[\\s\\xa0]*(?:İnc[iI]li|Inc(?:[İI]li|il[İIi])|inc(?:[iİ]li|Il[İIi])))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kutsal[\\s\\xa0]*Resuller[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]ler[Iİ]))|Ha(?:berc[Iİ]ler(?:[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]ler[Iİ])))|var[Iİ]ler(?:[Iİ]n[\\s\\xa0]*Faal(?:[Iİ]yetler[Iİ])))|Acts|El[cç](?:[Iİ]ler(?:[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]ler[Iİ])))?))|El[cç]|(?:Kutsal[\\s\\xa0]*Resuller(?:in[\\s\\xa0]*[İIi](?:[şs]ler[İIi])|[Iİ]n[\\s\\xa0]*(?:i(?:[şs]ler[iIİ]|[Iİ](?:[sş]leri))))|Resuller[İiI]n[\\s\\xa0]*(?:[Iİi](?:[sş]ler[Iİi]))|El[cç](?:(?:[İI]ler(?:in[\\s\\xa0]*(?:[İIi](?:[sş]ler[İIi])|[İI]n[\\s\\xa0]*(?:i(?:[sş]ler[İIi]|[Iİ](?:[şs]leri)))))|iler[iİI]n[\\s\\xa0]*(?:[iIİ](?:[sş]ler[İiI]))))|Ha(?:var(?:[Iİ]ler(?:(?:[İI]n[\\s\\xa0]*Faal(?:(?:[Iİ]yetleri|iyetler[iİI]))|in[\\s\\xa0]*Faal[İIi]yetler[Iiİ]))|iler[iİI]n[\\s\\xa0]*Faal(?:[iIİ]yetler[iIİ]))|berc(?:[Iİ]ler(?:in[\\s\\xa0]*(?:[Iİi](?:[şs]ler[İIi])|[İI]n[\\s\\xa0]*(?:i(?:[sş]ler[Iiİ]|[İI](?:[şs]leri)))))|iler[iIİ]n[\\s\\xa0]*(?:[iIİ](?:[şs]ler[Iiİ])))))|(?:El[cç](?:[İI]ler(?:[İI]n[\\s\\xa0]*(?:i(?:[sş]ler[İIi]|[Iİ](?:[şs]leri)))))|Haberc[İI]ler(?:[Iİ]n[\\s\\xa0]*(?:i(?:[şs]ler[İIi]|[İI](?:[sş]leri))))|Kutsal[\\s\\xa0]*Resuller[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[sş]leri)))|(?:El[cç](?:[İI]ler(?:[Iİ]n[\\s\\xa0]*(?:[Iİ](?:[şs]leri))))|Haberc[İI]ler(?:[Iİ]n[\\s\\xa0]*(?:[İI](?:[sş]leri)))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Rom|Pavlus(?:['’]tan[\\s\\xa0]*Romal(?:[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)))|tan[\\s\\xa0]*Romal[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|(?:Pavlus(?:['’]tan[\\s\\xa0]*Romal(?:ilar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[İıI]lar))|tan[\\s\\xa0]*Romal(?:ilar(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[ıIİ]lar))|Romal[ıİiI]lar(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?))|Pavlus['’]tan[\\s\\xa0]*Romal(?:[İıI]lar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:I(?:[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))|\.[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler)))|k(?:[Iİ](?:nc(?:[Iİ][\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler)))|[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler)))))|İk(?:[Iİ](?:nc(?:[Iİ][\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler)))|[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))))|Kor(?:[Iİ]ntoslular(?:a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))|Pavlus(?:(?:['’]tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))))|tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))))|2(?:Ko|[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler))?)?|\.[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler))?)?|Cor))|(?:İk(?:i(?:[\s\xa0]*Kor(?:[iIİ]nt(?:oslular|l[iIİ]ler))|nc(?:[iİI][\s\xa0]*Kor(?:[iİI]nt(?:oslular|l[İiI]ler))))|(?:[İI](?:nc(?:i[\s\xa0]*Kor(?:[Iiİ]nt(?:oslular|l[iİI]ler))|(?:[İI][\s\xa0]*Kor(?:int(?:oslular|l[İIi]ler)|[Iİ]ntliler)))|[\s\xa0]*Kor(?:int(?:oslular|l[İIi]ler)|[Iİ]ntliler))))|Pavlus(?:tan[\s\xa0]*Kor(?:intl(?:[İIi]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[Iİ]ntl(?:(?:[İI]ler(?:(?:[’']e[\s\xa0]*(?:ik(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[Iİi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|iler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:[’']tan[\s\xa0]*Kor(?:intl(?:[İIi]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[İiI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]ntl(?:(?:[İI]ler(?:(?:[’']e[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|iler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[İiI](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))))|2(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)|[İI]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)|[İI]ntliler))|ik(?:[İIi](?:[\s\xa0]*Kor(?:[İIi]nt(?:oslular|l[İiI]ler))|nc(?:[Iiİ][\s\xa0]*Kor(?:[İiI]nt(?:oslular|l[iİI]ler)))))|Kor(?:int(?:oslular(?:(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|l(?:[iİI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|(?:[Iİ]nt(?:oslular(?:a[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:ik(?:[Iİi](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup)))))|l(?:[Iiİ]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|I(?:k(?:i(?:[\s\xa0]*Kor(?:[İiI]nt(?:oslular|l[iİI]ler))|nc(?:[iIİ][\s\xa0]*Kor(?:[Iİi]nt(?:oslular|l[iİI]ler))))|(?:[İI](?:nc(?:i[\s\xa0]*Kor(?:[İiI]nt(?:oslular|l[iİI]ler))|(?:[İI][\s\xa0]*Kor(?:int(?:oslular|l[Iiİ]ler)|[Iİ]ntliler)))|[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)|[İI]ntliler))))|I(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[Iİi]ler)|[İI]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[İiI]ler)|[Iİ]ntliler)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlus(?:tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:['’]tan[\s\xa0]*Kor(?:[Iİ]ntl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))))|B(?:[Iİ]r(?:[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))|(?:[Iİ]nc(?:[Iİ][\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))))))|I(?:[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))|\.[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))|lk[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler)))|1(?:Ko|[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler))?)?|\.[\s\xa0]*Ko(?:r(?:[Iİ]nt(?:oslular|l[Iİ]ler))?)?|Cor)|İlk[\s\xa0]*Kor(?:[Iİ]nt(?:oslular|l[Iİ]ler))|Kor(?:[Iİ]ntoslular(?:a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:İlk[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)|[İI]ntliler)|B(?:ir(?:(?:[İIi]nc(?:[iIİ][\s\xa0]*Kor(?:[Iİi]nt(?:oslular|l[Iİi]ler))))|[\s\xa0]*Kor(?:[iİI]nt(?:oslular|l[iIİ]ler)))|(?:[İI]r(?:inc(?:[İiI][\s\xa0]*Kor(?:[İiI]nt(?:oslular|l[İiI]ler)))|(?:[İI]nc(?:i[\s\xa0]*Kor(?:[İIi]nt(?:oslular|l[İiI]ler))|(?:[İI][\s\xa0]*Kor(?:int(?:oslular|l[Iİi]ler)|[İI]ntliler))))|[\s\xa0]*Kor(?:int(?:oslular|l[İIi]ler)|[Iİ]ntliler))))|1(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[Iiİ]ler)|[Iİ]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[iIİ]ler)|[İI]ntliler))|ilk[\s\xa0]*Kor(?:[Iİi]nt(?:oslular|l[Iiİ]ler))|Pavlus(?:tan[\s\xa0]*Kor(?:intl(?:[İiI]ler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[iİI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[Iİi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[Iİ]ntl(?:iler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İIi]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[İIi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[İI]ler(?:(?:['’]e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[İiI]nc(?:[iIİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[iİI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iİI]nc(?:[iIİ][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[İiI][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))))|(?:['’]tan[\s\xa0]*Kor(?:intl(?:[Iİi]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İIi]r(?:[\s\xa0]*Mektup|[İiI]nc(?:[Iiİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iiİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]ntl(?:iler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İIi]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[İiI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[İI]ler(?:(?:[’']e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[İiI]nc(?:[iİI][\s\xa0]*Mektup))|[İI]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[Iİi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iİI]nc(?:[iIİ][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[İIi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))))))|I(?:lk[\s\xa0]*Kor(?:int(?:oslular|l[İiI]ler)|[Iİ]ntliler)|\.[\s\xa0]*Kor(?:int(?:oslular|l[Iİi]ler)|[İI]ntliler)|[\s\xa0]*Kor(?:int(?:oslular|l[iİI]ler)|[İI]ntliler))|Kor(?:int(?:l(?:[İiI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[iIİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|oslular(?:(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iİi][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[İI]nt(?:l(?:[iIİ]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[iİI][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|oslular(?:a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[İIi][\s\xa0]*Mektup))|[İI]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[Iiİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)|(?:['’]a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iİi][\s\xa0]*Mektup))|[Iİ]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[Iİi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pavlus(?:tan[\\s\\xa0]*Galatyal[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))|['’]tan[\\s\\xa0]*Galatyal(?:[Iİı]lar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|Gal)|(?:Pavlus(?:tan[\\s\\xa0]*Galatyal(?:ilar(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[ıIİ]lar)|['’]tan[\\s\\xa0]*Galatyal(?:ilar(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[ıIİ]lar)))|Galatyal[iİIı]lar(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?))|Pavlus['’]tan[\\s\\xa0]*Galatyal(?:[ıIİ]lar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        ...
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlus(?:['’]tan[\\s\\xa0]*F(?:[Iİ]l(?:[Iİ]p(?:[Iİ]l(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))))|tan[\\s\\xa0]*F[Iİ]l(?:[Iİ]p(?:[Iİ]l(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))))|hil)|Flp)|Pavlus(?:tan[\\s\\xa0]*Fİlİp(?:İliler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Ililere[\\s\\xa0]*Mektup|il(?:iler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|’tan[\\s\\xa0]*Fİlİp(?:İliler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Ililer’e[\\s\\xa0]*Mektup|il(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|'tan[\\s\\xa0]*Fİlİp(?:İliler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|Pavlus(?:tan[\\s\\xa0]*Fİlİp(?:il(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ililer[’']e[\\s\\xa0]*Mektup)|’tan[\\s\\xa0]*Fİlİp(?:il(?:Iler['’]e[\\s\\xa0]*Mektup|iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ililer(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|'tan[\\s\\xa0]*Fİlİp(?:Ililer(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler'e[\\s\\xa0]*Mektup)))|(?:Fİlİp(?:Il(?:Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler'e[\\s\\xa0]*Mektup)|il(?:iler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:Ilere[\\s\\xa0]*Mektup|iler['’]e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Pavlus(?:'tan[\\s\\xa0]*F(?:Il(?:ip(?:İl[Iİ]lere[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|İp(?:il(?:[Iİ]ler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|İliler’e[\\s\\xa0]*Mektup))|il(?:Ip(?:İl(?:Iler[’']e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup)|Ilİler'e[\\s\\xa0]*Mektup|il(?:Iler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup))|İp(?:il[iİ]lere[\\s\\xa0]*Mektup|İl(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ilİler'e[\\s\\xa0]*Mektup)|ip(?:ililere[\\s\\xa0]*Mektup|[Iİ]lİler’e[\\s\\xa0]*Mektup))|İl(?:Ip(?:İliler'e[\\s\\xa0]*Mektup|il(?:iler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup))|İp[iİ]l(?:[iİ]ler)|ip(?:Il(?:Ilere[\\s\\xa0]*Mektup|İler[’']e[\\s\\xa0]*Mektup)|İl(?:Ilere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ilİlere[\\s\\xa0]*Mektup)))|’tan[\\s\\xa0]*F(?:il(?:ip(?:İl[Iİ]ler'e[\\s\\xa0]*Mektup|ililer’e[\\s\\xa0]*Mektup)|İp(?:Il(?:iler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ilIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İl(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ip(?:İlilere[\\s\\xa0]*Mektup|IlIlere[\\s\\xa0]*Mektup))|Il(?:ip(?:İl(?:iler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:Iler'e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İp(?:İliler’e[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup))|İl(?:İp(?:il[Iİ]ler|İl[iİ]ler)|ip(?:il[iİ]lere[\\s\\xa0]*Mektup|Il[Iİ]ler’e[\\s\\xa0]*Mektup|İl(?:Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ipil[Iİ]ler'e[\\s\\xa0]*Mektup))|tan[\\s\\xa0]*F(?:il(?:Ipilİlere[\\s\\xa0]*Mektup|ip(?:ililere[\\s\\xa0]*Mektup|Ilİler’e[\\s\\xa0]*Mektup|İl(?:Ilere[\\s\\xa0]*Mektup|iler[’']e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İp(?:il(?:iler’e[\\s\\xa0]*Mektup|Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|İl(?:İp(?:IlIler|İl[Iİ]ler|ilİler)|ip(?:Il[İI]ler’e[\\s\\xa0]*Mektup|İl(?:ilere[\\s\\xa0]*Mektup|Iler['’]e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ilİler'e[\\s\\xa0]*Mektup)|Ipil(?:İlere[\\s\\xa0]*Mektup|iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Il(?:İpİliler'e[\\s\\xa0]*Mektup|IpIliler’e[\\s\\xa0]*Mektup|ipil[İI]ler'e[\\s\\xa0]*Mektup))))|(?:Fİlİp(?:Ilİler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|ilIler’e[\\s\\xa0]*Mektup|İlIler['’]e[\\s\\xa0]*Mektup)|Pavlus(?:'tan[\\s\\xa0]*F(?:İlIp(?:İlilere[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup)|il(?:İp(?:Ilİler’e[\\s\\xa0]*Mektup|İlIler’e[\\s\\xa0]*Mektup|ilIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ip(?:İl(?:Iler[’']e[\\s\\xa0]*Mektup|İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ililere[\\s\\xa0]*Mektup|ilİler’e[\\s\\xa0]*Mektup)|Ip(?:IlIler'e[\\s\\xa0]*Mektup|İlIlere[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup))|Il(?:ip(?:İlİler’e[\\s\\xa0]*Mektup|ililer’e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup)|İpil(?:iler’e[\\s\\xa0]*Mektup|İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|’tan[\\s\\xa0]*F(?:İl(?:Ipİlilere[\\s\\xa0]*Mektup|ip(?:ililer'e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup|İl(?:iler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)))|Il(?:IpIlilere[\\s\\xa0]*Mektup|İpIliler’e[\\s\\xa0]*Mektup)|il(?:İp(?:İlilere[\\s\\xa0]*Mektup|ilİler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|IpİlIlere[\\s\\xa0]*Mektup))|tan[\\s\\xa0]*F(?:il(?:İp(?:ililer'e[\\s\\xa0]*Mektup|İlIler'e[\\s\\xa0]*Mektup|Il(?:ilere[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|ipilİler’e[\\s\\xa0]*Mektup|Ipİlİler'e[\\s\\xa0]*Mektup)|İl(?:Ipİliler'e[\\s\\xa0]*Mektup|ip(?:IlIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İl(?:Ilere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup)|ilİlere[\\s\\xa0]*Mektup))|Il(?:ip(?:İl(?:iler['’]e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:İlere[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup))|Ip(?:İlilere[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup)|İp(?:Ililer’e[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup)))))|(?:Pavlus(?:tan[\\s\\xa0]*F(?:İl(?:ip(?:İliler'e[\\s\\xa0]*Mektup|Il(?:İlere[\\s\\xa0]*Mektup|iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:[iI]ler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ip(?:ilIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Ililer(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İliler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Il(?:Ip(?:il(?:[iI]ler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İliler[’']e[\\s\\xa0]*Mektup)|İp(?:il(?:İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[Ii]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ililer(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ip(?:Il(?:[iI]ler’e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il[İI]ler’e[\\s\\xa0]*Mektup|İl(?:ilere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup|Iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|il(?:İp(?:İliler'e[\\s\\xa0]*Mektup|Il(?:iler[’']e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup|Iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:ilere[\\s\\xa0]*Mektup|Iler’e[\\s\\xa0]*Mektup))|ip(?:İl(?:ilere[\\s\\xa0]*Mektup|Iler['’]e[\\s\\xa0]*Mektup)|[iI]l(?:(?:[iI]ler’e[\\s\\xa0]*Mektup|İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|Ip(?:Il(?:[Ii]ler’e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İl(?:İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[iI]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|il(?:İler[’']e[\\s\\xa0]*Mektup|[Ii]ler’e[\\s\\xa0]*Mektup))))|’tan[\\s\\xa0]*F(?:Il(?:İp(?:il(?:[Ii]ler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|İlilere[\\s\\xa0]*Mektup)|Ip(?:İlilere[\\s\\xa0]*Mektup|il[Ii]lere[\\s\\xa0]*Mektup)|ip[İiI]l(?:[iI]lere[\\s\\xa0]*Mektup))|il(?:İp(?:il[iI]ler’e[\\s\\xa0]*Mektup|IlIler’e[\\s\\xa0]*Mektup)|Ip(?:Ililere[\\s\\xa0]*Mektup|il[Ii]lere[\\s\\xa0]*Mektup)|ip[İiI]l(?:[Ii]lere[\\s\\xa0]*Mektup))|İl(?:ip(?:İlilere[\\s\\xa0]*Mektup|il[Iİ]ler'e[\\s\\xa0]*Mektup|Il[iI]ler'e[\\s\\xa0]*Mektup)|Ip(?:[iI]liler'e[\\s\\xa0]*Mektup|İliler['’]e[\\s\\xa0]*Mektup)))|'tan[\\s\\xa0]*F(?:Il(?:İp(?:Ililer(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:ilere[\\s\\xa0]*Mektup|Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ip(?:[Iİ]liler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il[Iİi]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|ip(?:Il(?:İler['’]e[\\s\\xa0]*Mektup|[iI]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İl(?:Iler['’]e[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup|iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:İler['’]e[\\s\\xa0]*Mektup|iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|İlip(?:İlilere[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup)|il(?:ip(?:İl(?:Ilere[\\s\\xa0]*Mektup|iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|[iI]l(?:iler(?:[’']e[\\s\\xa0]*Mektup|İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))|İp(?:Il(?:İlere[\\s\\xa0]*Mektup|[iI]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İliler’e[\\s\\xa0]*Mektup|il(?:[İi]ler(?:['’]e[\\s\\xa0]*Mektup)|Iler’e[\\s\\xa0]*Mektup))|Ip(?:Il(?:(?:[İI]ler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|il(?:Iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|(?:[iİ]ler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İl(?:İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))))))|FİlİpIl[iI]ler’e[\\s\\xa0]*Mektup)|Pavlus'tan[\\s\\xa0]*Filip(?:[iI]l(?:İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|(?:F(?:Ilİp(?:İlİler['’]e[\\s\\xa0]*Mektup|Ilİler’e[\\s\\xa0]*Mektup)|il(?:Ipİlilere[\\s\\xa0]*Mektup|İp(?:IlIler’e[\\s\\xa0]*Mektup|[iİ]lİlere[\\s\\xa0]*Mektup))|İl(?:Ipİl(?:Ilere[\\s\\xa0]*Mektup|İler['’]e[\\s\\xa0]*Mektup)|İp(?:İl(?:ilere[\\s\\xa0]*Mektup|İler)|il(?:Ilere[\\s\\xa0]*Mektup|[iİ]ler'e[\\s\\xa0]*Mektup))|ipİlİlere[\\s\\xa0]*Mektup))|Pavlus(?:tan[\\s\\xa0]*F(?:Il(?:Ip[iİ]lİler|ipİliler|İp(?:ililer|İl(?:iler’e[\\s\\xa0]*Mektup|İler)))|İl(?:ip(?:il[İI]ler’e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup|İlİler)|Ipİliler|İp(?:İliler|Il[iİ]ler))|il(?:ipIlilere[\\s\\xa0]*Mektup|Ipililer'e[\\s\\xa0]*Mektup|İp(?:İlIlere[\\s\\xa0]*Mektup|ilİler)))|’tan[\\s\\xa0]*F(?:Il(?:Ipİliler'e[\\s\\xa0]*Mektup|ip(?:ililer’e[\\s\\xa0]*Mektup|İlİler'e[\\s\\xa0]*Mektup)|İpilIler'e[\\s\\xa0]*Mektup)|il(?:İp(?:İl(?:Iler[’']e[\\s\\xa0]*Mektup|İler)|il(?:ilere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|ip(?:İl(?:Iler’e[\\s\\xa0]*Mektup|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ilİler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|Ipililer'e[\\s\\xa0]*Mektup)|İl(?:Ip(?:il[Iİ]lere[\\s\\xa0]*Mektup|İliler|Ililer’e[\\s\\xa0]*Mektup)|İp(?:ililer|İlIler|Ilİler)|ip(?:ilİler’e[\\s\\xa0]*Mektup|İlİler)))|'tan[\\s\\xa0]*F(?:Ilİp(?:ililer|İl(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler))|İl(?:ip(?:[Iİ]lIler'e[\\s\\xa0]*Mektup|il[İi]ler’e[\\s\\xa0]*Mektup)|Ip(?:İl(?:iler’e[\\s\\xa0]*Mektup|İler)|il(?:Ilere[\\s\\xa0]*Mektup|İler'e[\\s\\xa0]*Mektup))|İp(?:İlIler|Il[Iİ]ler))|il(?:Ip[İi]lİler|İpilİler|ip[iİ]liler))))|(?:F(?:İlIpİlİlere[\\s\\xa0]*Mektup|Il(?:İp[İI]lİlere[\\s\\xa0]*Mektup|ipİlIlere[\\s\\xa0]*Mektup))|Pavlus(?:'tan[\\s\\xa0]*F(?:İl(?:Ipililere[\\s\\xa0]*Mektup|ip(?:Ililer'e[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup|İl(?:Iler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)))|ilİpİl(?:ilere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup))|tan[\\s\\xa0]*F(?:ilipIlIler'e[\\s\\xa0]*Mektup|İlIpilİler[’']e[\\s\\xa0]*Mektup|Ilİpİlilere[\\s\\xa0]*Mektup)|’tan[\\s\\xa0]*F(?:il(?:İp(?:İliler’e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup)|Ipİl(?:Iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İl(?:ipIlİlere[\\s\\xa0]*Mektup|Ipil(?:ilere[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup))|Ilİpİliler'e[\\s\\xa0]*Mektup)))|(?:Pavlus(?:’tan[\\s\\xa0]*F(?:il[Ii]pİliler'e[\\s\\xa0]*Mektup|Ilipİl[Ii]ler'e[\\s\\xa0]*Mektup|İl(?:ip(?:ilIlere[\\s\\xa0]*Mektup|Il[iI]lere[\\s\\xa0]*Mektup)|IpIlilere[\\s\\xa0]*Mektup))|'tan[\\s\\xa0]*Fİl(?:ip(?:Ililere[\\s\\xa0]*Mektup|il(?:[Ii]ler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ip(?:ililer'e[\\s\\xa0]*Mektup|Ililer(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|tan[\\s\\xa0]*F(?:Il(?:ip(?:ililer'e[\\s\\xa0]*Mektup|Il[Ii]ler'e[\\s\\xa0]*Mektup)|Ip(?:Ililer'e[\\s\\xa0]*Mektup|il[iI]ler'e[\\s\\xa0]*Mektup))|il(?:ip(?:Ililer'e[\\s\\xa0]*Mektup|il[iI]ler'e[\\s\\xa0]*Mektup)|Ip(?:ilIler'e[\\s\\xa0]*Mektup|Il[iI]ler'e[\\s\\xa0]*Mektup))))|F(?:Il(?:İpilİlere[\\s\\xa0]*Mektup|ipİlilere[\\s\\xa0]*Mektup|Ipİl[Ii]lere[\\s\\xa0]*Mektup)|il(?:İpIlİlere[\\s\\xa0]*Mektup|IpİlIlere[\\s\\xa0]*Mektup|ipİl[iI]lere[\\s\\xa0]*Mektup)))|Pavlustan[\\s\\xa0]*FIlIpilIlere[\\s\\xa0]*Mektup|(?:Pavlus(?:'tan[\\s\\xa0]*F(?:il(?:ipilIler|İpİlİler)|Il(?:İp(?:İliler|ilIler|Ilİler)|ipilİler|Ipİl[iİ]ler)|İl(?:Ip(?:İlIler|ilİler’e[\\s\\xa0]*Mektup)|ip(?:Ililer’e[\\s\\xa0]*Mektup|İlİler)|İpIliler))|’tan[\\s\\xa0]*F(?:İl(?:Ip(?:ilIler’e[\\s\\xa0]*Mektup|İlİler)|İpIliler|ip(?:İlIler|ilİler))|Il(?:İp(?:Ililer'e[\\s\\xa0]*Mektup|ilIlere[\\s\\xa0]*Mektup|İl[Iİ]ler)|ip(?:Ililer'e[\\s\\xa0]*Mektup|ilIler’e[\\s\\xa0]*Mektup)|Ipilİler’e[\\s\\xa0]*Mektup)|il(?:Ip(?:İl(?:iler’e[\\s\\xa0]*Mektup|İler)|ilİler'e[\\s\\xa0]*Mektup)|ipilİlere[\\s\\xa0]*Mektup|İpIlİler))|tan[\\s\\xa0]*F(?:Il(?:İp(?:Ililer|ilİler)|ip[Iİ]lİler|IpIlIler)|İl(?:ipİliler|İpilIler|Ip(?:il(?:iler’e[\\s\\xa0]*Mektup|İler)|İlİler))|il(?:ipİlIler|İpİl(?:Iler’e[\\s\\xa0]*Mektup|İler))))|F(?:il(?:ipİlİler’e[\\s\\xa0]*Mektup|İp(?:Il(?:İler[’']e[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup)|İlİler[’']e[\\s\\xa0]*Mektup)|Ipİl(?:İlere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup))|Il(?:İpİl(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|Ipİlİler'e[\\s\\xa0]*Mektup)|İl(?:İp(?:İliler|il(?:ilere[\\s\\xa0]*Mektup|İler|Iler'e[\\s\\xa0]*Mektup))|ip(?:Ililere[\\s\\xa0]*Mektup|il[Iİ]ler'e[\\s\\xa0]*Mektup|İl(?:Ilere[\\s\\xa0]*Mektup|İler['’]e[\\s\\xa0]*Mektup))|Ip(?:ilİlere[\\s\\xa0]*Mektup|İliler['’]e[\\s\\xa0]*Mektup))))|(?:Pavlus’tan[\\s\\xa0]*F(?:il(?:Ip(?:il(?:İler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|Ilİler'e[\\s\\xa0]*Mektup)|İpililer'e[\\s\\xa0]*Mektup|ipilIler’e[\\s\\xa0]*Mektup)|IlIpilİlere[\\s\\xa0]*Mektup)|F(?:Ilipİlİler’e[\\s\\xa0]*Mektup|İl(?:IpİlIler'e[\\s\\xa0]*Mektup|ip(?:İlIler’e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup))))|(?:Pavlus’tan[\\s\\xa0]*F(?:il(?:Ip(?:il(?:İlere[\\s\\xa0]*Mektup|[Ii]ler’e[\\s\\xa0]*Mektup)|Il(?:[Ii]ler(?:[’']e[\\s\\xa0]*Mektup)|İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İpIl[iI]ler'e[\\s\\xa0]*Mektup|ip(?:il(?:İler[’']e[\\s\\xa0]*Mektup|[iI]ler'e[\\s\\xa0]*Mektup)|Il[iI]ler(?:['’]e[\\s\\xa0]*Mektup)))|Il(?:Ip(?:il(?:[Ii]ler(?:[’']e[\\s\\xa0]*Mektup)|İler'e[\\s\\xa0]*Mektup)|Ililer['’]e[\\s\\xa0]*Mektup)|ip(?:ililer'e[\\s\\xa0]*Mektup|Il(?:Iler[’']e[\\s\\xa0]*Mektup|iler’e[\\s\\xa0]*Mektup|İler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|İpililer'e[\\s\\xa0]*Mektup))|F(?:[Ii]lIpİlİler’e[\\s\\xa0]*Mektup|İl(?:ip(?:İl(?:iler[’']e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|ilİlere[\\s\\xa0]*Mektup)|Ip(?:İlIler’e[\\s\\xa0]*Mektup|Ilİlere[\\s\\xa0]*Mektup))))|(?:F(?:Il(?:Ip(?:il(?:İler['’]e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|İl(?:İlere[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup))|İp(?:Ililer'e[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup|İlİler)|ipİlİler'e[\\s\\xa0]*Mektup)|İl(?:ip(?:Il(?:İler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|ililere[\\s\\xa0]*Mektup|İlİler)|Ip(?:İlilere[\\s\\xa0]*Mektup|ilİler'e[\\s\\xa0]*Mektup)|İp(?:İlIler|Il(?:iler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|İler)))|il(?:Ipilİlere[\\s\\xa0]*Mektup|İp(?:İl(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler'e[\\s\\xa0]*Mektup)|il[Iİ]ler’e[\\s\\xa0]*Mektup)|ipililer’e[\\s\\xa0]*Mektup))|Pavlus(?:’tan[\\s\\xa0]*F(?:Il(?:İp(?:ililere[\\s\\xa0]*Mektup|Ilİler)|IpIlİler)|il(?:IpİlIler’e[\\s\\xa0]*Mektup|ip(?:Ililer|İlİler)|İp(?:İliler|ilIler))|İl(?:İpIlIler|Ip(?:İlIler|ilİler)|ipilIler’e[\\s\\xa0]*Mektup))|tan[\\s\\xa0]*F(?:Il(?:ipil(?:ilere[\\s\\xa0]*Mektup|Iler)|İp(?:İlIler|Ilİler)|IpIlİler)|İl(?:İpililer|Ip(?:İlIler|ilIler’e[\\s\\xa0]*Mektup)|ipIlİler)|il(?:Ipİliler|İpililer|ipİlİler))|'tan[\\s\\xa0]*F(?:IlIpilİler|İl(?:ip(?:İliler|Il(?:Iler’e[\\s\\xa0]*Mektup|İler))|İpilIler)|il(?:ipİlİler|İp(?:İliler|Il[iİ]ler)|Ip[iİ]liler))))|(?:F(?:İlIpIl(?:ilere[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup|Iler'e[\\s\\xa0]*Mektup)|Il(?:İp(?:ilİler’e[\\s\\xa0]*Mektup|IlIler’e[\\s\\xa0]*Mektup)|ipIlIler’e[\\s\\xa0]*Mektup)|ilİpİliler'e[\\s\\xa0]*Mektup)|Pavlus’tan[\\s\\xa0]*F(?:İlIpililer’e[\\s\\xa0]*Mektup|ilİpIlilere[\\s\\xa0]*Mektup))|(?:Pavlus’tan[\\s\\xa0]*F(?:İlip[Ii]liler’e[\\s\\xa0]*Mektup|IlİpIlilere[\\s\\xa0]*Mektup|ilİpIlIlere[\\s\\xa0]*Mektup)|F(?:il(?:ip(?:Il[Ii]ler’e[\\s\\xa0]*Mektup|ilIler’e[\\s\\xa0]*Mektup)|Ip[Ii]l(?:[iI]ler’e[\\s\\xa0]*Mektup)|İpililer’e[\\s\\xa0]*Mektup)|Il(?:ip(?:il[iI]ler’e[\\s\\xa0]*Mektup|Ililer’e[\\s\\xa0]*Mektup)|Ip[Ii]l(?:[Ii]ler’e[\\s\\xa0]*Mektup)|İp(?:İlIler'e[\\s\\xa0]*Mektup|il[Ii]ler’e[\\s\\xa0]*Mektup|Ililer’e[\\s\\xa0]*Mektup))|İl(?:ip(?:IlIler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|il(?:Ilere[\\s\\xa0]*Mektup|İler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup))|Ip(?:Il(?:Ilere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|il(?:İler’e[\\s\\xa0]*Mektup|(?:[Ii]ler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))))))|(?:F(?:il(?:Ip(?:Ilİler[’']e[\\s\\xa0]*Mektup|İlİler'e[\\s\\xa0]*Mektup)|İp(?:ilIler'e[\\s\\xa0]*Mektup|İlİler)|ip(?:Il(?:İlere[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)|İlİlere[\\s\\xa0]*Mektup))|Il(?:ipİliler'e[\\s\\xa0]*Mektup|İp(?:ilIlere[\\s\\xa0]*Mektup|İl(?:ilere[\\s\\xa0]*Mektup|Iler’e[\\s\\xa0]*Mektup)|Ilİler'e[\\s\\xa0]*Mektup))|İl(?:Ip(?:Ilİler'e[\\s\\xa0]*Mektup|İlİler)|ipİlilere[\\s\\xa0]*Mektup|İpIliler))|Pavlus(?:'tan[\\s\\xa0]*F(?:İl(?:ipİlIler|Ipil(?:Iler’e[\\s\\xa0]*Mektup|İler))|Il(?:İpilİler|ipİl[İi]ler)|il(?:ipIliler|IpIlİler|İp[iİ]lIler))|’tan[\\s\\xa0]*F(?:il(?:İpililer|ipilIler)|Il(?:ip(?:İlIler’e[\\s\\xa0]*Mektup|ilİler)|Ipİlİler|İp(?:İliler|ilİler))|İl(?:IpilIler|ip(?:İliler|Ilİler)))|tan[\\s\\xa0]*F(?:Il(?:ipIlIler(?:e[\\s\\xa0]*Mektup)?|Ipİliler)|İl(?:ip(?:İlIler|Ililer’e[\\s\\xa0]*Mektup)|IpIlİler)|il(?:İp(?:[iİ]lIler|Ilİler)|Ipİlİler|ipIlİler))))|(?:Pavlus’tan[\\s\\xa0]*F(?:ilipİliler’e[\\s\\xa0]*Mektup|IlIpİliler’e[\\s\\xa0]*Mektup)|F(?:İlipIlİler'e[\\s\\xa0]*Mektup|Ilİp(?:IlIler'e[\\s\\xa0]*Mektup|il[iI]ler'e[\\s\\xa0]*Mektup)|il(?:İp(?:İlIlere[\\s\\xa0]*Mektup|il[İi]ler'e[\\s\\xa0]*Mektup|Il[Ii]ler'e[\\s\\xa0]*Mektup)|ipİlİler'e[\\s\\xa0]*Mektup)))|Pavlustan[\\s\\xa0]*FilIpIlIlere[\\s\\xa0]*Mektup|(?:Pavlus(?:'tan[\\s\\xa0]*F(?:İl(?:Ip(?:İliler|Ililer’e[\\s\\xa0]*Mektup)|ipilİler)|Il(?:ip(?:İlIler|Il[İi]ler)|İp(?:Ililer|İlIler)))|tan[\\s\\xa0]*F(?:İl(?:ipilİler|IpIliler’e[\\s\\xa0]*Mektup)|il(?:IpilIler|ip(?:İliler|ilİler)|İp[Iİ]liler))|’tan[\\s\\xa0]*F(?:il(?:ipİliler|İp(?:[Iİ]lIler|ilİler))|İlIpIl[iİ]ler|Il(?:ip(?:ililer|İlİler)|Ipilİler)))|F(?:Il(?:ip(?:il(?:İler(?:'e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler'e[\\s\\xa0]*Mektup)|İlİlere[\\s\\xa0]*Mektup)|İpIlilere[\\s\\xa0]*Mektup)|il(?:İpİlIler’e[\\s\\xa0]*Mektup|ip(?:Ilİler’e[\\s\\xa0]*Mektup|İl(?:Iler’e[\\s\\xa0]*Mektup|iler'e[\\s\\xa0]*Mektup)))|İlİpilIler))|Pavlus(?:'tan[\\s\\xa0]*FİlipilIler’e[\\s\\xa0]*Mektup|tan[\\s\\xa0]*Fİlipililer’e[\\s\\xa0]*Mektup)|(?:F(?:Il(?:ip(?:İl(?:iler’e[\\s\\xa0]*Mektup|İler)|Ilİlere[\\s\\xa0]*Mektup)|IpIlIler'e[\\s\\xa0]*Mektup|İp(?:IlIlere[\\s\\xa0]*Mektup|İliler’e[\\s\\xa0]*Mektup))|İl(?:ipİlIler|İpIlIler|Ipililer’e[\\s\\xa0]*Mektup)|il(?:ip(?:İlIler'e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup)|Ipilİler’e[\\s\\xa0]*Mektup|İpilİler))|Pavlus(?:tan[\\s\\xa0]*F(?:Il(?:Ipililer(?:e[\\s\\xa0]*Mektup)?|ip(?:İlIler|ilİler)|İp(?:İliler|IlIler))|İlIpilIler)|’tan[\\s\\xa0]*F(?:Ilip[İI]lIler|il(?:İpIliler|Ipilİler)|İlipililer)|'tan[\\s\\xa0]*F(?:il(?:İpililer|ip(?:İlIler|Ilİler))|İlIpIl[Iİ]ler|IlIpIliler)))|FIl(?:ip(?:ililer'e[\\s\\xa0]*Mektup|Ilİler’e[\\s\\xa0]*Mektup)|Ip(?:İliler'e[\\s\\xa0]*Mektup|Ilİler'e[\\s\\xa0]*Mektup|ilİlere[\\s\\xa0]*Mektup))|F(?:il(?:ip(?:IlIler'e[\\s\\xa0]*Mektup|il(?:[Ii]ler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Ip(?:İliler'e[\\s\\xa0]*Mektup|Il(?:İlere[\\s\\xa0]*Mektup|[Ii]ler'e[\\s\\xa0]*Mektup)|il[İIi]ler'e[\\s\\xa0]*Mektup))|Il(?:ip(?:İlIler'e[\\s\\xa0]*Mektup|ilİler’e[\\s\\xa0]*Mektup|Il[İiI]ler'e[\\s\\xa0]*Mektup)|Ip(?:ililer'e[\\s\\xa0]*Mektup|Il(?:İler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|iler'e[\\s\\xa0]*Mektup))))|(?:F(?:Il(?:ipİlIler’e[\\s\\xa0]*Mektup|Ipİlİler|İp(?:il(?:ilere[\\s\\xa0]*Mektup|İler)|İliler))|İl(?:İpililer|ip(?:İliler|Ilİler)|IpIliler’e[\\s\\xa0]*Mektup))|Pavlus(?:’tan[\\s\\xa0]*F(?:Il(?:IpİlIler|İpIliler)|ilip(?:ililer|Ilİler)|İlIpililer)|tan[\\s\\xa0]*F(?:ilIpil(?:Ilere[\\s\\xa0]*Mektup|İler)|Il(?:IpİlIler|ipililer|İpilIler)|İlipIlIler)|'tan[\\s\\xa0]*F(?:Il(?:İpIlIler|IpilIler)|il(?:IpİlIler|ipilİler)|İlipilIler)))|(?:Pavlustan[\\s\\xa0]*F(?:il(?:Ip[Ii]lilere[\\s\\xa0]*Mektup|ip[iI]lIlere[\\s\\xa0]*Mektup)|Il(?:ip(?:Ililere[\\s\\xa0]*Mektup|ilIlere[\\s\\xa0]*Mektup)|IpIlilere[\\s\\xa0]*Mektup))|Filİp[Ii]l(?:[Ii]lere[\\s\\xa0]*Mektup))|(?:Pavlus(?:’tan[\\s\\xa0]*F(?:Il(?:İpIlIler|IpIliler)|il(?:IpİlIler|ipilİler)|İlipIliler)|'tan[\\s\\xa0]*F(?:ilİpIlIler|Il(?:ipIlIler|Ip(?:İlIler|Ilİler))|İlipililer)|tan[\\s\\xa0]*F(?:il(?:İpIlIler|Ip(?:İlIler|Ilİler))|İlIpIliler|IlipIliler))|F(?:il(?:ipİlİler|İp(?:İlIler|Ilİler)|Ip(?:ililere[\\s\\xa0]*Mektup|İlIler’e[\\s\\xa0]*Mektup))|İl(?:Ip(?:İliler|ilİler)|ipIliler’e[\\s\\xa0]*Mektup)))|(?:Pavlus(?:'tan[\\s\\xa0]*F(?:il(?:Ip(?:ilIler|Il[Ii]ler)|ipIlIler)|İl(?:Ip(?:Ililer|il[iI]ler)|ipIl[Ii]ler)|Il(?:Ip(?:ililer|IlIler)|ipil[iI]ler))|tan[\\s\\xa0]*F(?:İl(?:Ip(?:ililer|IlIler)|ip(?:Ililer|il[Ii]ler))|il(?:ip[Ii]l(?:[Ii]ler)|Ip(?:ililer|Il[iI]ler))|IlIp(?:Ililer|ilIler))|’tan[\\s\\xa0]*F(?:İl(?:ip[Ii]lIler|IpIlIler)|Il(?:Ip(?:İliler|IlIler|il[iI]ler)|ip(?:İliler|ilIler|Il[iİ]ler)|İpil[Ii]ler)|il(?:Ip(?:Il[iİI]ler|İliler|il[Ii]ler)|ip[İI]lIler)))|F(?:il(?:İp(?:İliler|[iI]l(?:[iI]ler))|Ip(?:il(?:Iler(?:e[\\s\\xa0]*Mektup)?|[iİ]ler)|Il(?:(?:[iI]ler(?:e[\\s\\xa0]*Mektup)?)|İler)|İl(?:iler(?:’e[\\s\\xa0]*Mektup)?|[Iİ]ler))|ip(?:(?:[iI]l(?:(?:[Ii]ler(?:e[\\s\\xa0]*Mektup)?)|İler))|İl(?:iler(?:’e[\\s\\xa0]*Mektup)?|Iler)))|İl(?:ip(?:Il(?:Iler(?:’e[\\s\\xa0]*Mektup)?|iler)|il(?:(?:[Ii]ler(?:’e[\\s\\xa0]*Mektup)?)|İler))|Ip(?:İlIler|Il(?:Iler(?:’e[\\s\\xa0]*Mektup)?|[iİ]ler)|il(?:Iler(?:’e[\\s\\xa0]*Mektup)?|iler)))|Il(?:İp(?:Il[iİI]ler|İlIler|il[iI]ler)|Ip(?:(?:[iI]l(?:(?:[Ii]ler(?:e[\\s\\xa0]*Mektup)?)|İler))|İl(?:[Ii]ler(?:’e[\\s\\xa0]*Mektup)?))|ip(?:(?:[Ii]l(?:(?:[Ii]ler(?:e[\\s\\xa0]*Mektup)?)|İler))|İl[iI]ler)))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CK]ol|Pavlus(?:tan[\\s\\xa0]*Kolosel[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|['’]tan[\\s\\xa0]*Kolosel(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))))|Pavlus(?:tan[\\s\\xa0]*Koloseliler(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|[’']tan[\\s\\xa0]*Koloseliler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|(?:Pavlus(?:tan[\\s\\xa0]*Kolosel[iİ]ler|['’]tan[\\s\\xa0]*Kolosel(?:[Iİ]ler))|Kolosel(?:iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)|Iler'e[\\s\\xa0]*Mektup|İler(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|Koloseliler'e[\\s\\xa0]*Mektup|(?:Kolosel(?:Iler(?:’e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)?|[iİ]ler)|Pavlus(?:['’]tan[\\s\\xa0]*Koloseliler|tan[\\s\\xa0]*KoloselIler)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İk[Iİ](?:[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler)|nc[Iİ][\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler))))|2(?:Thess|[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|\.[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|Se)|I(?:I(?:[\s\xa0]*Selan[Iİ]kl(?:[Iİ]ler)|\.[\s\xa0]*Selan[Iİ]kl(?:[Iİ]ler))|k[Iİ](?:[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler)|nc[Iİ][\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler)))))|Pavlus(?:tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))))))|(?:['’]tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))))))|[Iİ]k(?:[Iİ]nc(?:[Iİ][\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler))))|(?:Selan(?:[İiI]kl(?:[Iİi]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|(?:[İi]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|Pavlus(?:tan[\s\xa0]*Selan(?:ikl(?:[İiI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[Iİ]kl(?:(?:[Iİ]ler(?:(?:['’]e[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|iler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|(?:[’']tan[\s\xa0]*Selan(?:ikl(?:[İiI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iİI](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[Iİ]kl(?:(?:[Iİ]ler(?:(?:[’']e[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup))))|e[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))|iler(?:(?:['’]e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İiI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|(?:[İi]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))))|İk(?:[Iİ](?:nc(?:i[\s\xa0]*Selan(?:[İIi]kl(?:[İIi]ler)|[Iİ][\s\xa0]*Selan(?:(?:[İI]kliler|ikl[İiI]ler)))|[\s\xa0]*Selan(?:[İI]kliler|ikl[İIi]ler)))|i(?:[\s\xa0]*Selan[İIi]kl(?:[İiI]ler)|nc[Iiİ][\s\xa0]*Selan(?:[Iiİ]kl(?:[iIİ]ler))))|2(?:[\s\xa0]*Selan(?:[İI]kliler|ikl[Iiİ]ler)|\.[\s\xa0]*Selan(?:[Iİ]kliler|ikl[Iİi]ler))|I(?:k(?:[Iİ](?:nc(?:i[\s\xa0]*Selan(?:[iIİ]kl(?:[iİI]ler)|[Iİ][\s\xa0]*Selan(?:(?:[İI]kliler|ikl[iIİ]ler)))|[\s\xa0]*Selan(?:[İI]kliler|ikl[İiI]ler)))|i(?:[\s\xa0]*Selan[Iiİ]kl(?:[iİI]ler)|nc[iIİ][\s\xa0]*Selan(?:[Iiİ]kl(?:[İIi]ler))))|I(?:[\s\xa0]*Selan(?:[Iİ]kliler|ikl[iİI]ler)|\.[\s\xa0]*Selan(?:[İI]kliler|ikl[İIi]ler)))|ik[Iiİ](?:[\s\xa0]*Selan(?:[iİI]kl(?:[Iiİ]ler)|nc[iİI][\s\xa0]*Selan(?:[İIi]kl(?:[Iİi]ler)))))|(?:ik[Iİi]nc(?:[iİI][\s\xa0]*Selan(?:[İIi]kl(?:[Iİi]ler)))|[Iİ]k(?:[Iİ](?:nc(?:[Iİ][\s\xa0]*Selan(?:(?:[İI]kliler|ikl[iIİ]ler))|[\s\xa0]*Selan(?:[İI]kliler|ikl[İiI]ler)))))|[Iİ]k(?:[Iİ][\s\xa0]*Selan(?:(?:[İI]kliler|ikl[İiI]ler))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlus(?:(?:['’]tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|tan[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler(?:e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|I(?:[\s\xa0]*Selan[Iİ]kl(?:[Iİ]ler)|\.[\s\xa0]*Selan[Iİ]kl(?:[Iİ]ler)|lk[\s\xa0]*Selan[Iİ]kl(?:[Iİ]ler))|1(?:Thess|[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|\.[\s\xa0]*Se(?:l(?:an[Iİ]kl(?:[Iİ]ler))?)?|Se)|İlk[\s\xa0]*Selan[Iİ]kl(?:[Iİ]ler)|B[Iİ]r(?:[\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler)|[Iİ]nc(?:[Iİ][\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler))))))|B[Iİ]r(?:[Iİ]nc(?:[Iİ][\s\xa0]*Selan(?:[Iİ]kl(?:[Iİ]ler))))|(?:Pavlus(?:(?:[’']tan[\s\xa0]*Selan(?:(?:[İI]kl(?:iler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[iIİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[İI]ler(?:(?:[’']e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iİi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[Iiİ][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iİi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)))))|ikl(?:[iİI]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|tan[\s\xa0]*Selan(?:(?:[Iİ]kl(?:iler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[iİI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[iIİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[Iİ]ler(?:(?:['’]e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup))|[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iiİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))|e[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iİi]nc(?:[iIİ][\s\xa0]*Mektup))|[İI]r(?:(?:[İI]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)))))|ikl(?:[İiI]ler(?:(?:['’]e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[İiI]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[iIİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[Iiİ]nc(?:[iIİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))))|Selan(?:[Iiİ]kl(?:[İIi]ler(?:(?:[’']e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[İIi]nc(?:[Iiİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|e[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİi]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[Iiİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|I(?:lk[\s\xa0]*Selan(?:[İI]kliler|ikl[Iiİ]ler)|[\s\xa0]*Selan(?:[Iİ]kliler|ikl[Iİi]ler)|\.[\s\xa0]*Selan(?:[Iİ]kliler|ikl[İIi]ler))|1(?:[\s\xa0]*Selan(?:[Iİ]kliler|ikl[İiI]ler)|\.[\s\xa0]*Selan(?:[İI]kliler|ikl[İiI]ler))|İlk[\s\xa0]*Selan(?:[Iİ]kliler|ikl[iIİ]ler)|B(?:ir(?:[\s\xa0]*Selan[iİI]kl(?:[iIİ]ler)|[İiI]nc(?:[İiI][\s\xa0]*Selan(?:[iİI]kl(?:[iIİ]ler))))|[Iİ]r(?:inc(?:[Iİi][\s\xa0]*Selan(?:[İIi]kl(?:[Iİi]ler))|[Iİ]nc(?:i[\s\xa0]*Selan(?:[iIİ]kl(?:[iİI]ler)|[Iİ][\s\xa0]*Selan(?:(?:[Iİ]kliler|ikl[iIİ]ler))))|[\s\xa0]*Selan(?:[Iİ]kliler|ikl[İiI]ler))))|ilk[\s\xa0]*Selan[iIİ]kl(?:[Iiİ]ler))|B[Iİ]r(?:(?:[Iİ]nc(?:i[\s\xa0]*Selan(?:[iIİ]kl(?:[iİI]ler)|[Iİ][\s\xa0]*Selan(?:(?:[Iİ]kliler|ikl[iIİ]ler))))|[\s\xa0]*Selan(?:[Iİ]kliler|ikl[İiI]ler)))|B[İI]r(?:[İI]nc(?:[Iİ][\s\xa0]*Selan(?:(?:[Iİ]kliler|ikl[İIi]ler)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:I(?:I(?:\.[\s\xa0]*T[Iİ]moteos|[\s\xa0]*T[Iİ]moteos)|k[Iİ](?:nc(?:[Iİ][\s\xa0]*T(?:[Iİ]moteos)|[\s\xa0]*T[Iİ]moteos)))|İk[Iİ](?:nc(?:[Iİ][\s\xa0]*T(?:[Iİ]moteos)|[\s\xa0]*T[Iİ]moteos))|Pavlus(?:tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))|(?:['’]tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|İk(?:[Iİ](?:[\s\xa0]*Mektup|nc[Iİ][\s\xa0]*Mektup))))))))|2(?:Tim?|\.[\s\xa0]*T(?:[Iİ](?:m(?:oteos)?)?)|[\s\xa0]*T(?:[Iİ](?:m(?:oteos)?)?)))|[Iİ]k(?:[Iİ][\s\xa0]*T(?:[Iİ]moteos))|(?:I(?:I(?:[\s\xa0]*Timoteos|\.[\s\xa0]*Timoteos)|k(?:[İI](?:nc(?:i[\s\xa0]*T(?:[İiI]moteos|[İI][\s\xa0]*Timoteos)|[\s\xa0]*Timoteos))|i(?:[\s\xa0]*T[Iİi]moteos|nc[İiI][\s\xa0]*T(?:[Iiİ]moteos))))|Pavlus(?:tan[\s\xa0]*T(?:imoteos(?:(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[İI]moteos(?:a[\s\xa0]*(?:ik(?:[Iiİ](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)|[İI]nci[\s\xa0]*Mektup)))|(?:['’]a[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup))|(?:[İI]k(?:i(?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))))|(?:['’]tan[\s\xa0]*T(?:imoteos(?:(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iİi](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[iIİ](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[İi]k(?:[Iiİ](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|(?:[Iİ]moteos(?:a[\s\xa0]*(?:ik(?:[iİI](?:[\s\xa0]*Mektup|nc[İiI][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))|(?:[’']a[\s\xa0]*(?:ik(?:[iIİ](?:[\s\xa0]*Mektup|nc[Iiİ][\s\xa0]*Mektup))|(?:[Iİ]k(?:i(?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)|[Iİ]nci[\s\xa0]*Mektup)))))))))|2(?:\.[\s\xa0]*Ti(?:m(?:oteos)?)?|[\s\xa0]*Ti(?:m(?:oteos)?)?)|T(?:[İIi]moteos(?:(?:['’]a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[Iİi](?:[\s\xa0]*Mektup|nc[İIi][\s\xa0]*Mektup)))|(?:[İi]k(?:[İIi](?:[\s\xa0]*Mektup|nc[Iİi][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:I(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|k(?:[İIi](?:[\s\xa0]*Mektup|nc[iIİ][\s\xa0]*Mektup)))|(?:[iİ]k(?:[iIİ](?:[\s\xa0]*Mektup|nc[iİI][\s\xa0]*Mektup)))|2(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|İk(?:[Iİ](?:nc(?:i[\s\xa0]*T(?:[İIi]moteos|[İI][\s\xa0]*Timoteos)|[\s\xa0]*Timoteos))|i(?:[\s\xa0]*T[iIİ]moteos|nc[iIİ][\s\xa0]*T(?:[İIi]moteos)))|ik[İIi](?:[\s\xa0]*T(?:[İiI]moteos|nc[Iiİ][\s\xa0]*T(?:[İIi]moteos))))|(?:ik[İiI]nc(?:[Iiİ][\s\xa0]*T(?:[İIi]moteos))|(?:[Iİ]k(?:[İI](?:[\s\xa0]*Timoteos|nc[İI][\s\xa0]*Timoteos)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:B[Iİ]r(?:[\s\xa0]*T(?:[Iİ]moteos|[Iİ]nc(?:[Iİ][\s\xa0]*T(?:[Iİ]moteos))))|I(?:lk[\s\xa0]*T[Iİ]moteos|\.[\s\xa0]*T[Iİ]moteos|[\s\xa0]*T[Iİ]moteos)|Pavlus(?:tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))|(?:['’]tan[\s\xa0]*T(?:[Iİ]moteos(?:a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))|(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iİ]r(?:[\s\xa0]*Mektup|[Iİ]nc(?:[Iİ][\s\xa0]*Mektup)))|İlk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|1(?:Tim?|\.[\s\xa0]*T(?:[Iİ](?:m(?:oteos)?)?)|[\s\xa0]*T(?:[Iİ](?:m(?:oteos)?)?))|İlk[\s\xa0]*T[Iİ]moteos)|B[Iİ]r(?:[Iİ]nc(?:[Iİ][\s\xa0]*T(?:[Iİ]moteos)))|(?:T(?:[İIi]moteos(?:(?:[’']a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[Iiİ][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|I(?:[\s\xa0]*Timoteos|lk[\s\xa0]*Timoteos|\.[\s\xa0]*Timoteos)|1(?:\.[\s\xa0]*Ti(?:m(?:oteos)?)?|[\s\xa0]*Ti(?:m(?:oteos)?)?)|ilk[\s\xa0]*T[iİI]moteos|B(?:ir(?:[\s\xa0]*T[Iiİ]moteos|[İiI]nc(?:[İiI][\s\xa0]*T(?:[İiI]moteos)))|[İI]r(?:(?:[Iİ]nc(?:i[\s\xa0]*T(?:[iIİ]moteos|[İI][\s\xa0]*Timoteos))|[\s\xa0]*Timoteos|inc[İIi][\s\xa0]*T(?:[İIi]moteos))))|İlk[\s\xa0]*Timoteos|Pavlus(?:tan[\s\xa0]*T(?:(?:[Iİ]moteos(?:a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[iİI]nc(?:[İIi][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)|(?:['’]a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iİi][\s\xa0]*Mektup))|[İI]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))|imoteos(?:(?:['’]a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iİI]r(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iiİ][\s\xa0]*Mektup)))|[İi]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iİI]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup))))|(?:[’']tan[\s\xa0]*T(?:(?:[Iİ]moteos(?:a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[Iİi]nc(?:[Iiİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[Iİi][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup)|(?:['’]a[\s\xa0]*(?:B(?:ir(?:[\s\xa0]*Mektup|[İIi]nc(?:[iIİ][\s\xa0]*Mektup))|[Iİ]r(?:(?:[Iİ]nci[\s\xa0]*Mektup|inc[iIİ][\s\xa0]*Mektup)))|ilk[\s\xa0]*Mektup))))|imoteos(?:(?:[’']a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[iIİ]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İiI][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))|a[\s\xa0]*(?:I(?:[\s\xa0]*Mektup|lk[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)|B(?:[Iiİ]r(?:[\s\xa0]*Mektup|[iIİ]nc(?:[İIi][\s\xa0]*Mektup)))|[iİ]lk[\s\xa0]*Mektup|1(?:[\s\xa0]*Mektup|\.[\s\xa0]*Mektup)))))))|B[İI]r(?:[Iİ]nc(?:[İI][\s\xa0]*Timoteos)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pavlus(?:['’]tan[\\s\\xa0]*T(?:[Iİ]t(?:[ou]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|tan[\\s\\xa0]*T[Iİ]t(?:[ou]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup))))|T[Iİ]t)|(?:T(?:it[uo]s(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)?|[İI]t(?:[uo]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)))|Pavlus(?:['’]tan[\\s\\xa0]*T(?:it(?:[ou]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[Iİ]t(?:[uo]s)))|tan[\\s\\xa0]*T(?:it[ou]s(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[Iİ]t(?:[ou]s))))|(?:Pavlus['’]tan[\\s\\xa0]*T(?:[Iİ]t(?:[uo]s))|Tit))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Flm|P(?:hlm|avlus(?:tan[\\s\\xa0]*F[Iİ]l(?:[Iİ]mon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)))|['’]tan[\\s\\xa0]*F(?:[Iİ]l(?:[Iİ]mon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)))))))|(?:Pavlus(?:tan[\\s\\xa0]*F(?:il[Iİi]mon(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[Iİ]l(?:imon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[İI]mon)))|['’]tan[\\s\\xa0]*F(?:il(?:[Iiİ]mon(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)|[İI]l(?:imon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[Iİ]mon)))))|F[İiI]l(?:[İiI]mon(?:(?:[’']a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?)))|Pavlus(?:['’]tan[\\s\\xa0]*F(?:[İI]l(?:imon(?:(?:['’]a[\\s\\xa0]*Mektup|a[\\s\\xa0]*Mektup)?|[Iİ]mon)))|tan[\\s\\xa0]*F[İI]l(?:[İI]mon))|Pavlus['’]tan[\\s\\xa0]*F(?:[İI]l(?:[Iİ]mon)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Heb|[Iİ]br(?:an(?:[Iİ]ler(?:(?:['’]e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))?))|(?:[Iİ]br)|(?:[Iİ]braniler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup))|ibran[iIİ]ler(?:(?:[’']e[\\s\\xa0]*Mektup|e[\\s\\xa0]*Mektup)))|(?:[Iİ]bran(?:[İiI]ler)|ibr(?:an[Iiİ]ler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],

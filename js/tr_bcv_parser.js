...
(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:YC(?:198|200[189])?|KM|C(?:OS|AN)|T(?:C|SV)|HADI))\b/gi;
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp("(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014]|ba[şs]l[ıi]k(?![a-z])|a\\.?" + bcv_parser.prototype.regexps.space + "+ayeti|baplar|ayet|bap|ile|bp|vs|vd|ve|[b-e](?!\\w)|$)+)", "gi");

  bcv_parser.prototype.regexps.match_end_split = /\d\W*ba[şs]l[ıi]k|\d\W*(?:vs|vd)(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[b-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi;
  ...
  bcv_parser.prototype.regexps.first = "(?:1|I|Bir(inci)?|[[İI]i]lk)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.second = "(?:2|II|[[İI]i]ki|[[İI]i]kinci)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.third = "(?:3|III|[ÜU][çc]([üu]nc[üu])?)\\.?" + bcv_parser.prototype.regexps.space + "*";
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Te(?:sn[Iİı]ye|kv[Iİı]n)|Gen|Yar(?:at[Iİı]l(?:[Iİı][sş]))?)|(?:Yarat(?:[Iİı]li[sş]|il[ıiİI][sş])|Te(?:sniye|kvin)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:M[Iİı]s(?:[Iİı]r(?:['’]dan[\\s\\xa0]*(?:[CÇ](?:[Iİı]k(?:[Iİı][sş])))))|Exod|[CÇ](?:[Iİı]k))|(?:M(?:[İIı]s(?:(?:[ıIİ]r(?:[’']dan[\\s\\xa0]*(?:[CÇ](?:(?:[ıİI]ki[sş]|ik[ıİiI][sş]))))|ir['’]dan[\\s\\xa0]*(?:[CÇ](?:[iİIı]k(?:[Iıiİ][sş])))))|is[İIıi]r(?:[’']dan[\\s\\xa0]*(?:[CÇ](?:[iİIı]k(?:[İiıI][sş])))))|[CÇ](?:(?:[Iİı]k(?:[ıiİI][sş])|ik(?:[Iiıİ][şs])?))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Lev[Iiİı]l(?:[Iiİı]ler)?|Lev)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Num"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CÇ](?:[oö]lde[\\s\\xa0]*Say(?:[Iİı]m))|Num|Say(?:[Iİı]lar)?)|(?:[ÇC](?:[oö]lde[\\s\\xa0]*Sayim)|Sayilar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(S(?:[Iİı]rak|ir(?:ak)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        ...
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yeremya['’]n(?:[Iiİı]n[\\s\\xa0]*Mektubu)|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Rev|Va(?:h(?:[Iiİı]y)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mana[sş](?:[sş]e(?:['’]n(?:[Iİı]n[\\s\\xa0]*Duas[Iİı])))|PrMan)|Mana[şs](?:[şs]e(?:['’]n(?:(?:[Iİı]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[Iiıİ])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Deut|Yas(?:a['’]n(?:[Iİı]n[\\s\\xa0]*Tekrar[Iİı]))?)|Yasa['’]n(?:(?:[İIı]n[\\s\\xa0]*Tekrari|in[\\s\\xa0]*Tekrar[iIıİ])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Josh|Y(?:e[sş]u|[sş]u)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Judg|Hak(?:[Iiİı]mler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Esdras|[\s\xa0]*Esdras)|[iİ]lk[\s\xa0]*Esdras|I(?:lk[\s\xa0]*Esdras|\.[\s\xa0]*Esdras|[\s\xa0]*Esdras)|1(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[iİ]ki(?:nci[\s\xa0]*Esdras|[\s\xa0]*Esdras))|I(?:ki(?:nci[\s\xa0]*Esdras|[\s\xa0]*Esdras)|I(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras))|2(?:\.[\s\xa0]*Esdras|[\s\xa0]*Esdras|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Isa|Y(?:e[sş]aya|[sş]a)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[iİ]ki(?:nci[\s\xa0]*Samuel|[\s\xa0]*Samuel))|I(?:ki(?:nci[\s\xa0]*Samuel|[\s\xa0]*Samuel)|I(?:\.[\s\xa0]*Samuel|[\s\xa0]*Samuel))|2(?:[\s\xa0]*Samuel|\.(?:[\s\xa0]*Samuel|\?[\s\xa0]*Sa)|\?[\s\xa0]*Sa|Sam?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Samuel|[\s\xa0]*Samuel)|[iİ]lk[\s\xa0]*Samuel|I(?:lk[\s\xa0]*Samuel|\.[\s\xa0]*Samuel|[\s\xa0]*Samuel)|1(?:[\s\xa0]*Samuel|\.(?:[\s\xa0]*Samuel|\?[\s\xa0]*Sa)|\?[\s\xa0]*Sa|Sam?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[iİ]ki(?:nci[\s\xa0]*Krallar|[\s\xa0]*Krallar))|I(?:ki(?:nci[\s\xa0]*Krallar|[\s\xa0]*Krallar)|I(?:\.[\s\xa0]*Krallar|[\s\xa0]*Krallar))|2(?:[\s\xa0]*Krallar|\.(?:[\s\xa0]*Krallar|\?[\s\xa0]*Kr)|\?[\s\xa0]*Kr|K(?:gs|r))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Krallar|[\s\xa0]*Krallar)|[iİ]lk[\s\xa0]*Krallar|I(?:lk[\s\xa0]*Krallar|\.[\s\xa0]*Krallar|[\s\xa0]*Krallar)|1(?:[\s\xa0]*Krallar|\.(?:[\s\xa0]*Krallar|\?[\s\xa0]*Kr)|\?[\s\xa0]*Kr|K(?:gs|r))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İki(?:nci[\s\xa0]*Tar[Iİı]hler|[\s\xa0]*Tar[Iİı]hler)|I(?:ki(?:nci[\s\xa0]*Tar[Iİı]hler|[\s\xa0]*Tar[Iİı]hler)|I(?:\.[\s\xa0]*Tar[Iİı]hler|[\s\xa0]*Tar[Iİı]hler))|2(?:[\s\xa0]*Tar[Iİı]hler|\.(?:[\s\xa0]*Tar[Iİı]hler|\?[\s\xa0]*Ta)|\?[\s\xa0]*Ta|Chr|Ta))|(?:İki(?:nci[\s\xa0]*Tarihler|[\s\xa0]*Tarihler)|iki(?:nci[\s\xa0]*Tar[Iıİi]hler|[\s\xa0]*Tar[İiıI]hler)|I(?:ki(?:nci[\s\xa0]*Tarihler|[\s\xa0]*Tarihler)|I(?:\.[\s\xa0]*Tarihler|[\s\xa0]*Tarihler))|2(?:\.[\s\xa0]*Tarihler|[\s\xa0]*Tarihler)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Tar[Iİı]hler|[\s\xa0]*Tar[Iİı]hler)|İlk[\s\xa0]*Tar[Iİı]hler|I(?:lk[\s\xa0]*Tar[Iİı]hler|\.[\s\xa0]*Tar[Iİı]hler|[\s\xa0]*Tar[Iİı]hler)|1(?:[\s\xa0]*Tar[Iİı]hler|\.(?:[\s\xa0]*Tar[Iİı]hler|\?[\s\xa0]*Ta)|\?[\s\xa0]*Ta|Chr|Ta))|(?:İlk[\s\xa0]*Tarihler|Bir(?:inci[\s\xa0]*Tarihler|[\s\xa0]*Tarihler)|ilk[\s\xa0]*Tar[İIıi]hler|I(?:lk[\s\xa0]*Tarihler|\.[\s\xa0]*Tarihler|[\s\xa0]*Tarihler)|1(?:\.[\s\xa0]*Tarihler|[\s\xa0]*Tarihler)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yunanca[\\s\\xa0]*Ester|G(?:rek[cç]e[\\s\\xa0]*Ester|kEsth)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Esth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Est(?:er|h)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Job"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ey[uü]p?|Job))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ps"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Azarya['’]n(?:[Iİı]n[\\s\\xa0]*Duas[Iİı])|PrAzar)|Azarya['’]n(?:(?:[ıİI]n[\\s\\xa0]*Duasi|in[\\s\\xa0]*Duas[İıiI])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S[uü]leyman(?:['’](?:[Iİı]n[\\s\\xa0]*(?:(?:[OÖ]zdey(?:[Iİı](?:[sş]ler[Iİı]))|Meseller[Iİı]))))|Meseller|Prov|[OÖ]zd)|S[uü]leyman(?:['’](?:(?:[Iıİ]n[\\s\\xa0]*(?:(?:[OÖ]zdey(?:(?:[ıIİ](?:[sş]leri)|i[şs]ler[İIiı]))|Meselleri))|in[\\s\\xa0]*(?:[ÖO]zdey(?:[İIıi](?:[şs]ler[ıiIİ]))|Meseller[İIiı])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Eccl|Va[Iiİı]z?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[UÜ](?:[cç][\\s\\xa0]*Gen(?:[cç][\\s\\xa0]*Adam(?:[Iİı]n[\\s\\xa0]*Ezg(?:[Iİı]s[Iİı]))))|SgThree)|[UÜ](?:[çc][\\s\\xa0]*Gen(?:[çc][\\s\\xa0]*Adam(?:(?:[ıIİ]n[\\s\\xa0]*Ezg(?:(?:[İIı]si|is[iıIİ]))|in[\\s\\xa0]*Ezg[iIİı]s[iıIİ])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|Ezg[Iİı]ler[\\s\\xa0]*Ezg(?:[Iİı]s[Iİı])?)|Ezg|Ezg(?:[İıI]ler[\\s\\xa0]*Ezg(?:(?:[İıI]si|is[Iİiı]))|iler[\\s\\xa0]*Ezg[Iİıi]s[İıiI]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jer|Yer(?:emya)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ezek|Hez(?:ek[Iiİı]el)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        ...
        osis: ["Joel"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Joel|Yoel?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Amos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Amos?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(O(?:bad|va(?:dya)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jonah|Yun(?:us)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(M(?:[Iİı]ka?|i(?:c|ka?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Nah"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Zeph|Sef(?:anya)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Hag(?:ay)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ze(?:ch|k(?:er[Iiİı]ya)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Mal(?:ak[Iiİı])?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Matta['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Matta['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Matta['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|Mat(?:t(?:a(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)))?)?|Matta(?:[Iİ]ncili)|Matta['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil|n[ıIİu]n[\\s\\xa0]*incili|[uIİı]n[\\s\\xa0]*incili))|Matta['’](?:n(?:[ıIİu]n[\\s\\xa0]*incili|[uIİı]n[\\s\\xa0]*incili))|Matta['’](?:[uIİı]n[\\s\\xa0]*incili)|Matta(?:['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil)|n[İIuı]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Markos['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Markos['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Markos['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|Mar(?:k(?:os(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)))?)?|Markos(?:[Iİ]ncili)|Markos[’'](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil|n[ıuIİ]n[\\s\\xa0]*incili|[ıİuI]n[\\s\\xa0]*incili))|Markos[’'](?:n(?:[ıuIİ]n[\\s\\xa0]*incili|[ıİuI]n[\\s\\xa0]*incili))|Markos[’'](?:[ıİuI]n[\\s\\xa0]*incili)|Markos(?:['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil)|n[ıIuİ]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Luka['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Luka['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Luka['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|Luk(?:a(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|e)?|Luka(?:[Iİ]ncili)|Luka[’'](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil|n[Iİuı]n[\\s\\xa0]*incili|[Iıİu]n[\\s\\xa0]*incili))|Luka[’'](?:n(?:[Iİuı]n[\\s\\xa0]*incili|[Iıİu]n[\\s\\xa0]*incili))|Luka[’'](?:[Iıİu]n[\\s\\xa0]*incili)|Luka(?:['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil)|n[İıuI]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Yuhanna|[\s\xa0]*Yuhanna)|[iİ]lk[\s\xa0]*Yuhanna|I(?:lk[\s\xa0]*Yuhanna|\.[\s\xa0]*Yuhanna|[\s\xa0]*Yuhanna)|1(?:[\s\xa0]*Yuhanna|\.(?:[\s\xa0]*Yuhanna|\?[\s\xa0]*Yu)|\?[\s\xa0]*Yu|John|Yu)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[iİ]ki(?:nci[\s\xa0]*Yuhanna|[\s\xa0]*Yuhanna))|I(?:ki(?:nci[\s\xa0]*Yuhanna|[\s\xa0]*Yuhanna)|I(?:\.[\s\xa0]*Yuhanna|[\s\xa0]*Yuhanna))|2(?:[\s\xa0]*Yuhanna|\.(?:[\s\xa0]*Yuhanna|\?[\s\xa0]*Yu)|\?[\s\xa0]*Yu|John|Yu)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:III(?:\.[\s\xa0]*Yuhanna|[\s\xa0]*Yuhanna)|[UÜ](?:[cç](?:(?:[uü]nc(?:[uü][\s\xa0]*Yuhanna)|[\s\xa0]*Yuhanna)))|3(?:[\s\xa0]*Yuhanna|\.(?:[\s\xa0]*Yuhanna|\?[\s\xa0]*Yu)|\?[\s\xa0]*Yu|John|Yu)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Yuhanna['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Yuhanna['’](?:n(?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)))|Yuhanna['’](?:[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili))|(?:John|Yu(?:h(?:anna(?:[uı]n[\\s\\xa0]*(?:[Iİ]ncili)|[İI]n(?:[\\s\\xa0]*(?:[Iİ]ncili|cili))|a[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)|n[Iuİı]n[\\s\\xa0]*(?:[Iİ]ncili)|['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*(?:[Iİ]ncil))|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*(?:[Iİ]ncil)))?)?)|Yuhanna(?:[Iİ]ncili)|Yuhanna['’](?:a[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil|n[ıİIu]n[\\s\\xa0]*incili|[İIuı]n[\\s\\xa0]*incili))|Yuhanna['’](?:n(?:[ıİIu]n[\\s\\xa0]*incili|[İIuı]n[\\s\\xa0]*incili))|Yuhanna['’](?:[İIuı]n[\\s\\xa0]*incili)|Yuhanna(?:['’]ya[\\s\\xa0]*G(?:[oö]re[\\s\\xa0]*incil)|n[Iuİı]n[\\s\\xa0]*incili|[İıuI]n[\\s\\xa0]*incili|ya[\\s\\xa0]*G[oö]re[\\s\\xa0]*incil|a[\\s\\xa0]*G[öo]re[\\s\\xa0]*incil|incili)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Acts|El[cç](?:[Iİı]ler(?:[Iİı]n[\\s\\xa0]*(?:[Iİı](?:[sş]ler[Iİı])))?))|El[cç]|El[çc](?:(?:[ıİI]ler(?:in[\\s\\xa0]*(?:[İIiı](?:[şs]ler[Iİıi])|[İIı]n[\\s\\xa0]*(?:(?:[ıİI](?:[sş]leri)|i[şs]ler[ıİiI]))))|iler[Iıiİ]n[\\s\\xa0]*(?:[Iıiİ](?:[sş]ler[İıiI]))))|El[çc](?:[Iıİ]ler(?:[ıİI]n[\\s\\xa0]*(?:(?:[İIı](?:[sş]leri)|i[şs]ler[İIiı])))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Rom(?:al[Iiİı]lar)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İki(?:nci[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler)))|I(?:ki(?:nci[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler)))|I(?:\.[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))))|2(?:[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|\.(?:[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|\?[\s\xa0]*Ko)|\?[\s\xa0]*Ko|Cor|Ko))|(?:İki(?:nci[\s\xa0]*Kor(?:[İıI]ntliler|int(?:oslular|l[ıiİI]ler))|[\s\xa0]*Kor(?:[Iıİ]ntliler|int(?:oslular|l[iİIı]ler)))|iki(?:nci[\s\xa0]*Kor(?:[Iıiİ]nt(?:oslular|l[iİıI]ler))|[\s\xa0]*Kor(?:[iİIı]nt(?:oslular|l[iİIı]ler)))|I(?:ki(?:nci[\s\xa0]*Kor(?:[ıİI]ntliler|int(?:oslular|l[iıIİ]ler))|[\s\xa0]*Kor(?:[ıİI]ntliler|int(?:oslular|l[İIıi]ler)))|I(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[iİIı]ler)|[ıIİ]ntliler)|[\s\xa0]*Kor(?:[İıI]ntliler|int(?:oslular|l[Iiıİ]ler))))|2(?:\.[\s\xa0]*Kor(?:int(?:oslular|l[İıiI]ler)|[İıI]ntliler)|[\s\xa0]*Kor(?:[ıIİ]ntliler|int(?:oslular|l[Iiıİ]ler)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler)))|İlk[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|I(?:lk[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|\.[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler)))|1(?:[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|\.(?:[\s\xa0]*Kor(?:[Iİı]nt(?:oslular|l[Iİı]ler))|\?[\s\xa0]*Ko)|\?[\s\xa0]*Ko|Cor|Ko))|(?:İlk[\s\xa0]*Kor(?:[ıİI]ntliler|int(?:oslular|l[Iiıİ]ler))|Bir(?:inci[\s\xa0]*Kor(?:[İıI]ntliler|int(?:oslular|l[iIİı]ler))|[\s\xa0]*Kor(?:[İıI]ntliler|int(?:oslular|l[Iıiİ]ler)))|ilk[\s\xa0]*Kor(?:[ıİIi]nt(?:oslular|l[İıiI]ler))|1(?:\.[\s\xa0]*Kor(?:[İIı]ntliler|int(?:oslular|l[iIıİ]ler))|[\s\xa0]*Kor(?:[ıİI]ntliler|int(?:oslular|l[İIıi]ler)))|I(?:lk[\s\xa0]*Kor(?:[ıIİ]ntliler|int(?:oslular|l[Iiİı]ler))|\.[\s\xa0]*Kor(?:[ıİI]ntliler|int(?:oslular|l[İIiı]ler))|[\s\xa0]*Kor(?:[İIı]ntliler|int(?:oslular|l[Iiİı]ler)))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Gal(?:atyal[Iiİı]lar)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(E(?:ph|f(?:e(?:sl[Iiİı]ler)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Phil|F(?:[Iİı]l(?:[Iİı]p(?:[Iİı]l(?:[Iİı]ler)))|lp))|F(?:[ıİI]l(?:(?:[ıIİ]p(?:(?:[Iİı]liler|il[İIıi]ler))|ip[Iiİı]l(?:[İıIi]ler)))|il[iİIı]p(?:[İıIi]l(?:[iİIı]ler))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Col|Kol(?:osel[Iiİı]ler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İki(?:nci[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler))|I(?:ki(?:nci[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler))|I(?:\.[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)))|2(?:[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|\.(?:[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|\?[\s\xa0]*Se)|Thess|\?[\s\xa0]*Se|Se))|(?:İki(?:nci[\s\xa0]*Selan(?:[İıI]kiler|ik[iİıI]ler)|[\s\xa0]*Selan(?:[ıIİ]kiler|ik[İıiI]ler))|iki(?:nci[\s\xa0]*Selan[iıIİ]k(?:[İIiı]ler)|[\s\xa0]*Selan[ıİIi]k(?:[İIiı]ler))|I(?:ki(?:nci[\s\xa0]*Selan(?:[Iıİ]kiler|ik[Iıİi]ler)|[\s\xa0]*Selan(?:[Iİı]kiler|ik[ıiIİ]ler))|I(?:\.[\s\xa0]*Selan(?:[Iİı]kiler|ik[ıİIi]ler)|[\s\xa0]*Selan(?:[Iıİ]kiler|ik[iİıI]ler)))|2(?:\.[\s\xa0]*Selan(?:[ıIİ]kiler|ik[iıİI]ler)|[\s\xa0]*Selan(?:[ıIİ]kiler|ik[İiıI]ler))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler))|İlk[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|I(?:lk[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|\.[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler))|1(?:[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|\.(?:[\s\xa0]*Selan[Iİı]k(?:[Iİı]ler)|\?[\s\xa0]*Se)|Thess|\?[\s\xa0]*Se|Se))|(?:ilk[\s\xa0]*Selan[iıIİ]k(?:[İIiı]ler)|Bir(?:inci[\s\xa0]*Selan(?:[İIı]kiler|ik[İIiı]ler)|[\s\xa0]*Selan(?:[Iıİ]kiler|ik[iIİı]ler))|İlk[\s\xa0]*Selan(?:[İIı]kiler|ik[iıIİ]ler)|1(?:\.[\s\xa0]*Selan(?:[ıIİ]kiler|ik[İIiı]ler)|[\s\xa0]*Selan(?:[İIı]kiler|ik[Iıİi]ler))|I(?:lk[\s\xa0]*Selan(?:[Iıİ]kiler|ik[ıIİi]ler)|\.[\s\xa0]*Selan(?:[Iİı]kiler|ik[Iiİı]ler)|[\s\xa0]*Selan(?:[İIı]kiler|ik[Iıİi]ler))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:İki(?:nci[\s\xa0]*T[Iİı]moteos|[\s\xa0]*T[Iİı]moteos)|I(?:ki(?:nci[\s\xa0]*T[Iİı]moteos|[\s\xa0]*T[Iİı]moteos)|I(?:\.[\s\xa0]*T[Iİı]moteos|[\s\xa0]*T[Iİı]moteos))|2(?:[\s\xa0]*T[Iİı]moteos|\.(?:[\s\xa0]*T[Iİı]moteos|\?[\s\xa0]*T[Iİı])|\?[\s\xa0]*T[Iİı]|Tim?))|(?:İki(?:nci[\s\xa0]*Timoteos|[\s\xa0]*Timoteos)|iki(?:nci[\s\xa0]*T[İiıI]moteos|[\s\xa0]*T[İiıI]moteos)|I(?:ki(?:nci[\s\xa0]*Timoteos|[\s\xa0]*Timoteos)|I(?:\.[\s\xa0]*Timoteos|[\s\xa0]*Timoteos))|2(?:[\s\xa0]*Timoteos|\.(?:[\s\xa0]*Timoteos|\?[\s\xa0]*Ti)|\?[\s\xa0]*Ti)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*T[Iİı]moteos|[\s\xa0]*T[Iİı]moteos)|İlk[\s\xa0]*T[Iİı]moteos|I(?:lk[\s\xa0]*T[Iİı]moteos|\.[\s\xa0]*T[Iİı]moteos|[\s\xa0]*T[Iİı]moteos)|1(?:[\s\xa0]*T[Iİı]moteos|\.(?:[\s\xa0]*T[Iİı]moteos|\?[\s\xa0]*T[Iİı])|\?[\s\xa0]*T[Iİı]|Tim?))|(?:Bir(?:inci[\s\xa0]*Timoteos|[\s\xa0]*Timoteos)|ilk[\s\xa0]*T[İIiı]moteos|İlk[\s\xa0]*Timoteos|I(?:lk[\s\xa0]*Timoteos|\.[\s\xa0]*Timoteos|[\s\xa0]*Timoteos)|1(?:[\s\xa0]*Timoteos|\.(?:[\s\xa0]*Timoteos|\?[\s\xa0]*Ti)|\?[\s\xa0]*Ti)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(T(?:[Iiİı]t(?:us)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Phlm|F(?:[Iiİı]l(?:[Iiİı]mon)|lm)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Heb|[Iİı]br(?:an(?:[Iİı]ler)?))|(?:[Iİı]br)|(?:[İıI]braniler|ibr(?:an[iİıI]ler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jas|Yak(?:up)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[iİ]ki(?:nci[\s\xa0]*Petrus|[\s\xa0]*Petrus))|I(?:ki(?:nci[\s\xa0]*Petrus|[\s\xa0]*Petrus)|I(?:\.[\s\xa0]*Petrus|[\s\xa0]*Petrus))|2(?:[\s\xa0]*Petrus|\.(?:[\s\xa0]*Petrus|\?[\s\xa0]*Pe)|\?[\s\xa0]*Pe|Pet?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Petrus|[\s\xa0]*Petrus)|[iİ]lk[\s\xa0]*Petrus|I(?:lk[\s\xa0]*Petrus|\.[\s\xa0]*Petrus|[\s\xa0]*Petrus)|1(?:[\s\xa0]*Petrus|\.(?:[\s\xa0]*Petrus|\?[\s\xa0]*Pe)|\?[\s\xa0]*Pe|Pet?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jude|Yah(?:uda)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Tob"],
        apocrypha: true,
        ...
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yud[Iiİı]t|Jdt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bar"],
        apocrypha: true,
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:[iİ]ki(?:nci[\s\xa0]*Makabeler|[\s\xa0]*Makabeler))|I(?:ki(?:nci[\s\xa0]*Makabeler|[\s\xa0]*Makabeler)|I(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler))|2(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:III(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler)|[UÜ](?:[cç](?:(?:[uü]nc(?:[uü][\s\xa0]*Makabeler)|[\s\xa0]*Makabeler)))|3(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:D[oö]r(?:d(?:[uü]nc(?:[uü][\s\xa0]*Makabeler)|t[\s\xa0]*Makabeler))|IV(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler)|4(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler|Macc))|D(?:[oö]rt[\s\xa0]*Makabeler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Bir(?:inci[\s\xa0]*Makabeler|[\s\xa0]*Makabeler)|[iİ]lk[\s\xa0]*Makabeler|I(?:lk[\s\xa0]*Makabeler|\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler)|1(?:\.[\s\xa0]*Makabeler|[\s\xa0]*Makabeler|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
...
var grammar = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c44 = "vs",
        peg$c45 = { type: "literal", value: "vs", description: "\"vs\"" },
        peg$c46 = "vd",
        peg$c47 = { type: "literal", value: "vd", description: "\"vd\"" },
        peg$c48 = /^[a-z]/,
        ...
        peg$c51 = "ba",
        peg$c52 = { type: "literal", value: "ba", description: "\"ba\"" },
        peg$c53 = /^[\u015Fs]/i,
        peg$c54 = { type: "class", value: "[\\u015Fs]i", description: "[\\u015Fs]i" },
        peg$c55 = "l",
        peg$c56 = { type: "literal", value: "l", description: "\"l\"" },
        peg$c57 = /^[\u0131i]/i,
        peg$c58 = { type: "class", value: "[\\u0131i]i", description: "[\\u0131i]i" },
        peg$c59 = "k",
        peg$c60 = { type: "literal", value: "k", description: "\"k\"" },
        peg$c61 = function(val_1) { return {"type": "integer_title", "value": [val_1], "indices": [offset(), peg$currPos - 1]} },
        peg$c62 = "/9\x1F",
        peg$c63 = { type: "literal", value: "/9\x1F", description: "\"/9\\x1F\"" },
        peg$c64 = function(val) { return {"type": "context", "value": val.value, "indices": [offset(), peg$currPos - 1]} },
        peg$c65 = "/2\x1F",
        peg$c66 = { type: "literal", value: "/2\x1F", description: "\"/2\\x1F\"" },
        peg$c67 = ".1",
        peg$c68 = { type: "literal", value: ".1", description: "\".1\"" },
        peg$c69 = /^[0-9]/,
        peg$c70 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c71 = function(val) { return {"type": "bc", "value": [val, {"type": "c", "value": [{"type": "integer", "value": 151, "indices": [peg$currPos - 2, peg$currPos - 1]}], "indices": [peg$currPos - 2, peg$currPos - 1]}], "indices": [offset(), peg$currPos - 1]} },
        peg$c72 = function(val_1, val_2) { return {"type": "bcv", "value": [val_1, {"type": "v", "value": [val_2], "indices": [val_2.indices[0], val_2.indices[1]]}], "indices": [offset(), peg$currPos - 1]} },
        peg$c73 = /^[b-e]/,
        peg$c74 = { type: "class", value: "[b-e]", description: "[b-e]" },
        peg$c75 = function(val) { return {"type": "v", "value": [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c76 = "b",
        peg$c77 = { type: "literal", value: "b", description: "\"b\"" },
        peg$c78 = "aplar",
        peg$c79 = { type: "literal", value: "aplar", description: "\"aplar\"" },
        peg$c80 = "ap",
        peg$c81 = { type: "literal", value: "ap", description: "\"ap\"" },
        peg$c82 = "p",
        peg$c83 = { type: "literal", value: "p", description: "\"p\"" },
        peg$c84 = function() { return {"type": "c_explicit"} },
        peg$c85 = "a",
        peg$c86 = { type: "literal", value: "a", description: "\"a\"" },
        peg$c87 = "yet",
        peg$c88 = { type: "literal", value: "yet", description: "\"yet\"" },
        peg$c89 = "ayeti",
        peg$c90 = { type: "literal", value: "ayeti", description: "\"ayeti\"" },
        peg$c91 = function() { return {"type": "v_explicit"} },
        peg$c92 = ":",
        ...
        peg$c98 = "ve",
        peg$c99 = { type: "literal", value: "ve", description: "\"ve\"" },
        peg$c100 = function() { return "" },
        peg$c101 = /^[\-\u2013\u2014]/,
        peg$c102 = { type: "class", value: "[\\-\\u2013\\u2014]", description: "[\\-\\u2013\\u2014]" },
        peg$c103 = "ile",
        peg$c104 = { type: "literal", value: "ile", description: "\"ile\"" },
        peg$c105 = function(val) { return {type:"title", value: [val], "indices": [offset(), peg$currPos - 1]} },
        peg$c106 = "from",
        ...
        peg$c120 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c121 = "\x1E",
        peg$c122 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c123 = function(val) { return {"type": "translation", "value": val.value, "indices": [offset(), peg$currPos - 1]} },
        peg$c124 = ",000",
        peg$c125 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c126 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [offset(), peg$currPos - 1]} },
        peg$c127 = /^[^\x1F\x1E([]/,
        peg$c128 = { type: "class", value: "[^\\x1F\\x1E([]", description: "[^\\x1F\\x1E([]" },
        peg$c129 = function(val) { return {"type": "word", "value": val.join(""), "indices": [offset(), peg$currPos - 1]} },
        peg$c130 = function(val) { return {"type": "stop", "value": val, "indices": [offset(), peg$currPos - 1]} },
        peg$c131 = /^[\s\xa0*]/,
